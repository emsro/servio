...
#define IS_LL_RCC_I3C_CLKSOURCE( __VALUE__ ) \
        ( ( ( __VALUE__ ) == LL_RCC_I3C1_CLKSOURCE ) || ( ( __VALUE__ ) == LL_RCC_I3C2_CLKSOURCE ) )
#else
...
#define IS_LL_RCC_SAI_CLKSOURCE( __VALUE__ ) \
        ( ( ( __VALUE__ ) == LL_RCC_SAI1_CLKSOURCE ) || ( ( __VALUE__ ) == LL_RCC_SAI2_CLKSOURCE ) )
#endif /* SAI1 */
...
ErrorStatus LL_RCC_DeInit( void )
{
        ...
        /* Reset HSECSSON, HSEON, HSIKERON, CSION, CSIKERON, HSI48ON, PLL1ON, PLL2ON and  PLL3ON
         * bits */
        CLEAR_BIT(
            RCC->CR,
        ...
        CLEAR_BIT(
            RCC->CIER,
            RCC_CIER_LSIRDYIE | RCC_CIER_LSERDYIE | RCC_CIER_HSIRDYIE | RCC_CIER_HSERDYIE |
        ...
        SET_BIT(
            RCC->CICR,
            RCC_CICR_LSIRDYC | RCC_CICR_LSERDYC | RCC_CICR_HSIRDYC | RCC_CICR_HSERDYC |
...
/**
 * @brief  Return the frequencies of different on chip clocks;  System, AHB, APB1, APB2 and APB3
 * buses clocks
 * @note   Each time SYSCLK, HCLK, PCLK1, PCLK2 and PCLK3 clock changes, this function
 *         must be called to update structure fields. Otherwise, any
 *         configuration based on this function will be incorrect.
 * @param  pRCC_Clocks pointer to a @ref LL_RCC_ClocksTypeDef structure which will hold the clocks
 * frequencies
 * @retval None
 */
...
uint32_t LL_RCC_GetUSARTClockFreq( uint32_t USARTxSource )
{
        ...
        if ( USARTxSource == LL_RCC_USART1_CLKSOURCE ) {
                ...
                case LL_RCC_USART1_CLKSOURCE_PCLK2: /* USART1 Clock is PCLK2 */
                        usart_frequency = RCC_GetPCLK2ClockFreq(
...
uint32_t LL_RCC_GetUARTClockFreq( uint32_t UARTxSource )
{
        ...
        if ( UARTxSource == LL_RCC_UART4_CLKSOURCE ) {
                ...
                case LL_RCC_UART4_CLKSOURCE_PCLK1: /* UART4 Clock is PCLK1 */
                        uart_frequency = RCC_GetPCLK1ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
...
uint32_t LL_RCC_GetSPIClockFreq( uint32_t SPIxSource )
{
        ...
        if ( SPIxSource == LL_RCC_SPI1_CLKSOURCE ) {
                ...
                case LL_RCC_SPI4_CLKSOURCE_PCLK2: /* SPI4 Clock is PCLK2 */
                        spi_frequency = RCC_GetPCLK2ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
                ...
                case LL_RCC_SPI5_CLKSOURCE_PCLK3: /* SPI5 Clock is PCLK3 */
                        spi_frequency = RCC_GetPCLK3ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
...
uint32_t LL_RCC_GetI2CClockFreq( uint32_t I2CxSource )
{
        ...
        if ( I2CxSource == LL_RCC_I2C1_CLKSOURCE ) {
                ...
                case LL_RCC_I2C3_CLKSOURCE_PCLK3: /* I2C3 Clock is PCLK3 */
                        i2c_frequency = RCC_GetPCLK3ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator or PLL is not ready or no
 * clock is selected
 */
uint32_t LL_RCC_GetI3CClockFreq( uint32_t I3CxSource )
{
        ...
        if ( I3CxSource == LL_RCC_I3C1_CLKSOURCE ) {
                ...
                case LL_RCC_I3C1_CLKSOURCE_PCLK1: /* I3C1 Clock is PCLK1 */
                        I3C_frequency = RCC_GetPCLK1ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
                ...
                case LL_RCC_I3C2_CLKSOURCE_PCLK3: /* I3C2 Clock is PCLK3 */
                        I3C_frequency = RCC_GetPCLK3ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
...
uint32_t LL_RCC_GetLPTIMClockFreq( uint32_t LPTIMxSource )
{
        ...
        if ( LPTIMxSource == LL_RCC_LPTIM1_CLKSOURCE ) {
                ...
                case LL_RCC_LPTIM1_CLKSOURCE_PCLK3: /* LPTIM1 Clock is is PCLK3 */
                        lptim_frequency = RCC_GetPCLK3ClockFreq(
                            RCC_GetHCLKClockFreq( RCC_GetSystemClockFreq() ) );
                        break;
...
uint32_t LL_RCC_GetOCTOSPIClockFreq( uint32_t OCTOSPIxSource )
{
        ...
        case LL_RCC_OSPI_CLKSOURCE_CLKP: /* OSPI Clock is CLKP */
                octospi_frequency =
                    LL_RCC_GetCLKPClockFreq( LL_RCC_GetCLKPClockSource( LL_RCC_CLKP_CLKSOURCE ) );
                break;
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator is not ready or no clock is
 * selected
 */
...
uint32_t RCC_PLL1_GetFreqSystem( void )
{
        ...
        */
        ...
        return __LL_RCC_CALC_PLL1CLK_P_FREQ(
            pllinputfreq, LL_RCC_PLL1_GetM(), LL_RCC_PLL1_GetN(), LL_RCC_PLL1_GetP() );
}
