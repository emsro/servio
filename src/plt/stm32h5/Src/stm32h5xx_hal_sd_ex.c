 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_BuildNode(
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_InsertNode(
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_RemoveNode(
    SD_DMALinkedListTypeDef* pLinkedList,
    SD_DMALinkNodeTypeDef*   pNode )
{
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_ReadBlocks(
