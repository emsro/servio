...
ErrorStatus LL_OPAMP_Init( OPAMP_TypeDef* OPAMPx, LL_OPAMP_InitTypeDef const* OPAMP_InitStruct )
{
        ...
        if ( OPAMP_InitStruct->FunctionalMode != LL_OPAMP_MODE_FOLLOWER ) {
                MODIFY_REG(
                    OPAMPx->CSR,
                    OPAMP_CSR_OPAHSM | OPAMP_CSR_CALON | OPAMP_CSR_VMSEL | OPAMP_CSR_VPSEL |
                        OPAMP_CSR_PGGAIN_2 | OPAMP_CSR_PGGAIN_1,
                    ( OPAMP_InitStruct->PowerMode & OPAMP_POWERMODE_CSR_BIT_MASK ) |
                        OPAMP_InitStruct->FunctionalMode | OPAMP_InitStruct->InputNonInverting |
                ...
                MODIFY_REG(
                    ...
                    OPAMP_CSR_OPAHSM | OPAMP_CSR_CALON | OPAMP_CSR_VMSEL | OPAMP_CSR_VPSEL |
                        OPAMP_CSR_PGGAIN_2 | OPAMP_CSR_PGGAIN_1,
                    ( OPAMP_InitStruct->PowerMode & OPAMP_POWERMODE_CSR_BIT_MASK ) |
                        LL_OPAMP_MODE_FOLLOWER | OPAMP_InitStruct->InputNonInverting );
        }
