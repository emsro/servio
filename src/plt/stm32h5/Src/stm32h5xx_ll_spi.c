...
#define IS_LL_SPI_PROTOCOL( __VALUE__ ) \
        ( ( ( __VALUE__ ) == LL_SPI_PROTOCOL_MOTOROLA ) || ( ( __VALUE__ ) == LL_SPI_PROTOCOL_TI ) )
...
#define IS_LL_SPI_TRANSFER_DIRECTION( __VALUE__ )                                                 \
        ( ( ( __VALUE__ ) == LL_SPI_FULL_DUPLEX ) || ( ( __VALUE__ ) == LL_SPI_SIMPLEX_TX ) ||    \
          ( ( __VALUE__ ) == LL_SPI_SIMPLEX_RX ) || ( ( __VALUE__ ) == LL_SPI_HALF_DUPLEX_RX ) || \
...
ErrorStatus LL_SPI_Init( SPI_TypeDef* SPIx, LL_SPI_InitTypeDef* SPI_InitStruct )
{
        ...
        if ( LL_SPI_IsEnabled( SPIx ) == 0x00000000UL ) {
                 ...
                 */
                MODIFY_REG(
                    SPIx->CR1, SPI_CR1_HDDIR, SPI_InitStruct->TransferDirection & SPI_CR1_HDDIR );
...
#define I2S_I2SCFGR_CLEAR_MASK                                                              \
        ( SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_DATFMT | SPI_I2SCFGR_CKPOL | \
          SPI_I2SCFGR_I2SSTD | SPI_I2SCFGR_MCKOE | SPI_I2SCFGR_I2SCFG | SPI_I2SCFGR_I2SMOD )
...
#define IS_LL_I2S_CHANNEL_LENGTH_TYPE                               \
        ( __VALUE__ )(                                              \
            ( ( __VALUE__ ) == LL_I2S_SLAVE_VARIABLE_CH_LENGTH ) || \
            ( ( __VALUE__ ) == LL_I2S_SLAVE_FIXED_CH_LENGTH ) )

#define IS_LL_I2S_CKPOL( __VALUE__ ) \
        ( ( ( __VALUE__ ) == LL_I2S_POLARITY_LOW ) || ( ( __VALUE__ ) == LL_I2S_POLARITY_HIGH ) )

#define IS_LL_I2S_STANDARD( __VALUE__ )                                                           \
        ( ( ( __VALUE__ ) == LL_I2S_STANDARD_PHILIPS ) ||                                         \
          ( ( __VALUE__ ) == LL_I2S_STANDARD_MSB ) || ( ( __VALUE__ ) == LL_I2S_STANDARD_LSB ) || \
...
#define IS_LL_I2S_FIFO_TH                                        \
        ( __VALUE__ )(                                           \
            ( ( __VALUE__ ) == LL_I2S_LL_I2S_FIFO_TH_01DATA ) || \
        ...
        if ( LL_SPI_IsEnabled( SPIx ) == 0x00000000UL ) {
                ...
                MODIFY_REG(
                    ...
                    I2S_InitStruct->Mode | I2S_InitStruct->Standard | I2S_InitStruct->DataFormat |
                        I2S_InitStruct->ClockPolarity | I2S_InitStruct->MCLKOutput |
                        SPI_I2SCFGR_I2SMOD );
                ...
                if ( I2S_InitStruct->AudioFreq != LL_I2S_AUDIOFREQ_DEFAULT ) {
                        ...
                        if ( I2S_InitStruct->MCLKOutput == LL_I2S_MCLK_OUTPUT_ENABLE ) {
                                ...
                                tmp = ( ( ( sourceclock / ( ( 32UL >> ispcm ) * packetlength ) ) *
                                          16UL ) /
                                        I2S_InitStruct->AudioFreq ) +
                                      8UL;
                        }
