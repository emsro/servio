 ...
 * @retval None
 */
void HAL_GPIO_Init( GPIO_TypeDef* GPIOx, GPIO_InitTypeDef const* pGPIO_Init )
{
        uint32_t tmp;
        uint32_t iocurrent;
        ...
        while ( ( ( pGPIO_Init->Pin ) >> position ) != 0U ) {
                ...
                if ( iocurrent != 0U ) {
                        ...
                        tmp |=
                            ( ( pGPIO_Init->Mode & GPIO_MODE )
                              << ( position * GPIO_MODER_MODE1_Pos ) );
                        GPIOx->MODER = tmp;
                             ...
                             ( pGPIO_Init->Mode == GPIO_MODE_AF_OD ) ) {
                                ...
                                tmp &=
                                    ~( GPIO_OSPEEDR_OSPEED0
                                       << ( position * GPIO_OSPEEDR_OSPEED1_Pos ) );
                                tmp |=
                                    ( pGPIO_Init->Speed
                                      << ( position * GPIO_OSPEEDR_OSPEED1_Pos ) );
                                GPIOx->OSPEEDR = tmp;
                                ...
                                tmp |=
                                    ( ( ( pGPIO_Init->Mode & GPIO_OUTPUT_TYPE ) >> 4U )
                                      << position );
                                GPIOx->OTYPER = tmp;
                        }
                        ...
                        if ( ( ( pGPIO_Init->Mode & GPIO_MODE ) != GPIO_MODE_ANALOG ) ||
                             ( ( ( pGPIO_Init->Mode & GPIO_MODE ) == GPIO_MODE_ANALOG ) &&
                               ( pGPIO_Init->Pull != GPIO_PULLUP ) ) ) {
                                ...
                                tmp |=
                                    ( ( pGPIO_Init->Pull ) << ( position * GPIO_PUPDR_PUPD1_Pos ) );
                                GPIOx->PUPDR = tmp;
                        }
...
void HAL_GPIO_DeInit( GPIO_TypeDef* GPIOx, uint32_t GPIO_Pin )
{
        ...
        while ( ( GPIO_Pin >> position ) != 0U ) {
                ...
                if ( iocurrent != 0U ) {
                        ...
                        GPIOx->PUPDR &=
                            ~( GPIO_PUPDR_PUPD0 << ( position * GPIO_PUPDR_PUPD1_Pos ) );
                }
 ...
 * @retval HAL Status.
 */
HAL_StatusTypeDef HAL_GPIO_GetConfigPinAttributes(
