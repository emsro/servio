...
#define IS_LL_I3C_SDAHOLDTIME_VALUE( VALUE ) \
        ( ( ( VALUE ) == LL_I3C_SDA_HOLD_TIME_0_5 ) || ( ( VALUE ) == LL_I3C_SDA_HOLD_TIME_1_5 ) )
...
ErrorStatus LL_I3C_Init( I3C_TypeDef* I3Cx, LL_I3C_InitTypeDef* I3C_InitStruct, uint32_t Mode )
{
        ...
        if ( Mode == LL_I3C_MODE_CONTROLLER ) {
                ...
                assert_param(
                    IS_LL_I3C_WAITTIME_VALUE( I3C_InitStruct->CtrlBusCharacteristic.WaitTime ) );

                /* Set Controller mode */
                LL_I3C_SetMode( I3Cx, LL_I3C_MODE_CONTROLLER );

                /*------------------ SCL signal waveform configuration : I3C timing register 0
                 * (I3C_TIMINGR0) ------------------- */
