    ...
    TIM_BreakDeadTimeConfigTypeDef const* sBreakDeadTimeConfig )
{
        ...
        MODIFY_REG(
            tmpbdtr, TIM_BDTR_BKF, ( sBreakDeadTimeConfig->BreakFilter << TIM_BDTR_BKF_Pos ) );
    ...
    TIMEx_BreakInputConfigTypeDef const* sBreakInputConfig )
{
        ...
        case TIM_BREAKINPUT_BRK: {
                ...
                tmporx |=
                    ( sBreakInputConfig->Polarity << bkin_polarity_bitpos ) & bkin_polarity_mask;
    ...
    TIMEx_EncoderIndexConfigTypeDef* sEncoderIndexConfig )
{
        ...
        MODIFY_REG(
            ...
            ( sEncoderIndexConfig->Direction | ( sEncoderIndexConfig->Blanking ) |
              ( ( sEncoderIndexConfig->FirstIndexEnable == ENABLE ) ? ( 0x1U << TIM_ECR_FIDX_Pos ) :
                                                                      0U ) |
...
static void TIM_CCxNChannelCmd( TIM_TypeDef* TIMx, uint32_t Channel, uint32_t ChannelNState )
{
        ...
        TIMx->CCER |=
            (uint32_t) ( ChannelNState << ( Channel & 0xFU ) ); /* 0xFU = 15 bits max shift */
}
