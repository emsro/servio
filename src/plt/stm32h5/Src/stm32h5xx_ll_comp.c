...
ErrorStatus LL_COMP_Init( COMP_TypeDef* COMPx, LL_COMP_InitTypeDef const* COMP_InitStruct )
{
        ...
        assert_param(
            IS_LL_COMP_OUTPUT_BLANKING_SOURCE( COMPx, COMP_InitStruct->OutputBlankingSource ) );
        ...
        if ( LL_COMP_IsLocked( COMPx ) == 0UL ) {
                ...
                MODIFY_REG(
                    ...
                    COMP_CFGR1_PWRMODE | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 |
                        COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN | COMP_CFGR1_INMSEL | COMP_CFGR1_HYST |
                        COMP_CFGR1_POLARITY | COMP_CFGR1_BLANKING,
                    COMP_InitStruct->PowerMode | COMP_InitStruct->InputPlus |
                        COMP_InitStruct->InputMinus | COMP_InitStruct->InputHysteresis |
                        COMP_InitStruct->OutputPolarity | COMP_InitStruct->OutputBlankingSource );
