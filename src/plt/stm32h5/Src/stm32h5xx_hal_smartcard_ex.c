 ...
 */
HAL_StatusTypeDef
HAL_SMARTCARDEx_SetTxFifoThreshold( SMARTCARD_HandleTypeDef* hsmartcard, uint32_t Threshold )
{
        uint32_t tmpcr1;
 ...
 */
HAL_StatusTypeDef
HAL_SMARTCARDEx_SetRxFifoThreshold( SMARTCARD_HandleTypeDef* hsmartcard, uint32_t Threshold )
{
        uint32_t tmpcr1;
...
static void SMARTCARDEx_SetNbDataToProcess( SMARTCARD_HandleTypeDef* hsmartcard )
{
        ...
        static uint8_t const numerator[]   = { 1U, 1U, 1U, 3U, 7U, 1U, 0U, 0U };
        static uint8_t const denominator[] = { 8U, 4U, 2U, 4U, 8U, 1U, 1U, 1U };
