 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_BuildNode(
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_InsertNode(
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_RemoveNode(
    MMC_DMALinkedListTypeDef* pLinkedList,
    MMC_DMALinkNodeTypeDef*   pNode )
{
 ...
 */
HAL_StatusTypeDef
HAL_MMCEx_DMALinkedList_EnableCircularMode( MMC_DMALinkedListTypeDef* pLinkedList )
{
 ...
 */
HAL_StatusTypeDef
HAL_MMCEx_DMALinkedList_DisableCircularMode( MMC_DMALinkedListTypeDef* pLinkedList )
{
 ...
 * linked list buffers. linked list should be prepared before call this function .
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_MMCEx_DMALinkedList_ReadBlocks(
    MMC_HandleTypeDef*              hmmc,
    MMC_DMALinkedListTypeDef const* pLinkedList,
    uint32_t                        BlockAdd,
...
/**
 * @brief  Write block(s) to a specified address in a card. The transferred Data are stored linked
 * list nodes buffers . linked list should be prepared before call this function .
 * @param  hmmc: MMC handle
 * @param  pLinkedList: pointer to first linked list node
 * @param  BlockAdd: Block Address from where data is to be read
 * @param  NumberOfBlocks: Total number of blocks to read
