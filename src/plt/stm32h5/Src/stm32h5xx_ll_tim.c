 ...
 * @{
 */
static ErrorStatus OC1Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus OC2Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus OC3Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus OC4Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus OC5Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus OC6Config( TIM_TypeDef* TIMx, LL_TIM_OC_InitTypeDef const* TIM_OCInitStruct );
static ErrorStatus IC1Config( TIM_TypeDef* TIMx, LL_TIM_IC_InitTypeDef const* TIM_ICInitStruct );
static ErrorStatus IC2Config( TIM_TypeDef* TIMx, LL_TIM_IC_InitTypeDef const* TIM_ICInitStruct );
static ErrorStatus IC3Config( TIM_TypeDef* TIMx, LL_TIM_IC_InitTypeDef const* TIM_ICInitStruct );
static ErrorStatus IC4Config( TIM_TypeDef* TIMx, LL_TIM_IC_InitTypeDef const* TIM_ICInitStruct );
 ...
 *          - ERROR: not applicable
 */
ErrorStatus LL_TIM_BDTR_Init( TIM_TypeDef* TIMx, LL_TIM_BDTR_InitTypeDef const* TIM_BDTRInitStruct )
{
        uint32_t tmpbdtr = 0;
