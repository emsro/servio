...
static HAL_StatusTypeDef RCCEx_PLL2_Config( RCC_PLL2InitTypeDef const* Pll2 );
#if defined( RCC_CR_PLL3ON )
static HAL_StatusTypeDef RCCEx_PLL3_Config( RCC_PLL3InitTypeDef const* Pll3 );
#endif /* RCC_CR_PLL3ON */
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig( RCC_PeriphCLKInitTypeDef const* pPeriphClkInit )
{
             ...
             RCC_PERIPHCLK_RTC ) {
                ...
                if ( ret == HAL_OK ) {
                        ...
                        if ( ( tmpregister != RCC_RTCCLKSOURCE_NO_CLK ) &&
                             ( tmpregister !=
                               ( ( pPeriphClkInit->RTCClockSelection ) & RCC_BDCR_RTCSEL ) ) ) {
        ...
        if ( ( ( pPeriphClkInit->PeriphClockSelection ) & RCC_PERIPHCLK_SDMMC1 ) ==
             RCC_PERIPHCLK_SDMMC1 ) {
                ...
                case RCC_SDMMC1CLKSOURCE_PLL1Q: /* PLL1 is used as clock source for SDMMC1 kernel
                                                   clock*/
                        /* Enable PLL1Q Clock output generated from System PLL . */
                        __HAL_RCC_PLL1_CLKOUT_ENABLE( RCC_PLL1_DIVQ );
                ...
                case RCC_SDMMC1CLKSOURCE_PLL2R: /* PLL2 is used as clock source for SDMMC1 kernel
                                                   clock*/
        ...
        if ( ( ( pPeriphClkInit->PeriphClockSelection ) & RCC_PERIPHCLK_SDMMC2 ) ==
             RCC_PERIPHCLK_SDMMC2 ) {
                ...
                case RCC_SDMMC2CLKSOURCE_PLL1Q: /* PLL1 is used as clock source for SDMMC2 kernel
                                                   clock*/
                        /* Enable PLL1Q Clock output generated from System PLL . */
                        __HAL_RCC_PLL1_CLKOUT_ENABLE( RCC_PLL1_DIVQ );
                ...
                case RCC_SDMMC2CLKSOURCE_PLL2R: /* PLL2 is used as clock source for SDMMC2 kernel
                                                   clock*/
                        /* PLL2R input clock, parameters M, N & R configuration and clock output
                         * (PLL2ClockOut) */
                        ret = RCCEx_PLL2_Config( &( pPeriphClkInit->PLL2 ) );
        ...
        if ( ( ( pPeriphClkInit->PeriphClockSelection ) & RCC_PERIPHCLK_FDCAN ) ==
             RCC_PERIPHCLK_FDCAN ) {
                ...
                case RCC_FDCANCLKSOURCE_PLL1Q: /* PLL1 is used as clock source for FDCAN kernel
                                                  clock*/
                        /* Enable PLL1Q Clock output generated from System PLL . */
                        __HAL_RCC_PLL1_CLKOUT_ENABLE( RCC_PLL1_DIVQ );
                        /* FDCAN kernel clock source config set later after clock selection check */
                ...
                case RCC_FDCANCLKSOURCE_PLL2Q: /* PLL2 is used as clock source for FDCAN kernel
                                                  clock*/
 ...
 *         clocks (ADC12, DAC, SDMMC1, SDMMC2, OCTOSPI1, TIM, LPTIM1, LPTIM2, LPTIM3, LPTIM4,
 * LPTIM5, LPTIM6, SPI1, SPI2, SPI3, SPI4, SPI5, SPI6, USART1, USART2, USART3, UART4, UART5, USART6,
 * UART7, UART8, UART9, USART10, USART11, UART12, LPUART1, I2C1, I2C2, I2C3, I2C4, I3C1, I3C2, CEC,
 * FDCAN, SAI1, SAI2, USB), PLL2 and PLL3.
 * @retval None
 */
void HAL_RCCEx_GetPeriphCLKConfig( RCC_PeriphCLKInitTypeDef* pPeriphClkInit )
{
        ...
        pPeriphClkInit->PeriphClockSelection =
            ...
            RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_LPTIM1 |
            RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RTC |
            RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 |
        ...
        pPeriphClkInit->PLL2.PLL2M =
            (uint32_t) ( ( RCC->PLL2CFGR & RCC_PLL2CFGR_PLL2M ) >> RCC_PLL2CFGR_PLL2M_Pos );
        pPeriphClkInit->PLL2.PLL2N =
            (uint32_t) ( ( RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2N ) >> RCC_PLL2DIVR_PLL2N_Pos ) + 1U;
        pPeriphClkInit->PLL2.PLL2P =
            (uint32_t) ( ( RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2P ) >> RCC_PLL2DIVR_PLL2P_Pos ) + 1U;
        pPeriphClkInit->PLL2.PLL2Q =
            (uint32_t) ( ( RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2Q ) >> RCC_PLL2DIVR_PLL2Q_Pos ) + 1U;
        pPeriphClkInit->PLL2.PLL2R =
            (uint32_t) ( ( RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2R ) >> RCC_PLL2DIVR_PLL2R_Pos ) + 1U;
        pPeriphClkInit->PLL2.PLL2RGE =
            (uint32_t) ( ( RCC->PLL2CFGR & RCC_PLL2CFGR_PLL2RGE ) >> RCC_PLL2CFGR_PLL2RGE_Pos );
        ...
        pPeriphClkInit->PLL3.PLL3M =
            (uint32_t) ( ( RCC->PLL3CFGR & RCC_PLL3CFGR_PLL3M ) >> RCC_PLL3CFGR_PLL3M_Pos );
        pPeriphClkInit->PLL3.PLL3N =
            (uint32_t) ( ( RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3N ) >> RCC_PLL3DIVR_PLL3N_Pos ) + 1U;
        pPeriphClkInit->PLL3.PLL3P =
            (uint32_t) ( ( RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3P ) >> RCC_PLL3DIVR_PLL3P_Pos ) + 1U;
        pPeriphClkInit->PLL3.PLL3Q =
            (uint32_t) ( ( RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3Q ) >> RCC_PLL3DIVR_PLL3Q_Pos ) + 1U;
        pPeriphClkInit->PLL3.PLL3R =
            (uint32_t) ( ( RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3R ) >> RCC_PLL3DIVR_PLL3R_Pos ) + 1U;
        pPeriphClkInit->PLL3.PLL3RGE =
            (uint32_t) ( ( RCC->PLL3CFGR & RCC_PLL3CFGR_PLL3RGE ) >> RCC_PLL3CFGR_PLL3RGE_Pos );
...
void HAL_RCCEx_GetPLL1ClockFreq( PLL1_ClocksTypeDef* pPLL1_Clocks )
{
        ...
        */
        ...
        fracn1 =
            (float_t) (uint32_t) ( pll1fracen * ( ( RCC->PLL1FRACR & RCC_PLL1FRACR_PLL1FRACN ) >>
        ...
        if ( pll1m != 0U ) {
                ...
                case RCC_PLL1_SOURCE_HSI: /* HSI used as PLL1 clock source */
                        ...
                        pll1vco = ( (float_t) hsivalue / (float_t) pll1m ) *
                                  ( (float_t) (uint32_t) pll1n + ( fracn1 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;

                case RCC_PLL1_SOURCE_CSI: /* CSI used as PLL1 clock source */
                        pll1vco = ( (float_t) CSI_VALUE / (float_t) pll1m ) *
                                  ( (float_t) (uint32_t) pll1n + ( fracn1 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;
...
void HAL_RCCEx_GetPLL2ClockFreq( PLL2_ClocksTypeDef* pPLL2_Clocks )
{
        ...
        */
        ...
        fracn2 =
            (float_t) (uint32_t) ( pll2fracen * ( ( RCC->PLL2FRACR & RCC_PLL2FRACR_PLL2FRACN ) >>
                                                  RCC_PLL2FRACR_PLL2FRACN_Pos ) );
        ...
        if ( pll2m != 0U ) {
                ...
                case RCC_PLL2_SOURCE_HSI: /* HSI used as PLL clock source */
                        hsivalue =
                            ( HSI_VALUE >> ( __HAL_RCC_GET_HSI_DIVIDER() >> RCC_CR_HSIDIV_Pos ) );
                        pll2vco = ( (float_t) hsivalue / (float_t) pll2m ) *
                                  ( (float_t) (uint32_t) pll2n + ( fracn2 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;

                case RCC_PLL2_SOURCE_CSI: /* CSI used as PLL clock source */
                        pll2vco = ( (float_t) CSI_VALUE / (float_t) pll2m ) *
                                  ( (float_t) (uint32_t) pll2n + ( fracn2 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;
...
void HAL_RCCEx_GetPLL3ClockFreq( PLL3_ClocksTypeDef* pPLL3_Clocks )
{
        ...
        */
        ...
        fracn3 =
            (float_t) (uint32_t) ( pll3fracen * ( ( RCC->PLL3FRACR & RCC_PLL3FRACR_PLL3FRACN ) >>
                                                  RCC_PLL3FRACR_PLL3FRACN_Pos ) );
        ...
        if ( pll3m != 0U ) {
                ...
                case RCC_PLL3_SOURCE_HSI: /* HSI used as PLL clock source */
                        hsivalue =
                            ( HSI_VALUE >> ( __HAL_RCC_GET_HSI_DIVIDER() >> RCC_CR_HSIDIV_Pos ) );
                        pll3vco = ( (float_t) hsivalue / (float_t) pll3m ) *
                                  ( (float_t) (uint32_t) pll3n + ( fracn3 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;

                case RCC_PLL3_SOURCE_CSI: /* CSI used as PLL clock source */
                        pll3vco = ( (float_t) CSI_VALUE / (float_t) pll3m ) *
                                  ( (float_t) (uint32_t) pll3n + ( fracn3 / (float_t) 0x2000 ) +
                                    (float_t) 1 );
                        break;
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq( uint64_t PeriphClk )
{
        ...
        if ( PeriphClk == RCC_PERIPHCLK_RTC ) {
                ...
                /* Check if LSI is ready and if RTC clock selection is LSI */
                    ...
                    ( HAL_IS_BIT_SET( RCC->BDCR, RCC_BDCR_LSIRDY ) ) &&
                ...
                /* Check if HSE is ready and if RTC clock selection is HSE_DIVx*/
                    ...
                    ( srcclk == RCC_RTCCLKSOURCE_HSE_DIVx ) ) {
                        if ( __HAL_RCC_GET_RTC_HSE_PRESCALER() >= RCC_RTC_HSE_DIV2 ) {
                                frequency =
                                    ( HSE_VALUE /
                                      ( (uint32_t) ( __HAL_RCC_GET_RTC_HSE_PRESCALER() >>
                ...
                case RCC_PERIPHCLK_SAI1:
                        ...
                        case RCC_SAI1CLKSOURCE_CLKP: /* CLKP is the clock source for SAI1 */
                        {
                                ...
                                if ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_HSIRDY ) &&
                                    ...
                                    HAL_IS_BIT_SET( RCC->CR, RCC_CR_CSIRDY ) &&
                ...
                case RCC_PERIPHCLK_USART1:
                        ...
                        if ( srcclk == RCC_USART1CLKSOURCE_PCLK2 ) {
                            ...
                            ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_PLL2RDY ) ) &&
                            ...
                            ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_PLL3RDY ) ) &&
                            ...
                            ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_HSIRDY ) ) &&
                            ...
                            ( HAL_IS_BIT_SET( RCC->BDCR, RCC_BDCR_LSERDY ) ) &&
          ...
          defined(STM32H5F4xx) */
                ...
                case RCC_PERIPHCLK_RNG:
                        ...
                        if ( ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_HSI48RDY ) ) &&
                            ...
                            ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_PLL1RDY ) ) &&
                ...
                case RCC_PERIPHCLK_USB:
                        ...
                        if ( srcclk == RCC_USBCLKSOURCE_PLL1Q ) {
                            ...
                            ( HAL_IS_BIT_SET( RCC->CR, RCC_CR_HSI48RDY ) ) &&
...
void HAL_RCCEx_CRS_IRQHandler( void )
{
        ...
        /* Check CRS SYNCWARN flag  */
            ...
            ( ( itflags & RCC_CRS_FLAG_SYNCWARN ) != 0U ) &&
        ...
        /* Check CRS Error flags  */
            ...
            ( ( itflags & RCC_CRS_FLAG_ERR ) != 0U ) && ( ( itsources & RCC_CRS_IT_ERR ) != 0U ) ) {
...
/**
 * @brief  Configure the PLL2 VCI/VCO ranges, multiplication and division factors and its output
 * clock(s)
 * @param  pll2  pointer to an RCC_PLL2InitTypeDef structure that
 *         contains the configuration parameters M, N, FRACN, VCI/VCO ranges as well as PLL2 output
 * clocks dividers
...
static HAL_StatusTypeDef RCCEx_PLL2_Config( RCC_PLL2InitTypeDef const* pll2 )
{
        ...
        __HAL_RCC_PLL2_CONFIG(
            pll2->PLL2Source, pll2->PLL2M, pll2->PLL2N, pll2->PLL2P, pll2->PLL2Q, pll2->PLL2R );
...
#if defined( RCC_CR_PLL3ON )
/**
 * @brief  Configure the PLL3 VCI/VCO ranges, multiplication and division factors and its output
 * clock(s)
 * @param  pll3  pointer to an RCC_PLL3InitTypeDef structure that
 *         contains the configuration parameters M, N, FRACN, VCI/VCO ranges as well as PLL3 output
 * clocks dividers
...
static HAL_StatusTypeDef RCCEx_PLL3_Config( RCC_PLL3InitTypeDef const* pll3 )
{
        ...
        __HAL_RCC_PLL3_CONFIG(
            pll3->PLL3Source, pll3->PLL3M, pll3->PLL3N, pll3->PLL3P, pll3->PLL3Q, pll3->PLL3R );
