...
HAL_StatusTypeDef HAL_DCMI_Init( DCMI_HandleTypeDef* hdcmi )
{
        ...
        hdcmi->Instance->CR |=
            (uint32_t) ( hdcmi->Init.SynchroMode | hdcmi->Init.CaptureRate |
                         hdcmi->Init.VSPolarity | hdcmi->Init.HSPolarity | hdcmi->Init.PCKPolarity |
                         hdcmi->Init.ExtendedDataMode | hdcmi->Init.JPEGMode |
                         hdcmi->Init.ByteSelectMode | hdcmi->Init.ByteSelectStart |
                        ...
                        if ( ( hdcmi->DMA_Handle->LinkedListQueue != 0U ) &&
                             ( hdcmi->DMA_Handle->LinkedListQueue->Head != 0U ) ) {
                                ...
                                if ( hdcmi->DMA_Handle->LinkedListQueue->Head
                                        ...
                                        if ( HAL_DMAEx_List_Start_IT( hdcmi->DMA_Handle ) !=
                                             HAL_OK ) {
                                                /* Set Error Code */
                                                hdcmi->ErrorCode = HAL_DCMI_ERROR_DMA;
                                                /* Change DCMI state */
        ...
        if ( ( isr_value & DCMI_FLAG_FRAMERI ) == DCMI_FLAG_FRAMERI ) {
                ...
                if ( ( hdcmi->Instance->CR & DCMI_CR_CM ) == DCMI_MODE_SNAPSHOT ) {
                        ...
                        __HAL_DCMI_DISABLE_IT(
                            hdcmi, DCMI_IT_LINE | DCMI_IT_VSYNC | DCMI_IT_ERR | DCMI_IT_OVR );
                }
    ...
    pDCMI_CallbackTypeDef      pCallback )
{
        ...
        if ( pCallback == NULL ) {
                ...
                status = HAL_ERROR;
        } else if ( hdcmi->State == HAL_DCMI_STATE_READY ) {
                switch ( CallbackID ) {
