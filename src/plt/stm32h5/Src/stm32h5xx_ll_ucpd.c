 ...
 * @note   As some bits in ucpd configuration registers can only be written when the ucpd is
 * disabled (ucpd_CR1_SPE bit =0), UCPD peripheral should be in disabled state prior calling this
