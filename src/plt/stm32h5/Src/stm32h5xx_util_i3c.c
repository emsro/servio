 ...
 */
#define SEC210PSEC                                                                          \
        (uint64_t) 100000000000      /*!< 10ps, to take two decimal float of ns calculation \
                                      */
 ...
 */
/**
 * @brief  Calculate the I3C Controller timing according current I3C clock source and required I3C
 * bus clock.
 ...
 */
ErrorStatus I3C_CtrlTimingComputation(
    I3C_CtrlTimingTypeDef const* pInputTiming,
        ...
        if ( ( status == SUCCESS ) && ( ti3cclk != 0U ) ) {
                ...
                if ( pInputTiming->busType == I3C_PURE_I3C_BUS ) {
                        ...
                        if ( ( ( sclhi3c + 1U ) * ti3cclk ) < ti3ch_min ) {
                                ...
                                scllpp = DIV_ROUND_CLOSEST( ti3c_pp_min, ti3cclk ) -
                                         ( sclhi3c + 1U ) - 1U;
                        } else {
                                sclhi3c = DIV_ROUND_CLOSEST(
                                              DIV_ROUND_CLOSEST(
                                                  ti3c_pp_min * pInputTiming->dutyCycle, ti3cclk ),
                                              100U ) -
                                          1U;
                                ...
                                scllpp = DIV_ROUND_CLOSEST(
                                             ( ti3c_pp_min - ( ( sclhi3c + 1U ) * ti3cclk ) +
                                               ( ti3cclk / 2U ) ),
                                             ti3cclk ) -
                                         1U;
                        }
                        ...
                        scllpp = DIV_ROUND_CLOSEST(
                                     ( ti3c_pp_min - ( ( sclhi3c + 1U ) * ti3cclk ) ), ti3cclk ) -
                                 1U;
                }

                /* Check if scllpp is superior at (ti3c_pp_min + 1/2 clock source cycle) */
                /* Goal is to choice the scllpp approach lowest, to have a value frequency highest
                 ...
                 */
                /* Goal is to increase the scllpp, to have a value frequency not out of the clock
                 * request */
                ...
                /* I2C SCL high level (mixed bus with I2C) */
                        ...
                        sclhi2c = DIV_ROUND_CLOSEST(
                                      ( ti2c_od_min - ( ( scllod + 1U ) * ti3cclk ) ), ti3cclk ) -
                                  1U;
                }
                ...
                /* I3C, I2C mixed: (scllod + tcapa)/2 */
                        ...
                        free = DIV_ROUND_CLOSEST(
                            ( ( ( scllod + 1U ) * ti3cclk ) + tcapa ), ( 2U * ti3cclk ) );
                }
                ...
                if ( ( scllpp > 0xFFU ) || ( sclhi3c > 0xFFU ) || ( scllod > 0xFFU ) ||
                     ( sclhi2c > 0xFFU ) || ( free > 0xFFU ) || ( oneus > 0xFFU ) ) {
                        /* Case of value is over 8bits, issue may be due to clocksource have a rate
                         * too high for bus clock request */
 ...
 *          - ERROR: Parameters or timing calculation error
 */
ErrorStatus I3C_TgtTimingComputation(
    I3C_TgtTimingTypeDef const* pInputTiming,
