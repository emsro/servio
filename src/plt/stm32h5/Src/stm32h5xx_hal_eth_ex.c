...
#define ETH_MACL4CR_MASK                                                                           \
        ( ETH_MACL3L4CR_L4PEN | ETH_MACL3L4CR_L4SPM | ETH_MACL3L4CR_L4SPIM | ETH_MACL3L4CR_L4DPM | \
          ETH_MACL3L4CR_L4DPIM )

#define ETH_MACL3CR_MASK                                                                           \
        ( ETH_MACL3L4CR_L3PEN | ETH_MACL3L4CR_L3SAM | ETH_MACL3L4CR_L3SAIM | ETH_MACL3L4CR_L3DAM | \
          ETH_MACL3L4CR_L3DAIM | ETH_MACL3L4CR_L3HSBM | ETH_MACL3L4CR_L3HDBM )

#define ETH_MACRXVLAN_MASK                                                               \
        ( ETH_MACVTR_EIVLRXS | ETH_MACVTR_EIVLS | ETH_MACVTR_ERIVLT | ETH_MACVTR_EDVLP | \
          ETH_MACVTR_VTHM | ETH_MACVTR_EVLRXS | ETH_MACVTR_EVLS | ETH_MACVTR_DOVLTC |    \
          ETH_MACVTR_ERSVLM | ETH_MACVTR_ESVL | ETH_MACVTR_VTIM | ETH_MACVTR_ETV )

#define ETH_MACTXVLAN_MASK ( ETH_MACVIR_VLTI | ETH_MACVIR_CSVL | ETH_MACVIR_VLP | ETH_MACVIR_VLC )
...
HAL_StatusTypeDef HAL_ETHEx_SetL4FilterConfig(
    ...
    uint32_t                         Filter,
    ETH_L4FilterConfigTypeDef const* pL4FilterConfig )
{
        ...
        if ( Filter == ETH_L4_FILTER_0 ) {
                ...
                MODIFY_REG(
                    heth->Instance->MACL3L4C0R,
                    ETH_MACL4CR_MASK,
                    ( pL4FilterConfig->Protocol | pL4FilterConfig->SrcPortFilterMatch |
                      pL4FilterConfig->DestPortFilterMatch ) );

                /* Write configuration to MACL4A0R register */
                WRITE_REG(
                    heth->Instance->MACL4A0R,
                    ( pL4FilterConfig->SourcePort | ( pL4FilterConfig->DestinationPort << 16 ) ) );

        } else /* Filter == ETH_L4_FILTER_1 */
        {
                /* Write configuration to MACL3L4C1R register */
                MODIFY_REG(
                    heth->Instance->MACL3L4C1R,
                    ETH_MACL4CR_MASK,
                    ( pL4FilterConfig->Protocol | pL4FilterConfig->SrcPortFilterMatch |
                      pL4FilterConfig->DestPortFilterMatch ) );
    ...
    ETH_L4FilterConfigTypeDef* pL4FilterConfig )
{
        ...
        if ( Filter == ETH_L4_FILTER_0 ) {
                ...
                pL4FilterConfig->DestPortFilterMatch = READ_BIT(
                    heth->Instance->MACL3L4C0R, ( ETH_MACL3L4CR_L4DPM | ETH_MACL3L4CR_L4DPIM ) );
                pL4FilterConfig->SrcPortFilterMatch = READ_BIT(
                    heth->Instance->MACL3L4C0R, ( ETH_MACL3L4CR_L4SPM | ETH_MACL3L4CR_L4SPIM ) );
        ...
        } else /* Filter == ETH_L4_FILTER_1 */
        {
                ...
                pL4FilterConfig->DestPortFilterMatch = READ_BIT(
                    heth->Instance->MACL3L4C1R, ( ETH_MACL3L4CR_L4DPM | ETH_MACL3L4CR_L4DPIM ) );
                pL4FilterConfig->SrcPortFilterMatch = READ_BIT(
                    heth->Instance->MACL3L4C1R, ( ETH_MACL3L4CR_L4SPM | ETH_MACL3L4CR_L4SPIM ) );
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_ETHEx_SetL3FilterConfig(
    ETH_HandleTypeDef*               heth,
    uint32_t                         Filter,
    ETH_L3FilterConfigTypeDef const* pL3FilterConfig )
{
        ...
        if ( Filter == ETH_L3_FILTER_0 ) {
                ...
                MODIFY_REG(
                    heth->Instance->MACL3L4C0R,
                    ETH_MACL3CR_MASK,
                    ( pL3FilterConfig->Protocol | pL3FilterConfig->SrcAddrFilterMatch |
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef HAL_ETHEx_GetL3FilterConfig(
    ETH_HandleTypeDef const*   heth,
    uint32_t                   Filter,
    ETH_L3FilterConfigTypeDef* pL3FilterConfig )
{
        if ( pL3FilterConfig == NULL )
                return HAL_ERROR;
        pL3FilterConfig->Protocol = READ_BIT(
            *( (__IO uint32_t*) ( &( heth->Instance->MACL3L4C0R ) + Filter ) ),
            ETH_MACL3L4CR_L3PEN );
        pL3FilterConfig->SrcAddrFilterMatch = READ_BIT(
            *( (__IO uint32_t*) ( &( heth->Instance->MACL3L4C0R ) + Filter ) ),
            ( ETH_MACL3L4CR_L3SAM | ETH_MACL3L4CR_L3SAIM ) );
        pL3FilterConfig->DestAddrFilterMatch = READ_BIT(
            *( (__IO uint32_t*) ( &( heth->Instance->MACL3L4C0R ) + Filter ) ),
 ...
 */
HAL_StatusTypeDef
HAL_ETHEx_GetRxVLANConfig( ETH_HandleTypeDef const* heth, ETH_RxVLANConfigTypeDef* pVlanConfig )
{
        if ( pVlanConfig == NULL )
                return HAL_ERROR;

        pVlanConfig->InnerVLANTagInStatus =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_EIVLRXS ) >> 31 ) == 0U ) ? DISABLE :
                                                                                         ENABLE;
        pVlanConfig->StripInnerVLANTag = READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_EIVLS );
        pVlanConfig->InnerVLANTag =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_ERIVLT ) >> 27 ) == 0U ) ? DISABLE :
                                                                                        ENABLE;
        pVlanConfig->DoubleVLANProcessing =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_EDVLP ) >> 26 ) == 0U ) ? DISABLE :
                                                                                       ENABLE;
        pVlanConfig->VLANTagHashTableMatch =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_VTHM ) >> 25 ) == 0U ) ? DISABLE :
                                                                                      ENABLE;
        pVlanConfig->VLANTagInStatus =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_EVLRXS ) >> 24 ) == 0U ) ? DISABLE :
                                                                                        ENABLE;
        pVlanConfig->StripVLANTag  = READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_EVLS );
        pVlanConfig->VLANTypeCheck = READ_BIT(
            heth->Instance->MACVTR, ( ETH_MACVTR_DOVLTC | ETH_MACVTR_ERSVLM | ETH_MACVTR_ESVL ) );
        pVlanConfig->VLANTagInverceMatch =
            ( ( READ_BIT( heth->Instance->MACVTR, ETH_MACVTR_VTIM ) >> 17 ) == 0U ) ? DISABLE :
                                                                                      ENABLE;
 ...
 */
HAL_StatusTypeDef
HAL_ETHEx_SetRxVLANConfig( ETH_HandleTypeDef* heth, ETH_RxVLANConfigTypeDef* pVlanConfig )
{
        if ( pVlanConfig == NULL )
                return HAL_ERROR;
        ...
        MODIFY_REG(
            heth->Instance->MACVTR,
            ETH_MACRXVLAN_MASK,
            ( ( (uint32_t) pVlanConfig->InnerVLANTagInStatus << 31 ) |
              pVlanConfig->StripInnerVLANTag | ( (uint32_t) pVlanConfig->InnerVLANTag << 27 ) |
              ( (uint32_t) pVlanConfig->DoubleVLANProcessing << 26 ) |
              ( (uint32_t) pVlanConfig->VLANTagHashTableMatch << 25 ) |
              ( (uint32_t) pVlanConfig->VLANTagInStatus << 24 ) | pVlanConfig->StripVLANTag |
 ...
 * @retval HAL Status.
 */
HAL_StatusTypeDef HAL_ETHEx_GetTxVLANConfig(
    ETH_HandleTypeDef const* heth,
    uint32_t                 VLANTag,
 ...
 * @retval HAL Status
 */
HAL_StatusTypeDef HAL_ETHEx_SetTxVLANConfig(
    ETH_HandleTypeDef*             heth,
    uint32_t                       VLANTag,
    ETH_TxVLANConfigTypeDef const* pVlanConfig )
{
        if ( VLANTag == ETH_INNER_TX_VLANTAG ) {
                MODIFY_REG(
                    heth->Instance->MACIVIR,
                    ETH_MACTXVLAN_MASK,
                    ( ( (uint32_t) pVlanConfig->SourceTxDesc << 20 ) |
                      ( (uint32_t) pVlanConfig->SVLANType << 19 ) | pVlanConfig->VLANTagControl ) );
                /* Enable Double VLAN processing */
                SET_BIT( heth->Instance->MACVTR, ETH_MACVTR_EDVLP );
        } else {
                MODIFY_REG(
                    heth->Instance->MACVIR,
                    ETH_MACTXVLAN_MASK,
                    ( ( (uint32_t) pVlanConfig->SourceTxDesc << 20 ) |
                      ( (uint32_t) pVlanConfig->SVLANType << 19 ) | pVlanConfig->VLANTagControl ) );
        }
 ...
 * @retval None
 */
void HAL_ETHEx_SetTxVLANIdentifier(
    ETH_HandleTypeDef* heth,
    uint32_t           VLANTag,
