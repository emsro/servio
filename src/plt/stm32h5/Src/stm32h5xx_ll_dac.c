...
#define IS_LL_DAC_WAVE_AUTO_GENER_CONFIG(                                                         \
    __WAVE_AUTO_GENERATION_MODE__, __WAVE_AUTO_GENERATION_CONFIG__ )                              \
        ( ( ( ( __WAVE_AUTO_GENERATION_MODE__ ) == LL_DAC_WAVE_AUTO_GENERATION_NOISE ) &&         \
        ...
        if ( LL_DAC_IsEnabled( DACx, DAC_Channel ) == 0UL ) {
                ...
                MODIFY_REG(
                    ...
                    ( DAC_MCR_MODE1_1 | DAC_MCR_MODE1_0 | DAC_MCR_MODE1_2 )
                        << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ),
                    ( DAC_InitStruct->OutputBuffer | DAC_InitStruct->OutputConnection |
