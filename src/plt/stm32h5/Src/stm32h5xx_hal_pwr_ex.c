 ...
 * @retval None.
 */
void HAL_PWREx_ConfigAVD( PWREx_AVDTypeDef const* sConfigAVD )
{
        /* Check the parameters */
 ...
 * @retval None.
 */
void HAL_PWREx_EnableWakeUpPin( PWREx_WakeupPinTypeDef const* sPinParams )
{
        uint32_t       pinConfig;
        uint32_t       regMask;
        uint32_t const pullMask = PWR_WUCR_WUPPUPD1;
        ...
        regMask =
            sPinParams->WakeUpPin |
            ( PWR_WUCR_WUPP1 << ( POSITION_VAL( sPinParams->WakeUpPin ) & 0x1FU ) ) |
            ( pullMask
              << ( ( POSITION_VAL( sPinParams->WakeUpPin ) * PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET ) &
                   0x1FU ) );
 ...
 *            @arg PWR_ETHERNET_MEMORY_BLOCK      PWR_PMCR_ETHERNETSO    : Ethernet shut-off control
 * in Stop mode
 *            @arg PWR_RAM3_MEMORY_BLOCK          PWR_PMCR_SRAM3SO       : RAM3 shut-off control in
 * Stop mode
 *            @arg PWR_RAM2_16_MEMORY_BLOCK       PWR_PMCR_SRAM2_16SO    : RAM2 16k byte shut-off
 * control in Stop mode
 *            @arg PWR_RAM2_48_MEMORY_BLOCK       PWR_PMCR_SRAM2_48SO    : RAM2 48k byte shut-off
 * control in Stop mode
 *            @arg PWR_RAM1_MEMORY_BLOCK          PWR_PMCR_SRAM1SO       : RAM1 shut-off control in
 * Stop mode This parameter can be one of the following values for STM32H533xx/STM32H523xx :
 *            @arg PWR_RAM3_MEMORY_BLOCK          PWR_PMCR_SRAM3SO       : RAM3 shut-off control in
 * Stop mode
 *            @arg PWR_RAM2_LOW_16_MEMORY_BLOCK   PWR_PMCR_SRAM2_16LSO   : RAM2 Low 16k byte
 * shut-off control in Stop mode
 *            @arg PWR_RAM2_HIGH_16_MEMORY_BLOCK  PWR_PMCR_SRAM2_16HSO   : RAM2 High 16k byte
 * shut-off control in Stop mode
 *            @arg PWR_RAM2_48_MEMORY_BLOCK       PWR_PMCR_SRAM2_48SO    : RAM2 48k byte shut-off
 * control in Stop mode
 *            @arg PWR_RAM1_MEMORY_BLOCK          PWR_PMCR_SRAM1SO       : RAM1 shut-off control in
 * Stop mode This parameter can be one of the following values for STM32H503xx :
 *            @arg PWR_RAM2_MEMORY_BLOCK          PWR_PMCR_SRAM2SO       : RAM2 shut-off control in
 * Stop mode
 *            @arg PWR_RAM1_MEMORY_BLOCK          PWR_PMCR_SRAM1SO       : RAM1 shut-off control in
 * Stop mode
 * @retval None.
 ...
 * @note   When entering into standby mode, the output is sampled, and applied to the output IO
 * during the standby power mode
 * @retval None.
 */
