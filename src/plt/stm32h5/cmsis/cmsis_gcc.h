...
__STATIC_FORCEINLINE __NO_RETURN void __cmsis_start( void )
{
        ...
        extern __copy_table_t const __copy_table_start__;
        extern __copy_table_t const __copy_table_end__;
        extern __zero_table_t const __zero_table_start__;
        extern __zero_table_t const __zero_table_end__;
 ...
 */
__STATIC_FORCEINLINE uint8_t __LDREXB( uint8_t volatile* addr )
{
        uint32_t result;
 ...
 */
__STATIC_FORCEINLINE uint16_t __LDREXH( uint16_t volatile* addr )
{
        uint32_t result;
 ...
 */
__STATIC_FORCEINLINE uint32_t __LDREXW( uint32_t volatile* addr )
{
        uint32_t result;
 ...
 */
__STATIC_FORCEINLINE uint32_t __STREXB( uint8_t value, uint8_t volatile* addr )
{
        uint32_t result;
...
/**
  ...
  \return          1  Function failed
 */
__STATIC_FORCEINLINE uint32_t __STREXH( uint16_t value, uint16_t volatile* addr )
{
        uint32_t result;
...
/**
  ...
  \return          1  Function failed
 */
__STATIC_FORCEINLINE uint32_t __STREXW( uint32_t value, uint32_t volatile* addr )
{
        uint32_t result;
...
/**
  ...
  \return             value of type uint8_t at (*ptr)
 */
__STATIC_FORCEINLINE uint8_t __LDRBT( uint8_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint16_t at (*ptr)
 */
__STATIC_FORCEINLINE uint16_t __LDRHT( uint16_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint32_t at (*ptr)
 */
__STATIC_FORCEINLINE uint32_t __LDRT( uint32_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STRBT( uint8_t value, uint8_t volatile* ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STRHT( uint16_t value, uint16_t volatile* ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STRT( uint32_t value, uint32_t volatile* ptr )
{
...
{
        if ( ( sat >= 1U ) && ( sat <= 32U ) ) {
                int32_t const max = (int32_t) ( ( 1U << ( sat - 1U ) ) - 1U );
                int32_t const min = -1 - max;
                if ( val > max )
                        return max;
                else if ( val < min )
                        return min;
...
/**
  ...
  \return             value of type uint8_t at (*ptr)
 */
__STATIC_FORCEINLINE uint8_t __LDAB( uint8_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint16_t at (*ptr)
 */
__STATIC_FORCEINLINE uint16_t __LDAH( uint16_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint32_t at (*ptr)
 */
__STATIC_FORCEINLINE uint32_t __LDA( uint32_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STLB( uint8_t value, uint8_t volatile* ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STLH( uint16_t value, uint16_t volatile* ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__STATIC_FORCEINLINE void __STL( uint32_t value, uint32_t volatile* ptr )
{
...
/**
  ...
  \return             value of type uint8_t at (*ptr)
 */
__STATIC_FORCEINLINE uint8_t __LDAEXB( uint8_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint16_t at (*ptr)
 */
__STATIC_FORCEINLINE uint16_t __LDAEXH( uint16_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return        value of type uint32_t at (*ptr)
 */
__STATIC_FORCEINLINE uint32_t __LDAEX( uint32_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return          1  Function failed
 */
__STATIC_FORCEINLINE uint32_t __STLEXB( uint8_t value, uint8_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return          1  Function failed
 */
__STATIC_FORCEINLINE uint32_t __STLEXH( uint16_t value, uint16_t volatile* ptr )
{
        uint32_t result;
...
/**
  ...
  \return          1  Function failed
 */
__STATIC_FORCEINLINE uint32_t __STLEX( uint32_t value, uint32_t volatile* ptr )
{
        uint32_t result;
