...
#define TPI_ITFTTD0_ATB_IF2_ATVALID_Msk                                                        \
        ( 0x3UL << TPI_ITFTTD0_ATB_IF2_ATVALID_Pos ) /*!< TPI ITFTTD0: ATB Interface 2 ATVALID \
                                                        Mask */
...
#define TPI_ITFTTD0_ATB_IF1_ATVALID_Msk                                                        \
        ( 0x3UL << TPI_ITFTTD0_ATB_IF1_ATVALID_Pos ) /*!< TPI ITFTTD0: ATB Interface 1 ATVALID \
                                                        Mask */
...
#define TPI_ITFTTD1_ATB_IF2_ATVALID_Msk                                                        \
        ( 0x3UL << TPI_ITFTTD1_ATB_IF2_ATVALID_Pos ) /*!< TPI ITFTTD1: ATB Interface 2 ATVALID \
                                                        Mask */
...
#define TPI_ITFTTD1_ATB_IF1_ATVALID_Msk                                                        \
        ( 0x3UL << TPI_ITFTTD1_ATB_IF1_ATVALID_Pos ) /*!< TPI ITFTTD1: ATB Interface 1 ATVALID \
                                                        Mask */
...
typedef struct
{
        ...
        __IOM uint32_t FPDSCR; /*!< Offset: 0x00C (R/W)  Floating-Point Default Status Control
                                  Register */
...
#define CoreDebug_DHCSR_S_RESTART_ST_Msk                                                           \
        ( 1UL << CoreDebug_DHCSR_S_RESTART_ST_Pos ) /*!< \deprecated CoreDebug DHCSR: S_RESTART_ST \
                                                       Mask */
...
#define DCB_DAUTHCTRL_INTSPNIDEN_Msk                                                               \
        ( 0x1UL << DCB_DAUTHCTRL_INTSPNIDEN_Pos ) /*!< DCB DAUTHCTRL: Internal Secure non-invasive \
                                                     debug enable Mask */
...
#define DIB_DAUTHSTATUS_NSNID_Msk                                                                  \
        ( 0x3UL << DIB_DAUTHSTATUS_NSNID_Pos ) /*!< DIB DAUTHSTATUS: Non-secure Non-invasive Debug \
                                                  Mask */

#define DIB_DAUTHSTATUS_NSID_Pos 0U /*!< DIB DAUTHSTATUS: Non-secure Invasive Debug Position */
#define DIB_DAUTHSTATUS_NSID_Msk                                                                  \
        ( 0x3UL /*<< DIB_DAUTHSTATUS_NSID_Pos*/ ) /*!< DIB DAUTHSTATUS: Non-secure Invasive Debug \
                                                     Mask */
...
#define NVIC_BASE_NS                                                                          \
        ( SCS_BASE_NS + 0x0100UL ) /*!< NVIC Base Address                 (non-secure address \
                                      space) */
#define SCB_BASE_NS                                                                           \
        ( SCS_BASE_NS + 0x0D00UL ) /*!< System Control Block Base Address (non-secure address \
                                      space) */

#define SCnSCB_NS                                                                                 \
        ( (SCnSCB_Type*) SCS_BASE_NS ) /*!< System control Register not in SCB(non-secure address \
                                          space) */
#define SCB_NS                                                                                 \
...
#define SysTick_NS                                                                             \
        ( (SysTick_Type*) SysTick_BASE_NS ) /*!< SysTick configuration struct      (non-secure \
                                               address space) */
#define NVIC_NS                                                                                  \
        ( (NVIC_Type*) NVIC_BASE_NS ) /*!< NVIC configuration struct         (non-secure address \
                                         space) */
#define CoreDebug_NS                                                                             \
        ( (CoreDebug_Type*) CoreDebug_BASE_NS ) /*!< \deprecated Core Debug configuration struct \
                                                   (non-secure address space) */
#define DCB_NS                                                                                 \
        ( (DCB_Type*) DCB_BASE_NS ) /*!< DCB configuration struct          (non-secure address \
                                       space) */
#define DIB_NS                                                                                 \
        ( (DIB_Type*) DIB_BASE_NS ) /*!< DIB configuration struct          (non-secure address \
                                       space) */
...
__STATIC_INLINE void __NVIC_SetPriorityGrouping( uint32_t PriorityGroup )
{
        ...
        reg_value =
            ( reg_value | ( (uint32_t) 0x5FAUL << SCB_AIRCR_VECTKEY_Pos ) |
              ( PriorityGroupTmp << SCB_AIRCR_PRIGROUP_Pos ) ); /* Insert write key and priority
                                                                   group */
        SCB->AIRCR = reg_value;
}
...
__STATIC_INLINE uint32_t SysTick_Config( uint32_t ticks )
{
        ...
        NVIC_SetPriority( SysTick_IRQn, ( 1UL << __NVIC_PRIO_BITS ) - 1UL ); /* set Priority for
                                                                                Systick Interrupt */
...
__STATIC_INLINE uint32_t TZ_SysTick_Config_NS( uint32_t ticks )
{
        ...
        TZ_NVIC_SetPriority_NS( SysTick_IRQn, ( 1UL << __NVIC_PRIO_BITS ) - 1UL ); /* set Priority
                                                                                      for Systick
                                                                                      Interrupt */
...
extern int32_t volatile ITM_RxBuffer; /*!< External variable to receive characters. */
