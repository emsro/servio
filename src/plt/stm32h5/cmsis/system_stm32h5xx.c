...
/* FPU settings ------------------------------------------------------------*/
        ...
        /* Reset HSEON, HSECSSON, HSEBYP, HSEEXT, HSIDIV, HSIKERON, CSION, CSIKERON, HSI48 and
         * PLLxON bits */
#if defined( RCC_CR_PLL3ON )
        RCC->CR &=
            ~( RCC_CR_HSEON | RCC_CR_HSECSSON | RCC_CR_HSEBYP | RCC_CR_HSEEXT | RCC_CR_HSIDIV |
               RCC_CR_HSIKERON | RCC_CR_CSION | RCC_CR_CSIKERON | RCC_CR_HSI48ON | RCC_CR_PLL1ON |
...
/* Configure the Vector Table location add offset address ------------------*/
        ...
        /* Check OPSR register to verify if there is an ongoing swap or option bytes update
