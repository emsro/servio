...
#define LL_CORDIC_PRECISION_7CYCLES \
        ( (uint32_t) ( CORDIC_CSR_PRECISION_2 | CORDIC_CSR_PRECISION_1 | CORDIC_CSR_PRECISION_0 ) )
...
#define LL_CORDIC_PRECISION_11CYCLES \
        ( (uint32_t) ( CORDIC_CSR_PRECISION_3 | CORDIC_CSR_PRECISION_1 | CORDIC_CSR_PRECISION_0 ) )
...
#define LL_CORDIC_PRECISION_13CYCLES \
        ( (uint32_t) ( CORDIC_CSR_PRECISION_3 | CORDIC_CSR_PRECISION_2 | CORDIC_CSR_PRECISION_0 ) )
#define LL_CORDIC_PRECISION_14CYCLES \
        ( (uint32_t) ( CORDIC_CSR_PRECISION_3 | CORDIC_CSR_PRECISION_2 | CORDIC_CSR_PRECISION_1 ) )
 ...
 * @retval None
 */
__STATIC_INLINE void LL_CORDIC_Config(
    ...
    uint32_t        OutSize )
{
        MODIFY_REG(
            ...
            Function | Precision | Scale | NbWrite | NbRead | InSize | OutSize );
}
 ...
 *         @arg @ref LL_CORDIC_FUNCTION_SQUAREROOT
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetFunction( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_PRECISION_15CYCLES
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetPrecision( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_SCALE_7
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetScale( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_NBWRITE_2
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetNbWrite( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_NBREAD_2
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetNbRead( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_INSIZE_16BITS
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetInSize( CORDIC_TypeDef const* CORDICx )
{
 ...
 *         @arg @ref LL_CORDIC_OUTSIZE_16BITS
 */
__STATIC_INLINE uint32_t LL_CORDIC_GetOutSize( CORDIC_TypeDef const* CORDICx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CORDIC_IsEnabledIT( CORDIC_TypeDef const* CORDICx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_CORDIC_IsEnabledDMAReq_RD( CORDIC_TypeDef const* CORDICx )
{
        return (
            ( READ_BIT( CORDICx->CSR, CORDIC_CSR_DMAREN ) == ( CORDIC_CSR_DMAREN ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_CORDIC_IsEnabledDMAReq_WR( CORDIC_TypeDef const* CORDICx )
{
        return (
            ( READ_BIT( CORDICx->CSR, CORDIC_CSR_DMAWEN ) == ( CORDIC_CSR_DMAWEN ) ) ? 1U : 0U );
}
...
LL_CORDIC_DMA_GetRegAddr( CORDIC_TypeDef const* CORDICx, uint32_t Direction )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_CORDIC_IsActiveFlag_RRDY( CORDIC_TypeDef const* CORDICx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CORDIC_ReadData( CORDIC_TypeDef const* CORDICx )
{
 ...
 * @{
 */
ErrorStatus LL_CORDIC_DeInit( CORDIC_TypeDef const* CORDICx );
