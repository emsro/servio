...
LL_GPIO_IsEnabledHighSPeedLowVoltage( GPIO_TypeDef const* GPIOx, uint32_t PinMask )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_IsEnabledPinSecure( GPIO_TypeDef const* GPIOx, uint32_t PinMask )
{
