 ...
 * values */
static uint32_t const USART_PRESCALER_TAB[] = {
    1UL,
    2UL,
    4UL,
    6UL,
...
typedef struct
{
        uint32_t PrescalerValue; /*!< Specifies the Prescaler to compute the communication baud
                                    rate. This parameter can be a value of @ref
                                    USART_LL_EC_PRESCALER.
 ...
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabled( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledFIFO( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_FIFOEN ) == ( USART_CR1_FIFOEN ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_USART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_USART_GetTXFIFOThreshold( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_USART_GetRXFIFOThreshold( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledInStopMode( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_DIRECTION_TX_RX
 */
__STATIC_INLINE uint32_t LL_USART_GetTransferDirection( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_PARITY_ODD
 */
__STATIC_INLINE uint32_t LL_USART_GetParity( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_WAKEUP_ADDRESSMARK
 */
__STATIC_INLINE uint32_t LL_USART_GetWakeUpMethod( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_DATAWIDTH_9B
 */
__STATIC_INLINE uint32_t LL_USART_GetDataWidth( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledMuteMode( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_OVERSAMPLING_8
 */
__STATIC_INLINE uint32_t LL_USART_GetOverSampling( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_LASTCLKPULSE_OUTPUT
 */
__STATIC_INLINE uint32_t LL_USART_GetLastClkPulseOutput( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_PHASE_2EDGE
 */
__STATIC_INLINE uint32_t LL_USART_GetClockPhase( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_POLARITY_HIGH
 */
__STATIC_INLINE uint32_t LL_USART_GetClockPolarity( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_PRESCALER_DIV256
 */
__STATIC_INLINE uint32_t LL_USART_GetPrescaler( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSCLKOutput( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_STOPBITS_2
 */
__STATIC_INLINE uint32_t LL_USART_GetStopBitsLength( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_TXRX_SWAPPED
 */
__STATIC_INLINE uint32_t LL_USART_GetTXRXSwap( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_RXPIN_LEVEL_INVERTED
 */
__STATIC_INLINE uint32_t LL_USART_GetRXPinLevel( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_TXPIN_LEVEL_INVERTED
 */
__STATIC_INLINE uint32_t LL_USART_GetTXPinLevel( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_BINARY_LOGIC_NEGATIVE
 */
__STATIC_INLINE uint32_t LL_USART_GetBinaryDataLogic( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_BITORDER_MSBFIRST
 */
__STATIC_INLINE uint32_t LL_USART_GetTransferBitOrder( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledAutoBaud( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_AUTOBAUD_DETECT_ON_55_FRAME
 */
__STATIC_INLINE uint32_t LL_USART_GetAutoBaudRateMode( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledRxTimeout( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetNodeAddress( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_ADDRESS_DETECT_7B
 */
__STATIC_INLINE uint32_t LL_USART_GetNodeAddressLen( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_HWCONTROL_RTS_CTS
 */
__STATIC_INLINE uint32_t LL_USART_GetHWFlowCtrl( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledOneBitSamp( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR3, USART_CR3_ONEBIT ) == ( USART_CR3_ONEBIT ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledOverrunDetect( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_WAKEUP_ON_RXNE
 */
__STATIC_INLINE uint32_t LL_USART_GetWKUPType( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetRxTimeout( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetBlockLength( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIrda( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_PHASE_2EDGE
 */
__STATIC_INLINE uint32_t LL_USART_GetIrdaPowerMode( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetIrdaPrescaler( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSmartcardNACK( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSmartcard( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardAutoRetryCount( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardPrescaler( USART_TypeDef const* USARTx )
{
        return (uint32_t) ( READ_BIT( USARTx->GTPR, USART_GTPR_PSC ) );
}
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardGuardTime( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledHalfDuplex( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSPISlave( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSPISlaveSelect( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR2, USART_CR2_DIS_NSS ) != ( USART_CR2_DIS_NSS ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_USART_LINBREAK_DETECT_11B
 */
__STATIC_INLINE uint32_t LL_USART_GetLINBrkDetectionLen( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledLIN( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_GetDEDeassertionTime( USART_TypeDef const* USARTx )
{
 ...
 * @retval Time value expressed on 5 bits ([4:0] bits) : Value between Min_Data=0 and Max_Data=31
 */
__STATIC_INLINE uint32_t LL_USART_GetDEAssertionTime( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDEMode( USART_TypeDef const* USARTx )
{
 ...
 *         @arg @ref LL_USART_DE_POLARITY_LOW
 */
__STATIC_INLINE uint32_t LL_USART_GetDESignalPolarity( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_PE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_FE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_NE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ORE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_IDLE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXNE_RXFNE( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->ISR, USART_ISR_RXNE_RXFNE ) == ( USART_ISR_RXNE_RXFNE ) ) ? 1UL :
                                                                                            0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TC( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXE_TXFNF( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->ISR, USART_ISR_TXE_TXFNF ) == ( USART_ISR_TXE_TXFNF ) ) ? 1UL :
                                                                                          0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_LBD( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_nCTS( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_CTS( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RTO( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_EOB( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_UDR( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ABRE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ABR( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_BUSY( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_CM( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_SBK( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RWU( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_WKUP( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TEACK( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_REACK( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXFE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXFF( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TCBGT( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXFT( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXFT( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_IDLE( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_IDLEIE ) == ( USART_CR1_IDLEIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXNE_RXFNE( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_RXNEIE_RXFNEIE ) == ( USART_CR1_RXNEIE_RXFNEIE ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TC( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXE_TXFNF( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_TXEIE_TXFNFIE ) == ( USART_CR1_TXEIE_TXFNFIE ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_PE( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_CM( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RTO( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_EOB( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXFE( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_TXFEIE ) == ( USART_CR1_TXFEIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXFF( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR1, USART_CR1_RXFFIE ) == ( USART_CR1_RXFFIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_LBD( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_ERROR( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_CTS( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_WKUP( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXFT( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR3, USART_CR3_TXFTIE ) == ( USART_CR3_TXFTIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TCBGT( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR3, USART_CR3_TCBGTIE ) == ( USART_CR3_TCBGTIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXFT( USART_TypeDef const* USARTx )
{
        return (
            ( READ_BIT( USARTx->CR3, USART_CR3_RXFTIE ) == ( USART_CR3_RXFTIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMAReq_RX( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMAReq_TX( USART_TypeDef const* USARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMADeactOnRxErr( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_USART_DMA_GetRegAddr( USART_TypeDef const* USARTx, uint32_t Direction )
{
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0xFF
 */
__STATIC_INLINE uint8_t LL_USART_ReceiveData8( USART_TypeDef const* USARTx )
{
 ...
 */
__STATIC_INLINE uint16_t LL_USART_ReceiveData9( USART_TypeDef const* USARTx )
{
 ...
 * @{
 */
ErrorStatus LL_USART_DeInit( USART_TypeDef const* USARTx );
ErrorStatus LL_USART_Init( USART_TypeDef* USARTx, LL_USART_InitTypeDef const* USART_InitStruct );
void        LL_USART_StructInit( LL_USART_InitTypeDef* USART_InitStruct );
ErrorStatus
LL_USART_ClockInit( USART_TypeDef* USARTx, LL_USART_ClockInitTypeDef const* USART_ClockInitStruct );
