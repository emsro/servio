...
typedef struct
{
        uint32_t Prescaler; /*!< Specifies the prescaler value used to divide the TIM clock.
                               ...
                               Max_Data = 0xFFFF Macro __HAL_TIM_CALC_PSC() can be used to calculate
                               prescaler value */
        ...
        uint32_t Period; /*!< Specifies the period value to be loaded into the active
                            ...
                            = 0xFFFF (or 0xFFEF if dithering is activated)Macros
                            __HAL_TIM_CALC_PERIOD(),
                               __HAL_TIM_CALC_PERIOD_DITHER(),__HAL_TIM_CALC_PERIOD_BY_DELAY(),
                               __HAL_TIM_CALC_PERIOD_DITHER_BY_DELAY()can be used to calculate
                            Period value */
...
typedef struct
{
        ...
        uint32_t Pulse; /*!< Specifies the pulse value to be loaded into the Capture Compare
                           ...
                           __HAL_TIM_CALC_PULSE(), __HAL_TIM_CALC_PULSE_DITHER() can be used to
...
typedef struct
{
        ...
        uint32_t Break2Polarity; /*!< TIM Break2 input polarity, This parameter can be a value of
                                    @ref TIM_Break2_Polarity */
...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
        ...
        __IO HAL_TIM_ChannelStateTypeDef ChannelNState[4]; /*!< TIM complementary channel operation
                                                              state         */
        __IO HAL_TIM_DMABurstStateTypeDef DMABurstState;   /*!< DMA burst operation state   */

#if ( USE_HAL_TIM_REGISTER_CALLBACKS == 1 )
        void ( *Base_MspInitCallback )( struct __TIM_HandleTypeDef* htim );   /*!< TIM Base Msp Init
                                                                                 Callback   */
        void ( *Base_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Base Msp
                                                                                 DeInit Callback */
        void ( *IC_MspInitCallback )( struct __TIM_HandleTypeDef* htim );     /*!< TIM IC Msp Init
                                                                                 Callback     */
        void ( *IC_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim );   /*!< TIM IC Msp DeInit
                                                                                 Callback   */
        void ( *OC_MspInitCallback )( struct __TIM_HandleTypeDef* htim );     /*!< TIM OC Msp Init
                                                                                 Callback     */
        void ( *OC_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim );   /*!< TIM OC Msp DeInit
                                                                                 Callback   */
        void ( *PWM_MspInitCallback )( struct __TIM_HandleTypeDef* htim );    /*!< TIM PWM Msp Init
                                                                                 Callback    */
        void ( *PWM_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM PWM Msp DeInit
                                                                                Callback */
        void ( *OnePulse_MspInitCallback )( struct __TIM_HandleTypeDef* htim );   /*!< TIM One Pulse
                                                                                     Msp Init Callback
                                                                                   */
        void ( *OnePulse_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM One Pulse
                                                                                     Msp DeInit
                                                                                     Callback */
        void ( *Encoder_MspInitCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Encoder Msp
                                                                                  Init Callback */
        void ( *Encoder_MspDeInitCallback )( struct __TIM_HandleTypeDef* htim );  /*!< TIM Encoder
                                                                                     Msp DeInit
                                                                                     Callback  */
        void ( *HallSensor_MspInitCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Hall
                                                                                     Sensor Msp Init
                                                                                     Callback */
        void ( *HallSensor_MspDeInitCallback )(
            struct __TIM_HandleTypeDef* htim ); /*!< TIM Hall Sensor Msp DeInit Callback */
        void ( *PeriodElapsedCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Period Elapsed
                                                                                Callback */
        ...
        void ( *TriggerHalfCpltCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Trigger half
                                                                                  complete Callback
                                                                                */
        void ( *IC_CaptureCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Input Capture
                                                                             Callback */
        ...
        void ( *PWM_PulseFinishedCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM PWM Pulse
                                                                                    Finished
                                                                                    Callback */
        ...
        void ( *CommutationCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Commutation
                                                                              Callback */
        ...
        void ( *EncoderIndexCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Encoder Index
                                                                               Callback */
        void ( *DirectionChangeCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Direction
                                                                                  Change Callback */
        void ( *IndexErrorCallback )( struct __TIM_HandleTypeDef* htim );      /*!< TIM Index Error
                                                                                  Callback      */
        void ( *TransitionErrorCallback )( struct __TIM_HandleTypeDef* htim ); /*!< TIM Transition
                                                                                  Error Callback */
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
} TIM_HandleTypeDef;
 ...
 */
typedef void ( *pTIM_CallbackTypeDef )( TIM_HandleTypeDef* htim ); /*!< pointer to the TIM callback
                                                                      function */
...
#define TIM_TRGO2_OC1                                                                            \
        ( TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0 ) /*!< Capture or a compare match 1 is used as trigger \
                                               output (TRGO2) */
...
#define TIM_TRGO2_OC4REF_RISINGFALLING                                                             \
        ( TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 ) /*!< OC4REF rising or falling edges generate pulses on \
                                               TRGO2        */
...
#define TIM_TRGO2_OC4REF_RISING_OC6REF_RISING                                                     \
        ( TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 ) /*!< OC4REF or OC6REF rising edges generate pulses on \
                                               TRGO2         */
#define TIM_TRGO2_OC4REF_RISING_OC6REF_FALLING                                                    \
        ( TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0 ) /*!< OC4REF rising or OC6REF falling \
                                                                edges generate pulses on TRGO2 */
...
#define TIM_OCMODE_DIRECTION_OUTPUT                                                               \
        ( TIM_CCMR2_OC3M_3 | TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC3M_0 ) /*!< Direction output (CH3&CH4 \
                                                                      only)        */
/**
 * @}
 */
...
#define TIM_TS_ITR11                                                                               \
        ( TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_2 | TIM_SMCR_TS_3 ) /*!< Internal Trigger 11 \
                                                                             (ITR11)            */
...
#define TIM_TS_ETRF                                                                            \
        ( TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_2 ) /*!< Filtered External Trigger input \
                                                             (ETRF) */
...
#define TIM_BREAK_SYSTEM_ECC                                                           \
        SBS_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of \
                          TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_PVD                                                                   \
        SBS_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17/20 Break \
                          Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR                                                    \
        SBS_CFGR2_SEL /*!< Enables and locks the SRAM_PARITY error signal with Break Input of \
                         TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_LOCKUP                                                                \
        SBS_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of \
                         TIM1/8/15/16/17/20 */
/**
 * @}
 */
...
#define IS_TIM_CLOCKDIVISION_DIV( __DIV__ )            \
        ( ( ( __DIV__ ) == TIM_CLOCKDIVISION_DIV1 ) || \
          ( ( __DIV__ ) == TIM_CLOCKDIVISION_DIV2 ) || ( ( __DIV__ ) == TIM_CLOCKDIVISION_DIV4 ) )
...
HAL_StatusTypeDef
HAL_TIM_Base_Start_DMA( TIM_HandleTypeDef* htim, uint32_t const* pData, uint16_t Length );
...
HAL_StatusTypeDef
HAL_TIM_Encoder_Init( TIM_HandleTypeDef* htim, TIM_Encoder_InitTypeDef const* sConfig );
...
HAL_StatusTypeDef HAL_TIM_OC_ConfigChannel(
    TIM_HandleTypeDef*        htim,
    TIM_OC_InitTypeDef const* sConfig,
    uint32_t                  Channel );
...
HAL_StatusTypeDef HAL_TIM_IC_ConfigChannel(
    TIM_HandleTypeDef*        htim,
    TIM_IC_InitTypeDef const* sConfig,
    uint32_t                  Channel );
...
HAL_StatusTypeDef HAL_TIM_ConfigOCrefClear(
    TIM_HandleTypeDef*                 htim,
    TIM_ClearInputConfigTypeDef const* sClearInputConfig,
    uint32_t                           Channel );
HAL_StatusTypeDef HAL_TIM_ConfigClockSource(
    TIM_HandleTypeDef*            htim,
    TIM_ClockConfigTypeDef const* sClockSourceConfig );
HAL_StatusTypeDef HAL_TIM_ConfigTI1Input( TIM_HandleTypeDef* htim, uint32_t TI1_Selection );
HAL_StatusTypeDef
HAL_TIM_SlaveConfigSynchro( TIM_HandleTypeDef* htim, TIM_SlaveConfigTypeDef const* sSlaveConfig );
HAL_StatusTypeDef HAL_TIM_SlaveConfigSynchro_IT(
    TIM_HandleTypeDef*            htim,
    TIM_SlaveConfigTypeDef const* sSlaveConfig );
HAL_StatusTypeDef HAL_TIM_DMABurst_WriteStart(
    TIM_HandleTypeDef* htim,
    uint32_t           BurstBaseAddress,
    uint32_t           BurstRequestSrc,
    uint32_t const*    BurstBuffer,
...
uint32_t          HAL_TIM_ReadCapturedValue( TIM_HandleTypeDef const* htim, uint32_t Channel );
/**
 * @}
 */
...
HAL_TIM_StateTypeDef HAL_TIM_Base_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_StateTypeDef HAL_TIM_OC_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_StateTypeDef HAL_TIM_PWM_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_StateTypeDef HAL_TIM_IC_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_StateTypeDef HAL_TIM_OnePulse_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_StateTypeDef HAL_TIM_Encoder_GetState( TIM_HandleTypeDef const* htim );

/* Peripheral Channel state functions  ************************************************/
HAL_TIM_ActiveChannel HAL_TIM_GetActiveChannel( TIM_HandleTypeDef const* htim );
HAL_TIM_ChannelStateTypeDef
HAL_TIM_GetChannelState( TIM_HandleTypeDef const* htim, uint32_t Channel );
HAL_TIM_DMABurstStateTypeDef HAL_TIM_DMABurstState( TIM_HandleTypeDef const* htim );
/**
 * @}
 */
 ...
 * @{
 */
void TIM_Base_SetConfig( TIM_TypeDef* TIMx, TIM_Base_InitTypeDef const* Structure );
void TIM_TI1_SetConfig(
    TIM_TypeDef* TIMx,
    uint32_t     TIM_ICPolarity,
    uint32_t     TIM_ICSelection,
    uint32_t     TIM_ICFilter );
void TIM_OC2_SetConfig( TIM_TypeDef* TIMx, TIM_OC_InitTypeDef const* OC_Config );
...
HAL_StatusTypeDef
TIM_DMA_Start_IT( DMA_HandleTypeDef* hdma, uint32_t src, uint32_t dst, uint32_t length );
