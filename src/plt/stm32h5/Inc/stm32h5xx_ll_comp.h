...
typedef struct
{
        ...
        uint32_t InputHysteresis; /*!< Set comparator hysteresis mode of the input minus.
                                     ...
                                     COMP_LL_EC_INPUT_HYSTERESIS This feature can be modified
                                     afterwards using unitary function @ref
                                     LL_COMP_SetInputHysteresis(). */

        uint32_t OutputPolarity; /*!< Set comparator output polarity.
                                      This parameter can be a value of @ref
                                    COMP_LL_EC_OUTPUT_POLARITY This feature can be modified
                                    afterwards using unitary function @ref
                                    LL_COMP_SetOutputPolarity(). */

        uint32_t OutputBlankingSource; /*!< Set comparator blanking source.
                                            This parameter can be a value of @ref
                                          COMP_LL_EC_OUTPUT_BLANKING_SOURCE This feature can be
...
#define LL_COMP_POWERMODE_ULTRALOWPOWER \
        ( COMP_CFGR1_PWRMODE_1 | COMP_CFGR1_PWRMODE_0 ) /*!< COMP power mode to ultra-low power */
/**
 * @}
 */
...
#define LL_COMP_INPUT_MINUS_1_4VREFINT                                                        \
        ( COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN ) /*!< Comparator input minus connected to 1/4 \
                                                    VrefInt */
...
#define LL_COMP_INPUT_MINUS_IO1                                                                    \
        ( COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_0 ) /*!< Comparator input minus connected to pin \
                                                         PC4 */
#define LL_COMP_INPUT_MINUS_IO2                                                                    \
        ( COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1 ) /*!< Comparator input minus connected to pin \
                                                         PB1 */
...
#define LL_COMP_INPUT_MINUS_VBAT                                                                  \
        ( COMP_CFGR1_INMSEL_3 | COMP_CFGR1_INMSEL_0 ) /*!< Comparator input minus connected to    \
                              Vbat/4: Vbat voltage through a divider ladder of factor 1/4 to have \
                              input voltage always below Vdda. */
...
#define LL_COMP_OUTPUTPOL_INVERTED                                                       \
        ( COMP_CFGR1_POLARITY ) /*!< COMP output polarity is inverted: comparator output \
...
#define LL_COMP_BLANKINGSRC_TIM3_OC3                                                             \
        ( COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1 ) /*!< Comparator output blanking source \
                                                             TIM3 OC3 */
...
#define LL_COMP_BLANKINGSRC_LPTIM1_OC2                                                           \
        ( COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0 ) /*!< Comparator output blanking source \
                                                             LPTIM1 OC2 */
#define LL_COMP_BLANKINGSRC_LPTIM2_OC2                                                           \
        ( COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1 ) /*!< Comparator output blanking source \
                                                             LPTIM2 OC2 */
/**
 * @}
 */
 ...
 *         @arg @ref LL_COMP_POWERMODE_ULTRALOWPOWER
 */
__STATIC_INLINE uint32_t LL_COMP_GetPowerMode( COMP_TypeDef const* COMPx )
{
...
LL_COMP_ConfigInputs( COMP_TypeDef* COMPx, uint32_t InputMinus, uint32_t InputPlus )
{
        MODIFY_REG(
            COMPx->CFGR2,
            COMP_CFGR2_INPSEL0,
        ...
        MODIFY_REG(
            COMPx->CFGR1,
            COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 | COMP_CFGR1_SCALEN |
                COMP_CFGR1_BRGEN,
 ...
 *         @arg @ref LL_COMP_INPUT_PLUS_DAC1_CH1
 */
__STATIC_INLINE uint32_t LL_COMP_GetInputPlus( COMP_TypeDef const* COMPx )
{
        uint32_t val;
...
{
        MODIFY_REG(
            COMPx->CFGR1, COMP_CFGR1_INMSEL | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN, InputMinus );
}
 ...
 *         @arg @ref LL_COMP_INPUT_MINUS_VBAT
 */
__STATIC_INLINE uint32_t LL_COMP_GetInputMinus( COMP_TypeDef const* COMPx )
{
 ...
 *         @arg @ref LL_COMP_HYSTERESIS_HIGH
 */
__STATIC_INLINE uint32_t LL_COMP_GetInputHysteresis( COMP_TypeDef const* COMPx )
{
 ...
 *         @arg @ref LL_COMP_OUTPUTPOL_INVERTED
 */
__STATIC_INLINE uint32_t LL_COMP_GetOutputPolarity( COMP_TypeDef const* COMPx )
{
 ...
 *         @arg @ref LL_COMP_BLANKINGSRC_LPTIM2_OC2
 */
__STATIC_INLINE uint32_t LL_COMP_GetOutputBlankingSource( COMP_TypeDef const* COMPx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_COMP_IsEnabled( COMP_TypeDef const* COMPx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_COMP_IsLocked( COMP_TypeDef const* COMPx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_COMP_ReadOutputLevel( COMP_TypeDef const* COMPx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_COMP_IsActiveFlag_OutputTrig( COMP_TypeDef const* COMPx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_COMP_IsEnabledIT_OutputTrig( COMP_TypeDef const* COMPx )
{
...
ErrorStatus LL_COMP_Init( COMP_TypeDef* COMPx, LL_COMP_InitTypeDef const* COMP_InitStruct );
