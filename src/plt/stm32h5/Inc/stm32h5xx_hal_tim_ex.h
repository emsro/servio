...
typedef struct
{
        ...
        uint32_t Filter; /*!< TIM Encoder index filter.This parameter can be a number between
                            Min_Data = 0x0 and Max_Data = 0xF */

        uint32_t Blanking; /*!< Specifies whether or not the encoder index event is conditioned by
                              TI3 or TI4 input.This parameter can be a value of @ref
                              TIMEx_Encoder_Index_Blanking */
        ...
        uint32_t Position; /*!< Specifies in which AB input configuration the index event resets the
                              counter.This parameter can be a value of @ref
                              TIMEx_Encoder_Index_Position */

        uint32_t Direction; /*!< Specifies in which counter direction the index event resets the
                               counter.This parameter can be a value of @ref
                               TIMEx_Encoder_Index_Direction */
...
#define TIM_TIM2_ETR_SAI1_FSB \
        ( TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0 ) /*!< TIM2_ETR is connected to SAI1            */
#endif                                            /* SAI1 */
#define TIM_TIM2_ETR_TIM3_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_0 ) /*!< TIM2_ETR is connected to TIM3 ETR        */
#if defined( TIM4 )
#define TIM_TIM2_ETR_TIM4_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 ) /*!< TIM2_ETR is connected to TIM4 ETR        */
#endif                                            /* TIM4 */
#if defined( TIM5 )
#define TIM_TIM2_ETR_TIM5_ETR                                                                    \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM2_ETR is connected \
                                                                         to TIM5 ETR        */
#endif                                                                /* TIM5 */
#if defined( USB_DRD_FS )
#define TIM_TIM2_ETR_USB_SOF                                                                     \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0 ) /*!< TIM2_ETR is connected \
                                                                         to USB SOF         */
#elif defined( USB_OTG_HS )
#define TIM_TIM2_ETR_USBHS_SOF \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 ) /*!< TIM2_ETR is connected to USBHS OTG SOF   */
...
#define TIM_TIM2_ETR_ETH_PPS                                                                     \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 ) /*!< TIM2_ETR is connected \
                                                                         to ETH PPS         */
#endif                                                                /* ETH_NS */
#if defined( PLAY1 )
...
#define TIM_TIM3_ETR_ADC2_AWD1 \
        ( TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM3_ETR is connected to ADC2 AWD1       */
#define TIM_TIM3_ETR_ADC2_AWD2 TIM1_AF1_ETRSEL_2  /*!< TIM3_ETR is connected to ADC2 AWD2       */
#define TIM_TIM3_ETR_ADC2_AWD3 \
        ( TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0 ) /*!< TIM3_ETR is connected to ADC2 AWD3       */
#endif                                            /* ADC2 */
#define TIM_TIM3_ETR_TIM2_ETR TIM1_AF1_ETRSEL_3   /*!< TIM3_ETR is connected to TIM2 ETR        */
#if defined( TIM4 )
#define TIM_TIM3_ETR_TIM4_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 ) /*!< TIM3_ETR is connected to TIM4 ETR        */
#endif                                            /* TIM4 */
#if defined( TIM5 )
#define TIM_TIM3_ETR_TIM5_ETR                                                                    \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM3_ETR is connected \
                                                                         to TIM5 ETR        */
#endif                                                                /* TIM5 */
#if defined( ETH_NS )
#define TIM_TIM3_ETR_ETH_PPS                                                                     \
        ( TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_3 ) /*!< TIM3_ETR is connected \
                                                                         to ETH PPS         */
#endif                                                                /* ETH_NS */
#if defined( PLAY1 )
...
#define TIM_TIM4_ETR_TIM3_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_0 ) /*!< TIM4_ETR is connected to TIM3 ETR        */
#define TIM_TIM4_ETR_TIM5_ETR                                                                    \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM4_ETR is connected \
                                                                         to TIM5 ETR        */
#endif                                                                /* TIM4 */
...
#define TIM_TIM5_ETR_TIM3_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_0 ) /*!< TIM5_ETR is connected to TIM3 ETR        */
#define TIM_TIM5_ETR_TIM4_ETR \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 ) /*!< TIM5_ETR is connected to TIM4 ETR        */
#if defined( USB_DRD_FS )
#define TIM_TIM5_ETR_USB_SOF                                                                     \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0 ) /*!< TIM5_ETR is connected \
                                                                         to USB SOF         */
#elif defined( USB_OTG_HS )
#define TIM_TIM5_ETR_USBHS_SOF \
        ( TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 ) /*!< TIM5_ETR is connected to USBHS OTG SOF   */
...
#define TIM_TIM8_ETR_ADC2_AWD1 \
        ( TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM8_ETR is connected to ADC2 AWD1       */
#define TIM_TIM8_ETR_ADC2_AWD2 TIM1_AF1_ETRSEL_2  /*!< TIM8_ETR is connected to ADC2 AWD2       */
#define TIM_TIM8_ETR_ADC2_AWD3 \
        ( TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0 ) /*!< TIM8_ETR is connected to ADC2 AWD3       */
#if defined( ADC3 )
#define TIM_TIM8_ETR_ADC3_AWD1 \
        ( TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 ) /*!< TIM8_ETR is connected to ADC3 AWD1       */
#define TIM_TIM8_ETR_ADC3_AWD2                                                                   \
        ( TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0 ) /*!< TIM8_ETR is connected \
                                                                         to ADC3 AWD2       */
...
#define TIM_BREAKINPUTSOURCE_PLAY1 \
        0x00000008U /*!< The PLAY1 output is connected to the break input (only for BKIN) */
#endif              /* PLAY1 */
#if defined( MDF1 )
#define TIM_BREAKINPUTSOURCE_MDF1 \
        0x00000100U /*!< The Digital filter break output is connected to the break input */
#endif              /* MDF1 */
/**
 * @}
 */
...
#define TIM_TIM1_TI1_COMP2 \
        ( TIM_TISEL_TI1SEL_1 | TIM_TISEL_TI1SEL_0 ) /*!< TIM1_TI1 is connected to COMP2 OUT */
#elif defined( COMP1 )
...
#define TIM_ENCODERINDEX_POSITION_1                                                              \
        TIM_ECR_IPOS_0 /*!< In directional clock mode or clock plus direction mode, index resets \
                          the counter when clock is 1 */
/**
 * @}
 */
...
#define __HAL_TIM_CALC_PERIOD_DITHER( __TIMCLK__, __PSC__, __FREQ__ )                      \
        ( ( ( __TIMCLK__ ) / ( ( __PSC__ ) + 1U ) ) >= ( __FREQ__ ) ) ?                    \
            (uint32_t) ( (                                                                 \
                (uint64_t) ( __TIMCLK__ ) * 16 / ( ( __FREQ__ ) * ( ( __PSC__ ) + 1U ) ) - \
                16U ) ) :                                                                  \
            0U
        ...
        ( ( ( ( INSTANCE ) == TIM1 ) &&                                                            \
          ...
          ( ( ( INSTANCE ) == TIM2 ) &&                                                            \
            ( ( ( __SELECTION__ ) == TIM_TS_ITR0 ) || ( ( __SELECTION__ ) == TIM_TS_ITR2 ) ||      \
              ( ( __SELECTION__ ) == TIM_TS_ITR12 ) || ( ( __SELECTION__ ) == TIM_TS_TI1F_ED ) ||  \
...
#define IS_TIM_INTERNAL_TRIGGEREVENT_INSTANCE( INSTANCE, __SELECTION__ )                           \
        ( ( ( ( INSTANCE ) == TIM1 ) &&                                                            \
          ...
          ( ( ( INSTANCE ) == TIM2 ) &&                                                            \
            ( ( ( __SELECTION__ ) == TIM_TS_ITR0 ) || ( ( __SELECTION__ ) == TIM_TS_ITR2 ) ||      \
              ( ( __SELECTION__ ) == TIM_TS_ITR12 ) || ( ( __SELECTION__ ) == TIM_TS_NONE ) ) ) || \
          ( ( ( INSTANCE ) == TIM3 ) &&                                                            \
            ( ( ( __SELECTION__ ) == TIM_TS_ITR0 ) || ( ( __SELECTION__ ) == TIM_TS_ITR1 ) ||      \
              ( ( __SELECTION__ ) == TIM_TS_NONE ) ) ) )
#else
...
HAL_StatusTypeDef
HAL_TIMEx_HallSensor_Init( TIM_HandleTypeDef* htim, TIM_HallSensor_InitTypeDef const* sConfig );
...
HAL_StatusTypeDef HAL_TIMEx_MasterConfigSynchronization(
    TIM_HandleTypeDef*             htim,
    TIM_MasterConfigTypeDef const* sMasterConfig );
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakDeadTime(
    TIM_HandleTypeDef*                    htim,
    TIM_BreakDeadTimeConfigTypeDef const* sBreakDeadTimeConfig );
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakInput(
    TIM_HandleTypeDef*                   htim,
    uint32_t                             BreakInput,
    TIMEx_BreakInputConfigTypeDef const* sBreakInputConfig );
...
HAL_StatusTypeDef HAL_TIMEx_ReArmBreakInput( TIM_HandleTypeDef const* htim, uint32_t BreakInput );
...
HAL_TIM_StateTypeDef HAL_TIMEx_HallSensor_GetState( TIM_HandleTypeDef const* htim );
HAL_TIM_ChannelStateTypeDef
HAL_TIMEx_GetChannelNState( TIM_HandleTypeDef const* htim, uint32_t ChannelN );
/**
 * @}
 */
