 ...
 * values */
static uint16_t const LPUART_PRESCALER_TAB[] = {
    (uint16_t) 1,
    (uint16_t) 2,
    (uint16_t) 4,
    (uint16_t) 6,
...
typedef struct
{
        ...
        uint32_t DataWidth; /*!< Specifies the number of data bits transmitted or received in a
                               frame. This parameter can be a value of @ref LPUART_LL_EC_DATAWIDTH.
 ...
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabled( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledFIFO( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_FIFOEN ) == ( USART_CR1_FIFOEN ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_LPUART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTXFIFOThreshold( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_LPUART_GetRXFIFOThreshold( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledInStopMode( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_DIRECTION_TX_RX
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTransferDirection( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_PARITY_ODD
 */
__STATIC_INLINE uint32_t LL_LPUART_GetParity( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_WAKEUP_ADDRESSMARK
 */
__STATIC_INLINE uint32_t LL_LPUART_GetWakeUpMethod( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_DATAWIDTH_9B
 */
__STATIC_INLINE uint32_t LL_LPUART_GetDataWidth( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledMuteMode( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_PRESCALER_DIV256
 */
__STATIC_INLINE uint32_t LL_LPUART_GetPrescaler( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_STOPBITS_2
 */
__STATIC_INLINE uint32_t LL_LPUART_GetStopBitsLength( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_TXRX_SWAPPED
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTXRXSwap( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_RXPIN_LEVEL_INVERTED
 */
__STATIC_INLINE uint32_t LL_LPUART_GetRXPinLevel( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_TXPIN_LEVEL_INVERTED
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTXPinLevel( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_BINARY_LOGIC_NEGATIVE
 */
__STATIC_INLINE uint32_t LL_LPUART_GetBinaryDataLogic( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_BITORDER_MSBFIRST
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTransferBitOrder( USART_TypeDef const* LPUARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_LPUART_GetNodeAddress( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_ADDRESS_DETECT_7B
 */
__STATIC_INLINE uint32_t LL_LPUART_GetNodeAddressLen( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_HWCONTROL_RTS_CTS
 */
__STATIC_INLINE uint32_t LL_LPUART_GetHWFlowCtrl( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledOverrunDetect( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_WAKEUP_ON_RXNE
 */
__STATIC_INLINE uint32_t LL_LPUART_GetWKUPType( USART_TypeDef const* LPUARTx )
{
...
LL_LPUART_GetBaudRate( USART_TypeDef const* LPUARTx, uint32_t PeriphClk, uint32_t PrescalerValue )
{
        uint32_t lpuartdiv;
        uint32_t brrresult;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledHalfDuplex( USART_TypeDef const* LPUARTx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_LPUART_GetDEDeassertionTime( USART_TypeDef const* LPUARTx )
{
 ...
 * Max_Data=31
 */
__STATIC_INLINE uint32_t LL_LPUART_GetDEAssertionTime( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDEMode( USART_TypeDef const* LPUARTx )
{
 ...
 *         @arg @ref LL_LPUART_DE_POLARITY_LOW
 */
__STATIC_INLINE uint32_t LL_LPUART_GetDESignalPolarity( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_PE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_FE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_NE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_ORE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_IDLE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXNE_RXFNE( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->ISR, USART_ISR_RXNE_RXFNE ) == ( USART_ISR_RXNE_RXFNE ) ) ? 1UL :
                                                                                             0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TC( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXE_TXFNF( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->ISR, USART_ISR_TXE_TXFNF ) == ( USART_ISR_TXE_TXFNF ) ) ? 1UL :
                                                                                           0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_nCTS( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_CTS( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_BUSY( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_CM( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_SBK( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RWU( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_WKUP( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TEACK( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_REACK( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXFE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXFF( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXFT( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXFT( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_IDLE( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_IDLEIE ) == ( USART_CR1_IDLEIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXNE_RXFNE( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_RXNEIE_RXFNEIE ) == ( USART_CR1_RXNEIE_RXFNEIE ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TC( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXE_TXFNF( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_TXEIE_TXFNFIE ) == ( USART_CR1_TXEIE_TXFNFIE ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_PE( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_CM( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXFE( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_TXFEIE ) == ( USART_CR1_TXFEIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXFF( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR1, USART_CR1_RXFFIE ) == ( USART_CR1_RXFFIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_ERROR( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_CTS( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_WKUP( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXFT( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR3, USART_CR3_TXFTIE ) == ( USART_CR3_TXFTIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXFT( USART_TypeDef const* LPUARTx )
{
        return (
            ( READ_BIT( LPUARTx->CR3, USART_CR3_RXFTIE ) == ( USART_CR3_RXFTIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMAReq_RX( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMAReq_TX( USART_TypeDef const* LPUARTx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMADeactOnRxErr( USART_TypeDef const* LPUARTx )
{
 ...
 */
__STATIC_INLINE uint32_t
LL_LPUART_DMA_GetRegAddr( USART_TypeDef const* LPUARTx, uint32_t Direction )
{
 ...
 */
__STATIC_INLINE uint8_t LL_LPUART_ReceiveData8( USART_TypeDef const* LPUARTx )
{
 ...
 */
__STATIC_INLINE uint16_t LL_LPUART_ReceiveData9( USART_TypeDef const* LPUARTx )
{
 ...
 * @{
 */
ErrorStatus LL_LPUART_DeInit( USART_TypeDef const* LPUARTx );
ErrorStatus
     LL_LPUART_Init( USART_TypeDef* LPUARTx, LL_LPUART_InitTypeDef const* LPUART_InitStruct );
