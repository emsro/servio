...
#if ( USE_HAL_RAMCFG_REGISTER_CALLBACKS == 1 )
        void ( *MspInitCallback )( struct __RAMCFG_HandleTypeDef* hramcfg );   /*!< RAMCFG MSP Init
                                                                                  Callback   */
        void ( *MspDeInitCallback )( struct __RAMCFG_HandleTypeDef* hramcfg ); /*!< RAMCFG MSP
                                                                                  DeInit Callback */
        void ( *DetectSingleErrorCallback )(
            struct __RAMCFG_HandleTypeDef* hramcfg ); /*!< RAMCFG Single Error Detect Callback */
        void ( *DetectDoubleErrorCallback )(
            struct __RAMCFG_HandleTypeDef* hramcfg ); /*!< RAMCFG Double Error Detect Callback */
#endif                                                /* USE_HAL_RAMCFG_REGISTER_CALLBACKS */
 ...
 *         interrupts. RAMCFG_IT_NMIERR interrupt can only be disabled by global  peripheral reset
 * or system reset.
 * @param  __HANDLE__   : Specifies RAMCFG handle.
...
HAL_StatusTypeDef
HAL_RAMCFG_EnableNotification( RAMCFG_HandleTypeDef* hramcfg, uint32_t Notifications );
HAL_StatusTypeDef
         HAL_RAMCFG_DisableNotification( RAMCFG_HandleTypeDef* hramcfg, uint32_t Notifications );
uint32_t HAL_RAMCFG_IsECCSingleErrorDetected( RAMCFG_HandleTypeDef const* hramcfg );
uint32_t HAL_RAMCFG_IsECCDoubleErrorDetected( RAMCFG_HandleTypeDef const* hramcfg );
uint32_t HAL_RAMCFG_GetSingleErrorAddress( RAMCFG_HandleTypeDef const* hramcfg );
uint32_t HAL_RAMCFG_GetDoubleErrorAddress( RAMCFG_HandleTypeDef const* hramcfg );
/**
 * @}
 */
 ...
 * @{
 */
uint32_t                HAL_RAMCFG_GetError( RAMCFG_HandleTypeDef const* hramcfg );
HAL_RAMCFG_StateTypeDef HAL_RAMCFG_GetState( RAMCFG_HandleTypeDef const* hramcfg );
/**
 * @}
 */
