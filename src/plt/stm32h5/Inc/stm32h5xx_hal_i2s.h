...
typedef struct __I2S_HandleTypeDef
{
        ...
        uint16_t const* pTxBuffPtr; /*!< Pointer to I2S Tx transfer buffer */
        ...
        void ( *RxCpltCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S Rx Completed callback
                                                                       */
        void ( *TxRxCpltCallback )( struct __I2S_HandleTypeDef* hi2s );   /*!< I2S TxRx Completed
                                                                             callback        */
        void ( *TxHalfCpltCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S Tx Half Completed
                                                                             callback     */
        void ( *RxHalfCpltCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S Rx Half Completed
                                                                             callback     */
        void ( *TxRxHalfCpltCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S TxRx Half
                                                                               Completed callback */
        void ( *ErrorCallback )( struct __I2S_HandleTypeDef* hi2s );   /*!< I2S Error callback   */
        void ( *MspInitCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S Msp Init callback */
        void ( *MspDeInitCallback )( struct __I2S_HandleTypeDef* hi2s ); /*!< I2S Msp DeInit
                                                                            callback            */
 ...
 */
typedef void ( *pI2S_CallbackTypeDef )( I2S_HandleTypeDef* hi2s ); /*!< pointer to an I2S callback
                                                                      function */
...
#define I2S_FLAG_MASK \
        ( SPI_SR_RXP | SPI_SR_TXP | SPI_SR_DXP | SPI_SR_UDR | SPI_SR_OVR | SPI_SR_TIFRE )
/**
 * @}
 */
...
#define __HAL_I2S_GET_IT_SOURCE( __HANDLE__, __INTERRUPT__ )                                     \
        ( ( ( ( __HANDLE__ )->Instance->IER & ( __INTERRUPT__ ) ) == ( __INTERRUPT__ ) ) ? SET : \
                                                                                           RESET )
...
#define I2S_CHECK_FLAG( __SR__, __FLAG__ )                       \
        ( ( ( ( __SR__ ) & ( ( __FLAG__ ) & I2S_FLAG_MASK ) ) == \
            ( ( __FLAG__ ) & I2S_FLAG_MASK ) ) ?                 \
              SET :                                              \
              RESET )
...
#define IS_I2S_STANDARD( __STANDARD__ )                                                           \
        ( ( ( __STANDARD__ ) == I2S_STANDARD_PHILIPS ) ||                                         \
          ( ( __STANDARD__ ) == I2S_STANDARD_MSB ) || ( ( __STANDARD__ ) == I2S_STANDARD_LSB ) || \
