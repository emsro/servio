...
static uint8_t const LL_LPTIM_SHIFT_TAB_CCxP[] = {
    0U, /* CC1P */
    16U /* CC2P */
};

static uint8_t const LL_LPTIM_SHIFT_TAB_ICxF[] = {
    0U, /* IC1F */
    16U /* IC2F */
};

static uint8_t const LL_LPTIM_SHIFT_TAB_ICxPSC[] = {
    0U, /* IC1PSC */
    16U /* IC2PSC */
};

static uint8_t const LL_LPTIM_SHIFT_TAB_CCxSEL[] = {
    0U, /* CC1SEL */
    16U /* CC2SEL */
};

static uint8_t const LL_LPTIM_SHIFT_TAB_CCxE[] = {
    LPTIM_CCMR1_CC1E_Pos, /* CC1E */
    LPTIM_CCMR1_CC2E_Pos  /* CC2E */
};

static uint8_t const LL_LPTIM_OFFSET_TAB_ICx[8][4] = {
    { 2, 7, 9, 13 },
    { 3, 5, 6, 8 },
    { 2, 3, 4, 5 },
    { 2, 2, 3, 3 },
...
#define LL_LPTIM_OPERATING_MODE_CONTINUOUS                                                 \
        LPTIM_CR_CNTSTRT                                 /*!<LP Timer starts in continuous \
                                                            mode*/
...
#define LL_LPTIM_UPDATE_MODE_IMMEDIATE                                                      \
        0x00000000U /*!<Preload is disabled: registers are updated after each APB bus write \
                       access*/
#define LL_LPTIM_UPDATE_MODE_ENDOFPERIOD                                                           \
        LPTIM_CFGR_PRELOAD /*!<preload is enabled: registers are updated at the end of the current \
                              LPTIM period*/
/**
 * @}
 */
...
#define LL_LPTIM_COUNTER_MODE_EXTERNAL                                                          \
        LPTIM_CFGR_COUNTMODE /*!<The counter is incremented following each valid clock pulse on \
...
#define LL_LPTIM_OUTPUT_WAVEFORM_PWM                                                             \
        0x00000000U /*!<LPTIM  generates either a PWM waveform or a One pulse waveform depending \
                       on chosen operating mode CONTINUOUS or SINGLE*/
#define LL_LPTIM_OUTPUT_WAVEFORM_SETONCE                \
        LPTIM_CFGR_WAVE /*!<LPTIM  generates a Set Once \
                           waveform*/
/**
 * @}
 */
...
#define LL_LPTIM_OUTPUT_POLARITY_REGULAR                                                     \
        0x00000000U /*!<The LPTIM output reflects the compare results between LPTIMx_ARR and \
                       LPTIMx_CCRx registers*/
#define LL_LPTIM_OUTPUT_POLARITY_INVERSE                                                    \
        LPTIM_CCMR1_CC1P_0 /*!<The LPTIM output reflects the inverse of the compare results \
                              between LPTIMx_ARR and LPTIMx_CCx registers*/
/**
 * @}
 */
...
#define LL_LPTIM_ICPSC_DIV1 \
        0x00000000UL /*!< Capture performed each time an edge is detected on the capture input */
...
#define LL_LPTIM_ICFLT_CLOCK_DIV1                                                                 \
        0x00000000UL /*!< any external input capture signal level change is considered as a valid \
                        transition */
#define LL_LPTIM_ICFLT_CLOCK_DIV2                                                                \
        LPTIM_CCMR1_IC1F_0 /*!< external input capture signal level change must be stable for at \
                              least 2 clock periods before it is considered as valid transition */
#define LL_LPTIM_ICFLT_CLOCK_DIV4                                                                \
        LPTIM_CCMR1_IC1F_1 /*!< external input capture signal level change must be stable for at \
                              least 4 clock periods before it is considered as valid transition */
#define LL_LPTIM_ICFLT_CLOCK_DIV8                                                                 \
        ( LPTIM_CCMR1_IC1F_0 | LPTIM_CCMR1_IC1F_1 ) /*!< external input capture signal level      \
                                                       change must be stable for at least 8 clock \
                                                       periods before it is considered as valid   \
                                                       transition */
/**
 * @}
 */
...
#define LL_LPTIM_ICPOLARITY_RISING_FALLING                                                        \
        ( LPTIM_CCMR1_CC1P_0 | LPTIM_CCMR1_CC1P_1 ) /*!< Capture/Compare input rising and falling \
                                                       polarities */
/**
 * @}
 */
...
#define LL_LPTIM_PRESCALER_DIV8 \
        ( LPTIM_CFGR_PRESC_1 | LPTIM_CFGR_PRESC_0 ) /*!<Prescaler division factor is set to 8*/
#define LL_LPTIM_PRESCALER_DIV16 LPTIM_CFGR_PRESC_2 /*!<Prescaler division factor is set to 16*/
#define LL_LPTIM_PRESCALER_DIV32 \
        ( LPTIM_CFGR_PRESC_2 | LPTIM_CFGR_PRESC_0 ) /*!<Prescaler division factor is set to 32*/
#define LL_LPTIM_PRESCALER_DIV64 \
        ( LPTIM_CFGR_PRESC_2 | LPTIM_CFGR_PRESC_1 ) /*!<Prescaler division factor is set to 64*/
...
#define LL_LPTIM_TRIG_SOURCE_RTCTAMP1                                                              \
        ( LPTIM_CFGR_TRIGSEL_1 | LPTIM_CFGR_TRIGSEL_0 ) /*!<External input trigger is connected to \
                                                           RTC Tamper 1*/
...
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH0_TCF                                                 \
        LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to GPDMA CH0 transfer \
                                complete */
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH1_TCF                                                         \
        ( LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_1 ) /*!<External input trigger is connected to \
                                                           GPDMA CH1 transfer complete */
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH4_TCF                                                         \
        ( LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_1 ) /*!<External input trigger is connected to \
                                                           GPDMA CH4 transfer complete */
...
#define LL_LPTIM_TRIG_FILTER_2                                                                  \
        LPTIM_CFGR_TRGFLT_0 /*!<Trigger active level change must be stable for at least 2 clock \
                               periods before it is considered as valid trigger*/
#define LL_LPTIM_TRIG_FILTER_4                                                                  \
        LPTIM_CFGR_TRGFLT_1 /*!<Trigger active level change must be stable for at least 4 clock \
                               periods before it is considered as valid trigger*/
#define LL_LPTIM_TRIG_FILTER_8                                                                \
        LPTIM_CFGR_TRGFLT /*!<Trigger active level change must be stable for at least 8 clock \
                             periods before it is considered as valid trigger*/
/**
 * @}
 */
...
#define LL_LPTIM_TRIG_POLARITY_RISING_FALLING \
        LPTIM_CFGR_TRIGEN /*!<LPTIM counter starts when a rising or a falling edge is detected*/
/**
 * @}
 */
...
#define LL_LPTIM_CLK_SOURCE_EXTERNAL                                                        \
        LPTIM_CFGR_CKSEL /*!<LPTIM is clocked by an external clock source through the LPTIM \
                            external Input1*/
/**
 * @}
 */
...
#define LL_LPTIM_CLK_FILTER_2                                                                   \
        LPTIM_CFGR_CKFLT_0 /*!<External clock signal level change must be stable for at least 2 \
                              clock periods before it is considered as valid transition*/
#define LL_LPTIM_CLK_FILTER_4                                                                   \
        LPTIM_CFGR_CKFLT_1 /*!<External clock signal level change must be stable for at least 4 \
                              clock periods before it is considered as valid transition*/
#define LL_LPTIM_CLK_FILTER_8                                                                 \
        LPTIM_CFGR_CKFLT /*!<External clock signal level change must be stable for at least 8 \
                            clock periods before it is considered as valid transition*/
/**
 * @}
 */
...
#define LL_LPTIM_IC_GET_OFFSET( __PSC__, __FLT__ )                                              \
        LL_LPTIM_OFFSET_TAB_ICx[( ( __PSC__ ) & LPTIM_CFGR_PRESC_Msk ) >> LPTIM_CFGR_PRESC_Pos] \
...
ErrorStatus LL_LPTIM_DeInit( LPTIM_TypeDef const* LPTIMx );
void        LL_LPTIM_StructInit( LL_LPTIM_InitTypeDef* LPTIM_InitStruct );
ErrorStatus LL_LPTIM_Init( LPTIM_TypeDef* LPTIMx, LL_LPTIM_InitTypeDef const* LPTIM_InitStruct );
/**
 * @}
 */
#endif /* USE_FULL_LL_DRIVER */
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledResetAfterRead( LPTIM_TypeDef const* LPTIMx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetRepetition( LPTIM_TypeDef const* LPTIMx )
{
...
LL_LPTIM_CC_IsEnabledChannel( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
        return (
            ( READ_BIT( LPTIMx->CCMR1, 0x1UL << LL_LPTIM_SHIFT_TAB_CCxE[Channel] ) ==
 ...
 */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH1( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval CompareValue Value between Min_Data=0x00 and Max_Data=0xFFFF
 */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH2( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_OUTPUT_WAVEFORM_SETONCE
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetWaveform( LPTIM_TypeDef const* LPTIMx )
{
...
LL_LPTIM_OC_SetPolarity( LPTIM_TypeDef* LPTIMx, uint32_t Channel, uint32_t Polarity )
{
#if defined( LPTIM4 )
        if ( LPTIMx == LPTIM4 ) {
                MODIFY_REG(
 ...
 *         @arg @ref LL_LPTIM_OUTPUT_POLARITY_INVERSE
 */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetPolarity( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
#if defined( LPTIM4 )
        if ( LPTIMx == LPTIM4 ) {
 ...
 *         @arg @ref LL_LPTIM_PRESCALER_DIV128
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetPrescaler( LPTIM_TypeDef const* LPTIMx )
{
 ...
 */
__STATIC_INLINE void
LL_LPTIM_IC_SetPolarity( LPTIM_TypeDef* LPTIMx, uint32_t Channel, uint32_t Polarity )
{
        MODIFY_REG(
            LPTIMx->CCMR1,
            LPTIM_CCMR1_CC1P << LL_LPTIM_SHIFT_TAB_CCxP[Channel],
 ...
 *         @arg @ref LL_LPTIM_ICPOLARITY_RISING_FALLING
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetPolarity( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
        return (uint32_t) ( ( READ_BIT(
                                LPTIMx->CCMR1,
                                LPTIM_CCMR1_CC1P << LL_LPTIM_SHIFT_TAB_CCxP[Channel] ) ) >>
 ...
 */
__STATIC_INLINE void
LL_LPTIM_IC_SetFilter( LPTIM_TypeDef* LPTIMx, uint32_t Channel, uint32_t Filter )
{
        MODIFY_REG(
            LPTIMx->CCMR1,
 ...
 *         @arg @ref LL_LPTIM_ICFLT_CLOCK_DIV8
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetFilter( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
        return (uint32_t) ( ( READ_BIT(
                                LPTIMx->CCMR1,
                                LPTIM_CCMR1_IC1F << LL_LPTIM_SHIFT_TAB_ICxF[Channel] ) ) >>
 ...
 */
__STATIC_INLINE void
LL_LPTIM_IC_SetPrescaler( LPTIM_TypeDef* LPTIMx, uint32_t Channel, uint32_t Prescaler )
{
        MODIFY_REG(
            LPTIMx->CCMR1,
 ...
 *         @arg @ref LL_LPTIM_ICPSC_DIV8
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetPrescaler( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
        return (uint32_t) ( ( READ_BIT(
                                LPTIMx->CCMR1,
                                LPTIM_CCMR1_IC1PSC << LL_LPTIM_SHIFT_TAB_ICxPSC[Channel] ) ) >>
 ...
 */
__STATIC_INLINE void
LL_LPTIM_CC_SetChannelMode( LPTIM_TypeDef* LPTIMx, uint32_t Channel, uint32_t CCMode )
{
 ...
 *         @arg @ref LL_LPTIM_CCMODE_INPUTCAPTURE
 */
__STATIC_INLINE uint32_t LL_LPTIM_CC_GetChannelMode( LPTIM_TypeDef const* LPTIMx, uint32_t Channel )
{
        return (uint32_t) ( ( READ_BIT(
                                LPTIMx->CCMR1,
                                LPTIM_CCMR1_CC1SEL << LL_LPTIM_SHIFT_TAB_CCxSEL[Channel] ) ) >>
 ...
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH1( LPTIM_TypeDef const* LPTIMx )
{
        return (uint32_t) ( READ_BIT( LPTIMx->CCR1, LPTIM_CCR1_CCR1 ) );
}
 ...
 * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH2( LPTIM_TypeDef const* LPTIMx )
{
        return (uint32_t) ( READ_BIT( LPTIMx->CCR2, LPTIM_CCR2_CCR2 ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledTimeout( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->CFGR, LPTIM_CFGR_TIMOUT ) == LPTIM_CFGR_TIMOUT ) ? 1UL : 0UL ) );
}
...
/**
  ...
  */
__STATIC_INLINE void
LL_LPTIM_ConfigTrigger( LPTIM_TypeDef* LPTIMx, uint32_t Source, uint32_t Filter, uint32_t Polarity )
{
        MODIFY_REG(
            LPTIMx->CFGR,
...
/**
  ...
  *
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerSource( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_TRIG_FILTER_8
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerFilter( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_TRIG_POLARITY_RISING_FALLING
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerPolarity( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_CLK_SOURCE_EXTERNAL
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockSource( LPTIM_TypeDef const* LPTIMx )
{
...
/**
  ...
  */
__STATIC_INLINE void
LL_LPTIM_ConfigClock( LPTIM_TypeDef* LPTIMx, uint32_t ClockFilter, uint32_t ClockPolarity )
{
        MODIFY_REG(
            LPTIMx->CFGR, LPTIM_CFGR_CKFLT | LPTIM_CFGR_CKPOL, ClockFilter | ClockPolarity );
}
 ...
 *         @arg @ref LL_LPTIM_CLK_POLARITY_RISING_FALLING
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockPolarity( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_CLK_FILTER_8
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockFilter( LPTIM_TypeDef const* LPTIMx )
{
 ...
 *         @arg @ref LL_LPTIM_ENCODER_MODE_RISING_FALLING
 */
__STATIC_INLINE uint32_t LL_LPTIM_GetEncoderMode( LPTIM_TypeDef const* LPTIMx )
{
        return (uint32_t) ( READ_BIT( LPTIMx->CFGR, LPTIM_CFGR_CKPOL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledEncoderMode( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1O( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2O( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_ARRM( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_EXTTRIG( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->ISR, LPTIM_ISR_EXTTRIG ) == LPTIM_ISR_EXTTRIG ) ? 1UL : 0UL ) );
}
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_CCR1 register has
  been successfully completed. If so, a new one can be initiated.
  * @rmtoll ISR          CMP1OK         LL_LPTIM_IsActiveFlag_CMP1OK
  * @param  LPTIMx Low-Power Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP1OK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->ISR, LPTIM_ISR_CMP1OK ) == LPTIM_ISR_CMP1OK ) ? 1UL : 0UL ) );
}
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_CCR2 register has
  been successfully completed. If so, a new one can be initiated.
  * @rmtoll ISR          CMP2OK         LL_LPTIM_IsActiveFlag_CMP2OK
  * @param  LPTIMx Low-Power Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP2OK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->ISR, LPTIM_ISR_CMP2OK ) == LPTIM_ISR_CMP2OK ) ? 1UL : 0UL ) );
}
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_DIER register has
  been successfully completed. If so, a new one can be initiated.
  * @rmtoll ISR          DIEROK            LL_LPTIM_IsActiveFlag_DIEROK
  * @param  LPTIMx Low-Power Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_DIEROK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( READ_BIT( LPTIMx->ISR, LPTIM_ISR_DIEROK ) == ( LPTIM_ISR_DIEROK ) ) ? 1UL : 0UL );
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_ARROK( LPTIM_TypeDef const* LPTIMx )
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_UP( LPTIM_TypeDef const* LPTIMx )
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_DOWN( LPTIM_TypeDef const* LPTIMx )
{
...
/**
  * @brief  Informs application whether the APB bus write operation to the LPTIMx_RCR register has
  been successfully completed; If so, a new one can be initiated.
  * @rmtoll ISR          REPOK         LL_LPTIM_IsActiveFlag_REPOK
  * @param  LPTIMx Low-Power Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_REPOK( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_UE( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC1IE ) == LPTIM_DIER_CC1IE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC2IE ) == LPTIM_DIER_CC2IE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1O( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC1OIE ) == LPTIM_DIER_CC1OIE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2O( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC2OIE ) == LPTIM_DIER_CC2OIE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARRM( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_ARRMIE ) == LPTIM_DIER_ARRMIE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_EXTTRIG( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_EXTTRIGIE ) == LPTIM_DIER_EXTTRIGIE ) ? 1UL :
                                                                                           0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP1OK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CMP1OKIE ) == LPTIM_DIER_CMP1OKIE ) ? 1UL :
                                                                                         0UL ) );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP2OK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CMP2OKIE ) == LPTIM_DIER_CMP2OKIE ) ? 1UL :
                                                                                         0UL ) );
}
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARROK( LPTIM_TypeDef const* LPTIMx )
{
        return ( (
            ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_ARROKIE ) == LPTIM_DIER_ARROKIE ) ? 1UL : 0UL ) );
}
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UP( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_DOWN( LPTIM_TypeDef const* LPTIMx )
{
...
/**
 * @brief  Indicates whether the repetition register update successfully completed interrupt
 * (REPOKIE) is enabled.
 * @rmtoll DIER         REPOKIE       LL_LPTIM_IsEnabledIT_REPOK
 * @param  LPTIMx Low-Power Timer instance
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_REPOK( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_REPOKIE ) == ( LPTIM_DIER_REPOKIE ) ) ? 1UL :
                                                                                         0UL );
}
 ...
 *@ retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UE( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_UPDATE( LPTIM_TypeDef const* LPTIMx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC1( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC1DE ) == ( LPTIM_DIER_CC1DE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC2( LPTIM_TypeDef const* LPTIMx )
{
        return (
            ( READ_BIT( LPTIMx->DIER, LPTIM_DIER_CC2DE ) == ( LPTIM_DIER_CC2DE ) ) ? 1UL : 0UL );
}
