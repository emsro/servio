...
LL_SPI_SetInterDataIdleness( SPI_TypeDef* SPIx, uint32_t MasterInterDataIdleness )
{
 ...
 * @retval 0..0xFFFF
 */
__STATIC_INLINE uint16_t LL_SPI_ReceiveData16( SPI_TypeDef* SPIx ) /* Derogation
 ...
 * @retval  0..0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_SPI_ReceiveData32( SPI_TypeDef* SPIx ) /* Derogation
                                                                      MISRAC2012-Rule-8.13 */
{
 ...
 *         @arg @ref LL_I2S_DATAFORMAT_32B
 */
__STATIC_INLINE uint32_t LL_I2S_GetDataFormat( SPI_TypeDef const* SPIx )
{
        return (uint32_t) ( READ_BIT(
            SPIx->I2SCFGR, SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATFMT ) );
}
 ...
 *         @arg @ref LL_I2S_SLAVE_FIXED_CH_LENGTH
 */
__STATIC_INLINE uint32_t LL_I2S_GetChannelLengthType( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledWordSelectInversion( SPI_TypeDef const* SPIx )
{
        return (
            ( READ_BIT( SPIx->I2SCFGR, SPI_I2SCFGR_WSINV ) == ( SPI_I2SCFGR_WSINV ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_I2S_POLARITY_HIGH
 */
__STATIC_INLINE uint32_t LL_I2S_GetClockPolarity( SPI_TypeDef const* SPIx )
{
 ...
 *         @arg @ref LL_I2S_STANDARD_PCM_LONG
 */
__STATIC_INLINE uint32_t LL_I2S_GetStandard( SPI_TypeDef const* SPIx )
{
 ...
 *         @arg @ref LL_I2S_MODE_MASTER_FULL_DUPLEX
 */
__STATIC_INLINE uint32_t LL_I2S_GetTransferMode( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIOSwap( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledGPIOControl( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIOLock( SPI_TypeDef const* SPIx )
{
 ...
 *         @arg @ref LL_I2S_MSB_FIRST
 */
__STATIC_INLINE uint32_t LL_I2S_GetTransferBitOrder( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveTransfer( SPI_TypeDef const* SPIx )
{
 ...
 *         @arg @ref LL_I2S_FIFO_TH_08DATA
 */
__STATIC_INLINE uint32_t LL_I2S_GetFIFOThreshold( SPI_TypeDef const* SPIx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2S_GetPrescalerLinear( SPI_TypeDef const* SPIx )
{
 ...
 *         @arg @ref LL_I2S_PRESCALER_PARITY_ODD
 */
__STATIC_INLINE uint32_t LL_I2S_GetPrescalerParity( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledMasterClock( SPI_TypeDef const* SPIx )
{
        return (
            ( READ_BIT( SPIx->I2SCFGR, SPI_I2SCFGR_MCKOE ) == ( SPI_I2SCFGR_MCKOE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveFlag_RXP( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveFlag_TXP( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveFlag_UDR( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveFlag_OVR( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2S_IsActiveFlag_FRE( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIT_RXP( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIT_TXP( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIT_UDR( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIT_OVR( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledIT_FRE( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledDMAReq_RX( SPI_TypeDef const* SPIx )
{
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledDMAReq_TX( SPI_TypeDef const* SPIx )
{
 ...
 * @retval 0..0xFFFF
 */
__STATIC_INLINE uint16_t LL_I2S_ReceiveData16( SPI_TypeDef* SPIx ) /* Derogation
                                                                      MISRAC2012-Rule-8.13 */
{
 ...
 * @retval  0..0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_I2S_ReceiveData32( SPI_TypeDef* SPIx ) /* Derogation
                                                                      MISRAC2012-Rule-8.13 */
{
...
ErrorStatus LL_I2S_DeInit( SPI_TypeDef const* SPIx );
ErrorStatus LL_I2S_Init( SPI_TypeDef* SPIx, LL_I2S_InitTypeDef const* I2S_InitStruct );
void        LL_I2S_StructInit( LL_I2S_InitTypeDef* I2S_InitStruct );
void        LL_I2S_ConfigPrescaler(
           SPI_TypeDef* SPIx,
