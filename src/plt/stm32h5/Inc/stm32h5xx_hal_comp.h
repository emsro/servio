...
typedef struct
{
        uint32_t Mode; /*!< Set comparator operating mode to adjust power and speed.
                            Note: For the characteristics of comparator power modes
                                  (propagation delay and power consumption), refer to device
                          datasheet. This parameter can be a value of @ref COMP_PowerMode */
        ...
        uint32_t OutputPol; /*!< Set comparator output polarity.
                                 ...
                                 Note: Specific to comparator of this STM32 series: comparator
                               output triggers interruption on high level. HAL_COMP_Start_x
                               functions can change output polarity depending on initial output
                               level. */

        uint32_t BlankingSrce; /*!< Set comparator blanking source.
                                    This parameter can be a value of @ref COMP_BlankingSrce */

        uint32_t TriggerMode; /*!< Set the comparator output triggering External Interrupt Line
                                 (EXTI). This parameter can be a value of @ref COMP_EXTI_TriggerMode
                               */
...
typedef enum
{
        ...
        HAL_COMP_STATE_READY_LOCKED =
            ( HAL_COMP_STATE_READY | COMP_STATE_BITFIELD_LOCK ), /*!< COMP initialized but
                                                                    configuration is locked */
        HAL_COMP_STATE_BUSY = 0x02, /*!< COMP is running                                      */
        HAL_COMP_STATE_BUSY_LOCKED =
            ( HAL_COMP_STATE_BUSY | COMP_STATE_BITFIELD_LOCK ) /*!< COMP is running and
                                                                  configuration is locked */
...
#endif /* USE_HAL_COMP_REGISTER_CALLBACKS */
{
        ...
        void ( *MspInitCallback )( struct __COMP_HandleTypeDef* hcomp ); /*!< COMP Msp Init callback
                                                                          */
        void ( *MspDeInitCallback )( struct __COMP_HandleTypeDef* hcomp ); /*!< COMP Msp DeInit
                                                                              callback */
#endif                              /* USE_HAL_COMP_REGISTER_CALLBACKS */
 ...
 */
typedef void ( *pCOMP_CallbackTypeDef )( COMP_HandleTypeDef* hcomp ); /*!< pointer to a COMP
                                                                         callback function */
...
#define COMP_INPUT_MINUS_DAC1_CH1 \
        ( COMP_CFGR1_INMSEL_2 ) /*!< Comparator input minus connected to DAC1 channel 1 */
#define COMP_INPUT_MINUS_IO1                                                                       \
        ( COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_0 ) /*!< Comparator input minus connected to IO1 \
                                                         (pin PC4)  */
#define COMP_INPUT_MINUS_IO2                                                                       \
        ( COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1 ) /*!< Comparator input minus connected to IO2 \
                                                         (pin PB1)  */
...
#define COMP_OUTPUTPOL_INVERTED                                                          \
        ( COMP_CFGR1_POLARITY ) /*!< COMP output level is inverted (comparator output is \
...
#define COMP_BLANKINGSRC_TIM3_OC3                                                            \
        ( COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1 ) /*!< TIM3 OC3 selected as blanking \
                                                             source */
...
#define COMP_BLANKINGSRC_LPTIM1_OC2                                                            \
        ( COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0 ) /*!< LPTIM1 OC2 selected as blanking \
                                                             source */
#define COMP_BLANKINGSRC_LPTIM2_OC2                                                            \
        ( COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1 ) /*!< LPTIM2 OC2 selected as blanking \
                                                             source */
/**
 * @}
 */
