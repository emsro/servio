...
typedef struct
{
        uint32_t Reg_Addr;      /*!< This is the address of the byte of data inside of the selected
                                   function to read or write */
        uint8_t ReadAfterWrite; /*!< This is the read after write flag, it is used for write access
                                   only.                     */
        uint8_t IOFunctionNbr;  /*!< The number of the function within the IO card you wish to read
                                   or write                  */
...
typedef struct
{
        ...
        uint32_t IOFunctionNbr; /*!< The number of the function within the IO card you wish to read
                                   or write                  */
...
typedef struct __SDIO_HandleTypeDef
{
        ...
        uint8_t volatile IOInterruptNbr; /*!< SDIO used to record total enabled io interrupt numbers
                                          */

        void ( *SDIO_IOFunction_Callback[SDIO_MAX_IO_NUMBER] )(
            struct __SDIO_HandleTypeDef* hsdio,
            uint32_t                     func );
        ...
        void ( *DriveTransceiver_1_8V_Callback )(
            struct __SDIO_HandleTypeDef* hsdio,
            FlagStatus                   status );
