...
typedef struct
{
        ...
        uint32_t TypeAcknowledge; /*!< Specifies the ACKnowledge or Non ACKnowledge condition after
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabled( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetDigitalFilter( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledAnalogFilter( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledDMAReq_TX( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledDMAReq_RX( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_DMA_GetRegAddr( I2C_TypeDef const* I2Cx, uint32_t Direction )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledClockStretching( I2C_TypeDef const* I2Cx )
{
        return (
            ( READ_BIT( I2Cx->CR1, I2C_CR1_NOSTRETCH ) != ( I2C_CR1_NOSTRETCH ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSlaveByteControl( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledWakeUpFromStop( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledGeneralCall( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledFastModePlus( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledAutoClearFlag_ADDR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledAutoClearFlag_STOP( I2C_TypeDef const* I2Cx )
{
        return (
            ( READ_BIT( I2Cx->CR1, I2C_CR1_STOPFACLR ) == ( I2C_CR1_STOPFACLR ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_I2C_ADDRESSING_MODE_10BIT
 */
__STATIC_INLINE uint32_t LL_I2C_GetMasterAddressingMode( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledOwnAddress1( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledOwnAddress2( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x0 and Max_Data=0xF
 */
__STATIC_INLINE uint32_t LL_I2C_GetTimingPrescaler( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetClockLowPeriod( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0xFF
 */
__STATIC_INLINE uint32_t LL_I2C_GetClockHighPeriod( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x0 and Max_Data=0xF
 */
__STATIC_INLINE uint32_t LL_I2C_GetDataHoldTime( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x0 and Max_Data=0xF
 */
__STATIC_INLINE uint32_t LL_I2C_GetDataSetupTime( I2C_TypeDef const* I2Cx )
{
 ...
 *         @arg @ref LL_I2C_MODE_SMBUS_DEVICE_ARP
 */
__STATIC_INLINE uint32_t LL_I2C_GetMode( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusAlert( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusPEC( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutA( I2C_TypeDef const* I2Cx )
{
 ...
 *         @arg @ref LL_I2C_SMBUS_TIMEOUTA_MODE_SDA_SCL_HIGH
 */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutAMode( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFFF
 */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutB( I2C_TypeDef const* I2Cx )
{
...
LL_I2C_IsEnabledSMBusTimeout( I2C_TypeDef const* I2Cx, uint32_t ClockTimeout )
{
        return (
            ( READ_BIT( I2Cx->TIMEOUTR, ( I2C_TIMEOUTR_TIMOUTEN | I2C_TIMEOUTR_TEXTEN ) ) ==
              ( ClockTimeout ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_TX( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_RX( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_ADDR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_NACK( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_STOP( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_TC( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_ERR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_TXE( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_TXIS( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_RXNE( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_ADDR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_NACK( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_STOP( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_TC( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_TCR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_BERR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_ARLO( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_OVR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_PECERR( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_TIMEOUT( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_ALERT( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_BUSY( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledAutoEndMode( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledReloadMode( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetTransferSize( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledAuto10BitRead( I2C_TypeDef const* I2Cx )
{
 ...
 *         @arg @ref LL_I2C_REQUEST_READ
 */
__STATIC_INLINE uint32_t LL_I2C_GetTransferRequest( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetSlaveAddr( I2C_TypeDef const* I2Cx )
{
    ...
    uint32_t     Request )
{
        ...
        MODIFY_REG(
            ...
            I2C_CR2_SADD | I2C_CR2_ADD10 |
                ...
                I2C_CR2_START | I2C_CR2_STOP | I2C_CR2_RELOAD | I2C_CR2_NBYTES | I2C_CR2_AUTOEND |
                I2C_CR2_HEAD10R,
            tmp );
}
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetTransferDirection( I2C_TypeDef const* I2Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_GetAddressMatchCode( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusPECCompare( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0xFF
 */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusPEC( I2C_TypeDef const* I2Cx )
{
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0xFF
 */
__STATIC_INLINE uint8_t LL_I2C_ReceiveData8( I2C_TypeDef const* I2Cx )
{
...
ErrorStatus LL_I2C_Init( I2C_TypeDef* I2Cx, LL_I2C_InitTypeDef const* I2C_InitStruct );
ErrorStatus LL_I2C_DeInit( I2C_TypeDef const* I2Cx );
