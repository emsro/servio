...
typedef struct
{
        ...
        uint32_t WaveAutoGeneration; /*!< Set the waveform automatic generation mode for the
                                        selected DAC channel. This parameter can be a value of @ref
                                        DAC_LL_EC_WAVE_AUTO_GENERATION_MODE

                                          This feature can be modified afterwards using unitary
                                          function @ref LL_DAC_SetWaveAutoGeneration(). */

        uint32_t WaveAutoGenerationConfig; /*!< Set the waveform automatic generation mode for the
                                              selected DAC channel. If waveform automatic generation
                                              mode is set to noise, this parameter can be a value of
                                              @ref DAC_LL_EC_WAVE_NOISE_LFSR_UNMASK_BITS If waveform
                                              automatic generation mode is set to triangle, this
...
#define LL_DAC_TRIG_EXT_TIM1_TRGO                                                             \
        ( DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger from external peripheral: TIM1 \
                              TRGO. */
#define LL_DAC_TRIG_EXT_TIM2_TRGO                                                             \
        ( DAC_CR_TSEL1_1 ) /*!< DAC channel conversion trigger from external peripheral: TIM2 \
                              TRGO. */
#define LL_DAC_TRIG_EXT_TIM6_TRGO                                                             \
        ( DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger from external \
                                               peripheral: TIM6 TRGO. */
#define LL_DAC_TRIG_EXT_TIM7_TRGO                                                             \
        ( DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 ) /*!< DAC channel conversion trigger from external \
                                               peripheral: TIM7 TRGO. */
#define LL_DAC_TRIG_EXT_LPTIM1_CH1                                                               \
        ( DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger \
                                                                from external peripheral: LPTIM1 \
                                                                CH1. */
#define LL_DAC_TRIG_EXT_LPTIM2_CH1                                                            \
        ( DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 ) /*!< DAC channel conversion trigger from external \
                                               peripheral: LPTIM2 CH1. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9                                                                 \
        ( DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger   \
...
#define LL_DAC_TRIG_EXT_TIM4_TRGO                                                             \
        ( DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger from external \
                                               peripheral: TIM4 TRGO. */
#define LL_DAC_TRIG_EXT_TIM5_TRGO                                                             \
        ( DAC_CR_TSEL1_2 ) /*!< DAC channel conversion trigger from external peripheral: TIM5 \
                              TRGO. */
#define LL_DAC_TRIG_EXT_TIM8_TRGO                                                                \
        ( DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger \
                                                                from external peripheral: TIM8   \
                                                                TRGO. */
#define LL_DAC_TRIG_EXT_TIM15_TRGO                                                             \
        ( DAC_CR_TSEL1_3 ) /*!< DAC channel conversion trigger from external peripheral: TIM15 \
                              TRGO. */
#else
/* Devices STM32H503xx */
#define LL_DAC_TRIG_EXT_TIM3_TRGO                                                             \
        ( DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 ) /*!< DAC channel conversion trigger from external \
                                               peripheral: TIM3 TRGO. */
...
#define LL_DAC_WAVE_AUTO_GENERATION_NOISE                                                          \
        ( DAC_CR_WAVE1_0 ) /*!< DAC channel wave auto generation mode enabled, set generated noise \
                              waveform. */
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS1_0                                                           \
        ( DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask LFSR bits[1:0], for the selected DAC \
                              channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS2_0                                                           \
        ( DAC_CR_MAMP1_1 ) /*!< Noise wave generation, unmask LFSR bits[2:0], for the selected DAC \
                              channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS3_0                                                           \
        ( DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask LFSR bits[3:0], for \
                                               the selected DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS4_0                                                           \
        ( DAC_CR_MAMP1_2 ) /*!< Noise wave generation, unmask LFSR bits[4:0], for the selected DAC \
                              channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS5_0                                                           \
        ( DAC_CR_MAMP1_2 | DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask LFSR bits[5:0], for \
                                               the selected DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS6_0                                                           \
        ( DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 ) /*!< Noise wave generation, unmask LFSR bits[6:0], for \
                                               the selected DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS7_0                                                         \
        ( DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask  \
                                                                LFSR bits[7:0], for the selected \
                                                                DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS8_0                                                           \
        ( DAC_CR_MAMP1_3 ) /*!< Noise wave generation, unmask LFSR bits[8:0], for the selected DAC \
                              channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS9_0                                                           \
        ( DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask LFSR bits[9:0], for \
                                               the selected DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS10_0                                                       \
        ( DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 ) /*!< Noise wave generation, unmask LFSR bits[10:0], \
                                               for the selected DAC channel */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS11_0                                                         \
        ( DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0 ) /*!< Noise wave generation, unmask   \
                                                                LFSR bits[11:0], for the selected \
                                                                DAC channel */
/**
 * @}
 */
...
#define LL_DAC_TRIANGLE_AMPLITUDE_1                                                             \
        0x00000000UL /*!< Triangle wave generation, amplitude of 1 LSB of DAC output range, for \
                        the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_3                                                               \
        ( DAC_CR_MAMP1_0 ) /*!< Triangle wave generation, amplitude of 3 LSB of DAC output range, \
                              for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_7                                                               \
        ( DAC_CR_MAMP1_1 ) /*!< Triangle wave generation, amplitude of 7 LSB of DAC output range, \
                              for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_15                                                              \
        ( DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0 ) /*!< Triangle wave generation, amplitude of 15 LSB of \
                                               DAC output range, for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_31                                                               \
        ( DAC_CR_MAMP1_2 ) /*!< Triangle wave generation, amplitude of 31 LSB of DAC output range, \
                              for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_63                                                              \
        ( DAC_CR_MAMP1_2 | DAC_CR_MAMP1_0 ) /*!< Triangle wave generation, amplitude of 63 LSB of \
                                               DAC output range, for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_127                                                              \
        ( DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 ) /*!< Triangle wave generation, amplitude of 127 LSB of \
                                               DAC output range, for the selected DAC channel */
...
#define LL_DAC_TRIANGLE_AMPLITUDE_1023                                                           \
        ( DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0 ) /*!< Triangle wave generation, amplitude of 1023 LSB \
                                               of DAC output range, for the selected DAC channel \
                                             */
#define LL_DAC_TRIANGLE_AMPLITUDE_2047                                                           \
        ( DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 ) /*!< Triangle wave generation, amplitude of 2047 LSB \
                                               of DAC output range, for the selected DAC channel \
                                             */
...
#define LL_DAC_OUTPUT_MODE_SAMPLE_AND_HOLD                                                        \
        ( DAC_MCR_MODE1_2 ) /*!< The selected DAC channel output is on mode sample-and-hold. Mode \
                               sample-and-hold requires an external capacitor, refer to           \
                               description of function @ref LL_DAC_ConfigOutput() or @ref         \
...
#define LL_DAC_OUTPUT_BUFFER_ENABLE                                                         \
        0x00000000UL /*!< The selected DAC channel output is buffered: higher drive current \
                        capability, but also higher current consumption */
#define LL_DAC_OUTPUT_BUFFER_DISABLE                                                          \
        ( DAC_MCR_MODE1_1 ) /*!< The selected DAC channel output is not buffered: lower drive \
...
#define LL_DAC_OUTPUT_CONNECT_INTERNAL                                                           \
        ( DAC_MCR_MODE1_0 ) /*!< The selected DAC channel output is connected to on-chip         \
                               peripherals via internal paths. On this STM32 series, output      \
                               connection depends on output mode (normal or sample and hold) and \
                               output buffer state. Refer to comments of function @ref           \
...
#define LL_DAC_DMA_REG_DATA_12BITS_RIGHT_ALIGNED                                               \
        DAC_REG_DHR12RX_REGOFFSET_BITOFFSET_POS /*!< DAC channel data holding register 12 bits \
                                                   right aligned */
#define LL_DAC_DMA_REG_DATA_12BITS_LEFT_ALIGNED                                                \
        DAC_REG_DHR12LX_REGOFFSET_BITOFFSET_POS /*!< DAC channel data holding register 12 bits \
                                                   left aligned */
#define LL_DAC_DMA_REG_DATA_8BITS_RIGHT_ALIGNED                                                    \
        DAC_REG_DHR8RX_REGOFFSET_BITOFFSET_POS /*!< DAC channel data holding register 8 bits right \
                                                  aligned */
/**
 * @}
 */
...
#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                                                  \
        8UL /*!< Delay for DAC channel voltage settling time from DAC channel startup (transition \
 ...
 *         @arg @ref LL_DAC_HIGH_FREQ_MODE_ABOVE_160MHZ
 */
__STATIC_INLINE uint32_t LL_DAC_GetHighFrequencyMode( DAC_TypeDef const* DACx )
{
 ...
 *         @arg @ref LL_DAC_MODE_CALIBRATION
 */
__STATIC_INLINE uint32_t LL_DAC_GetMode( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
 ...
 */
__STATIC_INLINE uint32_t LL_DAC_GetTrimmingValue( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->CCR,
                                DAC_CCR_OTRIM1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
 ...
 *          Only available on STM32H503xx (refer to device reference manual for supported features
 * list) (2) On this STM32 series, parameter not available on all devices. Only available on
 * STM32H563/H573xx (refer to device reference manual for supported features list)
 * @retval None
 */
__STATIC_INLINE void
 ...
 * STM32H563/H573xx (refer to device reference manual for supported features list)
 */
__STATIC_INLINE uint32_t LL_DAC_GetTriggerSource( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->CR,
                                DAC_CR_TSEL1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
...
LL_DAC_GetWaveAutoGeneration( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->CR,
                                DAC_CR_WAVE1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
 ...
 *         @arg @ref LL_DAC_NOISE_LFSR_UNMASK_BITS11_0
 */
__STATIC_INLINE uint32_t LL_DAC_GetWaveNoiseLFSR( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->CR,
                                DAC_CR_MAMP1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_GetWaveTriangleAmplitude( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->CR,
                                DAC_CR_MAMP1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
 ...
 *         @arg @ref LL_DAC_OUTPUT_MODE_SAMPLE_AND_HOLD
 */
__STATIC_INLINE uint32_t LL_DAC_GetOutputMode( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->MCR,
 ...
 *         @arg @ref LL_DAC_OUTPUT_BUFFER_DISABLE
 */
__STATIC_INLINE uint32_t LL_DAC_GetOutputBuffer( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->MCR,
 ...
 *         @arg @ref LL_DAC_OUTPUT_CONNECT_INTERNAL
 */
__STATIC_INLINE uint32_t LL_DAC_GetOutputConnection( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->MCR,
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_GetSampleAndHoldSampleTime( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_GetSampleAndHoldHoldTime( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (uint32_t) ( READ_BIT(
                                DACx->SHHR,
                                DAC_SHHR_THOLD1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) >>
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_GetSampleAndHoldRefreshTime( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
            uint32_t) ( READ_BIT(
                            DACx->SHRR,
 ...
 *         @arg @ref LL_DAC_SIGNED_FORMAT_DISABLE
 */
__STATIC_INLINE uint32_t LL_DAC_GetSignedFormat( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
            uint32_t) ( READ_BIT(
                            DACx->MCR,
 ...
 */
__STATIC_INLINE uint32_t LL_DAC_IsDMAReqEnabled( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_IsDMADoubleDataModeEnabled( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
            ( READ_BIT(
                  DACx->MCR, DAC_MCR_DMADOUBLE1 << ( DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK ) ) ==
 ...
 */
__STATIC_INLINE uint32_t
LL_DAC_DMA_GetRegAddr( DAC_TypeDef const* DACx, uint32_t DAC_Channel, uint32_t Register )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsEnabled( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsReady( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsTriggerEnabled( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        return (
 ...
 */
__STATIC_INLINE uint32_t LL_DAC_RetrieveOutputData( DAC_TypeDef const* DACx, uint32_t DAC_Channel )
{
        __IO uint32_t const* preg = __DAC_PTR_REG_OFFSET(
            DACx->DOR1,
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_CAL1( DAC_TypeDef const* DACx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_CAL2( DAC_TypeDef const* DACx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_BWST1( DAC_TypeDef const* DACx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_BWST2( DAC_TypeDef const* DACx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DAC1RDY( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DAC1RDY ) == ( LL_DAC_FLAG_DAC1RDY ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DAC2RDY( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DAC2RDY ) == ( LL_DAC_FLAG_DAC2RDY ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DORSTAT1( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DORSTAT1 ) == ( LL_DAC_FLAG_DORSTAT1 ) ) ? 1UL :
                                                                                         0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DORSTAT2( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DORSTAT2 ) == ( LL_DAC_FLAG_DORSTAT2 ) ) ? 1UL :
                                                                                         0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DMAUDR1( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DMAUDR1 ) == ( LL_DAC_FLAG_DMAUDR1 ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsActiveFlag_DMAUDR2( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->SR, LL_DAC_FLAG_DMAUDR2 ) == ( LL_DAC_FLAG_DMAUDR2 ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsEnabledIT_DMAUDR1( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->CR, LL_DAC_IT_DMAUDRIE1 ) == ( LL_DAC_IT_DMAUDRIE1 ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DAC_IsEnabledIT_DMAUDR2( DAC_TypeDef const* DACx )
{
        return (
            ( READ_BIT( DACx->CR, LL_DAC_IT_DMAUDRIE2 ) == ( LL_DAC_IT_DMAUDRIE2 ) ) ? 1UL : 0UL );
}
...
ErrorStatus LL_DAC_DeInit( DAC_TypeDef const* DACx );
ErrorStatus
LL_DAC_Init( DAC_TypeDef* DACx, uint32_t DAC_Channel, LL_DAC_InitTypeDef const* DAC_InitStruct );
