...
typedef struct
{
        ...
        uint32_t SampleTime; /*!< Selects the trigger sampling time to configure the clock glitch
...
typedef struct
{
        ...
        LPTIM_ULPClockConfigTypeDef UltraLowPowerClock; /*!< Specifies the Ultra Low Power clock
                                                           parameters */
        ...
        uint32_t CounterSource; /*!< Specifies whether the counter is incremented each internal
                                event or each external event. This parameter can be a value of @ref
        ...
        uint32_t Input2Source; /*!< Specifies source selected for input2 (GPIO or comparator
                               output). Note: This parameter is used only for encoder feature so is
                               used only for LPTIM1 instance. This parameter can be a value of @ref
                               LPTIM_Input2_Source */
        ...
        uint32_t RepetitionCounter; /*!< Specifies the repetition counter value.
                                     ...
                                     Note: When using repetition counter the UpdateMode field must
                                     be set to LPTIM_UPDATE_ENDOFPERIOD otherwise unpredictable
                                           behavior may occur.
...
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
{
        ...
        DMA_HandleTypeDef* hdma[3]; /*!< DMA Handlers array, This array is accessed by a @ref
                                       LPTIM_DMA_Handle_index */
...
#if ( USE_HAL_LPTIM_REGISTER_CALLBACKS == 1 )
        void ( *MspInitCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< LPTIM Base Msp Init
                                                                              Callback */
        void ( *MspDeInitCallback )( struct __LPTIM_HandleTypeDef* hlptim );    /*!< LPTIM Base Msp
                                                                                   DeInit Callback    */
        void ( *CompareMatchCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Compare match
                                                                                   Callback */
        void ( *AutoReloadMatchCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Auto-reload
                                                                                      match Callback
                                                                                    */
        void ( *TriggerCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< External trigger
                                                                              event detection
                                                                              Callback    */
        void ( *CompareWriteCallback )(
            struct __LPTIM_HandleTypeDef* hlptim ); /*!< Compare register write complete Callback */
        void ( *AutoReloadWriteCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Auto-reload
                                                                                      register write
                                                                                      complete
                                                                                      Callback */
        void ( *DirectionUpCallback )( struct __LPTIM_HandleTypeDef* hlptim );     /*!< Up-counting
                                                                                      direction change
                                                                                      Callback        */
        void ( *DirectionDownCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Down-counting
                                                                                    direction change
                                                                                    Callback      */
        void ( *UpdateEventCallback )( struct __LPTIM_HandleTypeDef* hlptim );   /*!< Update event
                                                                                    detection Callback
                                                                                  */
        void ( *RepCounterWriteCallback )(
            struct __LPTIM_HandleTypeDef* hlptim ); /*!< Repetition counter register write complete
                                                       Callback */
        void ( *UpdateEventHalfCpltCallback )(
            struct __LPTIM_HandleTypeDef* hlptim ); /*!< Update event half complete detection
                                                       Callback */
        void ( *ErrorCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< LPTIM Error Callback
                                                                          */
        void ( *IC_CaptureCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Input capture
                                                                                 Callback */
        void ( *IC_CaptureHalfCpltCallback )(
            struct __LPTIM_HandleTypeDef* htim ); /*!< Input Capture half complete Callback */
        void ( *IC_OverCaptureCallback )( struct __LPTIM_HandleTypeDef* hlptim ); /*!< Over capture
                                                                                     Callback */
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
} LPTIM_HandleTypeDef;
 ...
 */
typedef void ( *pLPTIM_CallbackTypeDef )( LPTIM_HandleTypeDef* hlptim ); /*!< pointer to the LPTIM
                                                                            callback function */
...
#define LPTIM_DMA_ID_CC1                                                                       \
        ( (uint16_t) 0x0001 ) /*!< Index of the DMA handle used for Capture/Update event 1 DMA \
                                 request */
#define LPTIM_DMA_ID_CC2                                                                       \
        ( (uint16_t) 0x0002 ) /*!< Index of the DMA handle used for Capture/Update event 2 DMA \
                                 request */
/**
 * @}
 */
...
#define LPTIM_IC1SOURCE_COMP1 \
        LPTIM_CFGR2_IC1SEL_0 /*!< For LPTIM1, LPTIM2, LPTIM3, LPTIM4, LPTIM5 and LPTIM6 */
#endif                       /* COMP1 */
#if defined( STM32H503xx )
#define LPTIM_IC1SOURCE_EVENTOUT \
        LPTIM_CFGR2_IC1SEL_1 /*!< For LPTIM1, LPTIM2, LPTIM3, LPTIM4, LPTIM5 and LPTIM6 */
 ...
 */
/* Config functions  **********************************************************/
HAL_StatusTypeDef HAL_LPTIM_OC_ConfigChannel(
    LPTIM_HandleTypeDef*          hlptim,
    LPTIM_OC_ConfigTypeDef const* sConfig,
    uint32_t                      Channel );
...
HAL_StatusTypeDef HAL_LPTIM_PWM_Start_DMA(
    LPTIM_HandleTypeDef* hlptim,
    uint32_t             Channel,
...
HAL_StatusTypeDef HAL_LPTIM_IC_ConfigChannel(
    LPTIM_HandleTypeDef*          hlptim,
    LPTIM_IC_ConfigTypeDef const* sConfig,
    uint32_t                      Channel );
...
HAL_StatusTypeDef HAL_LPTIM_IC_Start_DMA(
    LPTIM_HandleTypeDef* hlptim,
    uint32_t             Channel,
    uint32_t*            pData,
    uint32_t             Length );
...
uint32_t HAL_LPTIM_ReadCounter( LPTIM_HandleTypeDef const* hlptim );
uint32_t HAL_LPTIM_ReadAutoReload( LPTIM_HandleTypeDef const* hlptim );
uint32_t HAL_LPTIM_ReadCapturedValue( LPTIM_HandleTypeDef const* hlptim, uint32_t Channel );
uint8_t  HAL_LPTIM_IC_GetOffset( LPTIM_HandleTypeDef const* hlptim, uint32_t Channel );
/**
 * @}
 */
...
HAL_StatusTypeDef
HAL_LPTIM_UnRegisterCallback( LPTIM_HandleTypeDef* lphtim, HAL_LPTIM_CallbackIDTypeDef CallbackID );
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
/**
 * @}
 */
...
HAL_LPTIM_StateTypeDef HAL_LPTIM_GetState( LPTIM_HandleTypeDef const* hlptim );
/**
 * @}
 */
...
#define IS_LPTIM_IC1_SOURCE( __INSTANCE__, __SOURCE__ )                                           \
        ( ( ( ( __INSTANCE__ ) == LPTIM1 ) && ( ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_GPIO ) ||     \
                                                ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_COMP1 ) ||    \
                                                ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_EVENTOUT ) || \
                                                ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_MCO1 ) ) ) || \
          ( ( ( __INSTANCE__ ) == LPTIM2 ) && ( ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_GPIO ) ||     \
                                                ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_COMP1 ) ||    \
                                                ( ( __SOURCE__ ) == LPTIM_IC1SOURCE_EVENTOUT ) || \
...
#define IS_LPTIM_IC2_SOURCE( __INSTANCE__, __SOURCE__ )                                           \
        ( ( ( ( __INSTANCE__ ) == LPTIM1 ) &&                                                     \
          ...
          ( ( ( __INSTANCE__ ) == LPTIM2 ) && ( ( ( __SOURCE__ ) == LPTIM_IC2SOURCE_GPIO ) ||     \
