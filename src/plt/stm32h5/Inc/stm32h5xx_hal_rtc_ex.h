...
typedef struct
{
        ...
        uint32_t ActiveAsyncPrescaler; /*!< Specifies the Active Tamper asynchronous Prescaler
                                          clock. This parameter can be a value of
...
typedef struct
{
        ...
        uint32_t tampSecureFull; /*!< Specifies If the TAMP is fully secure or not execpt monotonic
                                    counters and BackUp registers. This parameter can be a value of
                                    @ref RTCEx_TAMP_Secure_Full */
...
typedef struct
{
        ...
        uint32_t tampPrivilegeFull; /*!< Specifies If the TAMP is fully privileged or not execpt
                                       monotonic counters and BackUp registers. This parameter can
                                       be a value of @ref RTCEx_TAMP_Privilege_Full */
        ...
        uint32_t MonotonicCounterPrivilege; /*!< Specifies If the monotonic counter is privileged or
                                               not. This parameter can be a value of
...
#define RTC_LPCAL_SET                                                                   \
        RTC_CALR_LPCAL /*!< Calibration window is 2exp20 ck_apre, which is the required \
                          configuration for ultra-low consumption mode. */
#define RTC_LPCAL_RESET                                                                \
        0U /*!< Calibration window is 2exp20 RTCCLK, which is a high-consumption mode. \
...
#define RTC_INT_TAMPER_ALL                                                               \
        ( RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 | RTC_INT_TAMPER_4 |    \
          ...
          RTC_INT_TAMPER_9 | RTC_INT_TAMPER_11 | RTC_INT_TAMPER_12 | RTC_INT_TAMPER_13 | \
          RTC_INT_TAMPER_15 )
/**
 * @}
 */
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                                                     \
        ( TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1 ) /*!< Each of the tamper inputs are      \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024                                                     \
        ( TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_2 ) /*!< Each of the tamper inputs are      \
                                                             sampled with a frequency =  RTCCLK / \
                                                             1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                                      \
        ( TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2 ) /*!< Each of the tamper inputs are      \
                                                             sampled with a frequency =  RTCCLK / \
                                                             512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                                    \
        ( TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1 |                                       \
          TAMP_FLTCR_TAMPFREQ_2 ) /*!< Each of the tamper inputs are sampled with a frequency = \
                                     RTCCLK / 256   */
/**
 * @}
 */
...
#define RTC_IT_TAMP_ALL                                                                   \
        ( RTC_IT_TAMP_1 | RTC_IT_TAMP_2 | RTC_IT_TAMP_3 | RTC_IT_TAMP_4 | RTC_IT_TAMP_5 | \
          RTC_IT_TAMP_6 | RTC_IT_TAMP_7 | RTC_IT_TAMP_8 )
#endif /* RTC_TAMP_NB */
/**
 * @}
 */
...
#define RTC_IT_INT_TAMP_ALL                                                                  \
        ( RTC_IT_INT_TAMP_1 | RTC_IT_INT_TAMP_2 | RTC_IT_INT_TAMP_3 | RTC_IT_INT_TAMP_4 |    \
          RTC_IT_INT_TAMP_5 | RTC_IT_INT_TAMP_6 | RTC_IT_INT_TAMP_7 | RTC_IT_INT_TAMP_8 |    \
          RTC_IT_INT_TAMP_9 | RTC_IT_INT_TAMP_11 | RTC_IT_INT_TAMP_12 | RTC_IT_INT_TAMP_13 | \
          RTC_IT_INT_TAMP_15 )
/**
 * @}
 */
...
#define RTC_FLAG_INT_TAMP_ALL                                                                     \
        ( RTC_FLAG_INT_TAMP_1 | RTC_FLAG_INT_TAMP_2 | RTC_FLAG_INT_TAMP_3 | RTC_FLAG_INT_TAMP_4 | \
          RTC_FLAG_INT_TAMP_5 | RTC_FLAG_INT_TAMP_6 | RTC_FLAG_INT_TAMP_7 | RTC_FLAG_INT_TAMP_8 | \
          RTC_FLAG_INT_TAMP_9 | RTC_FLAG_INT_TAMP_11 | RTC_FLAG_INT_TAMP_12 |                     \
          RTC_FLAG_INT_TAMP_13 | RTC_FLAG_INT_TAMP_15 )
/**
 * @}
 */
 ...
 *           Warning : It Should not be confused with the Binary format @ref
...
#define RTC_BINARY_MIX_BCDU_1                                                                     \
        ( 0x1UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[8:0] = 0  */
#define RTC_BINARY_MIX_BCDU_2                                                                     \
        ( 0x2UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[9:0] = 0  */
#define RTC_BINARY_MIX_BCDU_3                                                                     \
        ( 0x3UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[10:0] = 0 */
#define RTC_BINARY_MIX_BCDU_4                                                                     \
        ( 0x4UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[11:0] = 0 */
#define RTC_BINARY_MIX_BCDU_5                                                                     \
        ( 0x5UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[12:0] = 0 */
#define RTC_BINARY_MIX_BCDU_6                                                                     \
        ( 0x6UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[13:0] = 0 */
#define RTC_BINARY_MIX_BCDU_7                                                                     \
        ( 0x7UL << RTC_ICSR_BCDU_Pos ) /*!<  The 1s BCD calendar increment is generated each time \
                                          SS[14:0] = 0 */
/**
 * @}
 */

/** @defgroup RTCEx_Alarm_Sub_Seconds_binary_Masks_Definitions RTC Alarm Sub Seconds with binary or
 * mix mode Masks Definitions.
 * @{
 */
#define RTC_ALARMSUBSECONDBINMASK_ALL \
        0U /*!< All Alarm SS fields are masked.There is no comparison on sub seconds for Alarm */
#define RTC_ALARMSUBSECONDBINMASK_SS31_1                                                          \
        ( 1UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:1] are don't care in Alarm comparison. Only \
                                              SS[0] is compared            */
#define RTC_ALARMSUBSECONDBINMASK_SS31_2                                                          \
        ( 2UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:2] are don't care in Alarm comparison. Only \
                                              SS[1:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_3                                                          \
        ( 3UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:3] are don't care in Alarm comparison. Only \
                                              SS[2:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_4                                                          \
        ( 4UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:4] are don't care in Alarm comparison. Only \
                                              SS[3:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_5                                                          \
        ( 5UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:5] are don't care in Alarm comparison. Only \
                                              SS[4:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_6                                                          \
        ( 6UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:6] are don't care in Alarm comparison. Only \
                                              SS[5:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_7                                                          \
        ( 7UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:7] are don't care in Alarm comparison. Only \
                                              SS[6:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_8                                                          \
        ( 8UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:8] are don't care in Alarm comparison. Only \
                                              SS[7:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_9                                                          \
        ( 9UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:9] are don't care in Alarm comparison. Only \
                                              SS[8:0] are compared         */
#define RTC_ALARMSUBSECONDBINMASK_SS31_10                                                      \
        ( 10UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:10] are don't care in Alarm comparison. \
                                               Only SS[9:0] are compared        */
#define RTC_ALARMSUBSECONDBINMASK_SS31_11                                                      \
        ( 11UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:11] are don't care in Alarm comparison. \
                                               Only SS[10:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_12                                                          \
        ( 12UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:12] are don't care in Alarm comparison.Only \
                                               SS[11:0] are compared        */
#define RTC_ALARMSUBSECONDBINMASK_SS31_13                                                      \
        ( 13UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:13] are don't care in Alarm comparison. \
                                               Only SS[12:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_14                                                      \
        ( 14UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:14] are don't care in Alarm comparison. \
                                               Only SS[13:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_15                                                      \
        ( 15UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:15] are don't care in Alarm comparison. \
                                               Only SS[14:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_16                                                      \
        ( 16UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:16] are don't care in Alarm comparison. \
                                               Only SS[15:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_17                                                      \
        ( 17UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:17] are don't care in Alarm comparison. \
                                               Only SS[16:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_18                                                      \
        ( 18UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:18] are don't care in Alarm comparison. \
                                               Only SS[17:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_19                                                      \
        ( 19UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:19] are don't care in Alarm comparison. \
                                               Only SS[18:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_20                                                      \
        ( 20UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:20] are don't care in Alarm comparison. \
                                               Only SS[19:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_21                                                      \
        ( 21UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:21] are don't care in Alarm comparison. \
                                               Only SS[20:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_22                                                      \
        ( 22UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:22] are don't care in Alarm comparison. \
                                               Only SS[21:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_23                                                      \
        ( 23UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:23] are don't care in Alarm comparison. \
                                               Only SS[22:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_24                                                      \
        ( 24UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:24] are don't care in Alarm comparison. \
                                               Only SS[23:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_25                                                      \
        ( 25UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:25] are don't care in Alarm comparison. \
                                               Only SS[24:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_26                                                      \
        ( 26UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:26] are don't care in Alarm comparison. \
                                               Only SS[25:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_27                                                      \
        ( 27UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:27] are don't care in Alarm comparison. \
                                               Only SS[26:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_28                                                      \
        ( 28UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:28] are don't care in Alarm comparison. \
                                               Only SS[27:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_29                                                      \
        ( 29UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:29] are don't care in Alarm comparison. \
                                               Only SS[28:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31_30                                                      \
        ( 30UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31:30] are don't care in Alarm comparison. \
                                               Only SS[29:0] are compared       */
#define RTC_ALARMSUBSECONDBINMASK_SS31                                                          \
        ( 31UL << RTC_ALRMASSR_MASKSS_Pos ) /*!< SS[31] is don't care in Alarm comparison. Only \
                                               SS[30:0] are compared           */
#define RTC_ALARMSUBSECONDBINMASK_NONE \
        RTC_ALRMASSR_MASKSS /*!< SS[31:0] are compared and must match to activate alarm */
/**
 * @}
 */
...
#define RTC_SECURE_FULL_NO                                                                         \
        0U /*!< RTC is not full secure, features can be unsecure. See RTCEx_RTC_NonSecure_Features \
            */
/**
 * @}
 */
...
#define RTC_NONSECURE_FEATURE_ALL                                                             \
        ( RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | RTC_SECCFGR_TSSEC | RTC_SECCFGR_WUTSEC | \
...
/** @defgroup RTCEx_TAMP_Device_Secrets_Erase_Conf  RTCEx TAMP Device Secrets Erase Configuration
 * Definition
 * @{
 */
...
/** @defgroup RTCEx_TAMP_Monotonic_Counter_Privilege  RTCEx TAMP Monotonic Counter Privilege
 * Definition
 * @{
 */
...
#define __HAL_RTC_GET_FLAG( __HANDLE__, __FLAG__ )                                                 \
        ( ( ( __FLAG__ ) == RTC_FLAG_RECALPF ) ?                                                   \
          ...
          ( ( __FLAG__ ) == RTC_FLAG_ALRAF ) ? ( READ_BIT( RTC->SR, RTC_SR_ALRAF ) ==              \
                                                 RTC_SR_ALRAF ) :                                  \
                                               ( 0U ) ) /*!< Return 0 because it is an invalid     \
                                                           parameter value */
...
#define __HAL_RTC_TIMESTAMP_CLEAR_FLAG( __HANDLE__, __FLAG__ )                                  \
        ( ( ( __FLAG__ ) == RTC_FLAG_TSF )   ? ( SET_BIT( RTC->SCR, RTC_SCR_CTSF ) ) :          \
          ( ( __FLAG__ ) == RTC_FLAG_TSOVF ) ? ( SET_BIT( RTC->SCR, RTC_SCR_CTSOVF ) ) :        \
                                               ( 0U ) ) /*!< Dummy action because is an invalid \
                                                           parameter value */
...
HAL_StatusTypeDef
HAL_RTCEx_SetWakeUpTimer( RTC_HandleTypeDef* hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock );
...
HAL_StatusTypeDef
HAL_RTCEx_PollForWakeUpTimerEvent( RTC_HandleTypeDef const* hrtc, uint32_t Timeout );
/**
 * @}
 */
...
HAL_StatusTypeDef
HAL_RTCEx_SetSynchroShift( RTC_HandleTypeDef* hrtc, uint32_t ShiftAdd1S, uint32_t ShiftSubFS );
#if defined( RTC_CR_COSEL )
...
HAL_StatusTypeDef
HAL_RTCEx_MonotonicCounterIncrement( RTC_HandleTypeDef const* hrtc, uint32_t Instance );
HAL_StatusTypeDef
HAL_RTCEx_MonotonicCounterGet( RTC_HandleTypeDef const* hrtc, uint32_t Instance, uint32_t* pValue );
...
HAL_StatusTypeDef HAL_RTCEx_PollForAlarmBEvent( RTC_HandleTypeDef const* hrtc, uint32_t Timeout );
/**
 * @}
 */
 ...
 */
HAL_StatusTypeDef
HAL_RTCEx_SetTamper( RTC_HandleTypeDef const* hrtc, RTC_TamperTypeDef const* sTamper );
HAL_StatusTypeDef
HAL_RTCEx_SetActiveTampers( RTC_HandleTypeDef* hrtc, RTC_ActiveTampersTypeDef const* sAllTamper );
HAL_StatusTypeDef HAL_RTCEx_SetActiveSeed( RTC_HandleTypeDef* hrtc, uint32_t const* pSeed );
HAL_StatusTypeDef
HAL_RTCEx_SetTamper_IT( RTC_HandleTypeDef const* hrtc, RTC_TamperTypeDef const* sTamper );
...
HAL_StatusTypeDef
HAL_RTCEx_PollForTamperEvent( RTC_HandleTypeDef const* hrtc, uint32_t Tamper, uint32_t Timeout );
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper(
    RTC_HandleTypeDef const*         hrtc,
    RTC_InternalTamperTypeDef const* sIntTamper );
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper_IT(
    RTC_HandleTypeDef const*         hrtc,
    RTC_InternalTamperTypeDef const* sIntTamper );
HAL_StatusTypeDef
HAL_RTCEx_DeactivateInternalTamper( RTC_HandleTypeDef const* hrtc, uint32_t IntTamper );
HAL_StatusTypeDef HAL_RTCEx_PollForInternalTamperEvent(
    RTC_HandleTypeDef const* hrtc,
    uint32_t                 IntTamper,
    uint32_t                 Timeout );
#if defined( TAMP_SECCFGR_BHKLOCK )
HAL_StatusTypeDef HAL_RTCEx_LockBootHardwareKey( RTC_HandleTypeDef const* hrtc );
...
void     HAL_RTCEx_BKUPErase( RTC_HandleTypeDef const* hrtc );
void     HAL_RTCEx_BKUPBlock( RTC_HandleTypeDef const* hrtc );
void     HAL_RTCEx_BKUPUnblock( RTC_HandleTypeDef const* hrtc );
#ifdef TAMP_ERCFGR_ERCFG0
void HAL_RTCEx_ConfigEraseDeviceSecrets( RTC_HandleTypeDef const* hrtc, uint32_t DeviceSecretConf );
 ...
 */
HAL_StatusTypeDef
HAL_RTCEx_SecureModeGet( RTC_HandleTypeDef const* hrtc, RTC_SecureStateTypeDef* secureState );
#if defined( __ARM_FEATURE_CMSE ) && ( __ARM_FEATURE_CMSE == 3U )
HAL_StatusTypeDef
HAL_RTCEx_SecureModeSet( RTC_HandleTypeDef const* hrtc, RTC_SecureStateTypeDef const* secureState );
 ...
 * @{
 */
HAL_StatusTypeDef HAL_RTCEx_PrivilegeModeSet(
    RTC_HandleTypeDef const*         hrtc,
    RTC_PrivilegeStateTypeDef const* privilegeState );
