...
#define LL_DCACHE_MONITOR_ALL \
        ( DCACHE_CR_RHITMEN | DCACHE_CR_RMISSMEN | DCACHE_CR_WHITMEN | DCACHE_CR_WMISSMEN )
/**
 * @}
 */
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabled( DCACHE_TypeDef const* DCACHEx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_GetStartAddress( DCACHE_TypeDef const* DCACHEx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_GetEndAddress( DCACHE_TypeDef const* DCACHEx )
{
 ...
 *         @arg @ref LL_DCACHE_COMMAND_CLEAN_INVALIDATE_BY_ADDR
 */
__STATIC_INLINE uint32_t LL_DCACHE_GetCommand( DCACHE_TypeDef const* DCACHEx )
{
        /*Get Dcache Command */
 ...
 *         @arg @ref LL_DCACHE_READ_BURST_INCR
 */
__STATIC_INLINE uint32_t LL_DCACHE_GetReadBurstType( DCACHE_TypeDef const* DCACHEx )
{
...
LL_DCACHE_IsEnabledMonitors( DCACHE_TypeDef const* DCACHEx, uint32_t Monitors )
{
        return (
            ( ( READ_BIT(
                    DCACHEx->CR,
                    ( DCACHE_CR_WMISSMEN | DCACHE_CR_WHITMEN | DCACHE_CR_RMISSMEN |
                      DCACHE_CR_RHITMEN ) ) &
                Monitors ) == ( Monitors ) ) ?
                1UL :
                0UL );
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetReadHitValue( DCACHE_TypeDef const* DCACHEx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetReadMissValue( DCACHE_TypeDef const* DCACHEx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetWriteHitValue( DCACHE_TypeDef const* DCACHEx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFFFF
 */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetWriteMissValue( DCACHE_TypeDef const* DCACHEx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_BSYEND( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->IER, DCACHE_IER_BSYENDIE ) == ( DCACHE_IER_BSYENDIE ) ) ? 1UL :
                                                                                           0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_ERR( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->IER, DCACHE_IER_ERRIE ) == ( DCACHE_IER_ERRIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_CMDEND( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->IER, DCACHE_IER_CMDENDIE ) == ( DCACHE_IER_CMDENDIE ) ) ? 1UL :
                                                                                           0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BUSY( DCACHE_TypeDef const* DCACHEx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BSYEND( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->SR, DCACHE_SR_BSYENDF ) == ( DCACHE_SR_BSYENDF ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_ERR( DCACHE_TypeDef const* DCACHEx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BUSYCMD( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->SR, DCACHE_SR_BUSYCMDF ) == ( DCACHE_SR_BUSYCMDF ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_CMDEND( DCACHE_TypeDef const* DCACHEx )
{
        return (
            ( READ_BIT( DCACHEx->SR, DCACHE_SR_CMDENDF ) == ( DCACHE_SR_CMDENDF ) ) ? 1UL : 0UL );
}
