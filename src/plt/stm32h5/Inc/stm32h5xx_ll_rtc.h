...
/** @defgroup RTC_LL_EC_ALMA_SUBSECONDBIN_AUTOCLR  RTC Alarm Sub Seconds with binary mode auto clear
 * Definitions
 * @{
 */
...
/*!< The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to
   RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFF FFFF when reaching
...
/** @defgroup RTC_LL_EC_ALMB_SUBSECONDBIN_AUTOCLR  Alarm Sub Seconds with binary mode auto clear
 * Definitions
 * @{
 */
...
/*!< The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to
   RTC_ALRMBBINR -> SS[31:0] value and is automatically reloaded with 0xFFFF FFFF when reaching
   RTC_ALRMBBINR -> SS[31:0]. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_MASK_TAMPER1                                                               \
        TAMP_CR2_TAMP1MSK /*!< Tamper 1 event generates a trigger event. TAMP1F is masked and    \
                             internally cleared by hardware. The backup registers are not erased \
                           */
#define LL_RTC_TAMPER_MASK_TAMPER2                                                               \
        TAMP_CR2_TAMP2MSK /*!< Tamper 2 event generates a trigger event. TAMP2F is masked and    \
                             internally cleared by hardware. The backup registers are not erased \
                           */
#if ( RTC_TAMP_NB > 2U )
#define LL_RTC_TAMPER_MASK_TAMPER3                                                               \
        TAMP_CR2_TAMP3MSK /*!< Tamper 3 event generates a trigger event. TAMP3F is masked and    \
                             internally cleared by hardware. The backup registers are not erased \
                           */
...
#define LL_RTC_TAMPER_NOERASE_TAMPER1 \
        TAMP_CR2_TAMP1NOERASE /*!< Tamper 1 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER2 \
        TAMP_CR2_TAMP2NOERASE /*!< Tamper 2 event does not erase the backup registers */
#if ( RTC_TAMP_NB == 3U )
#define LL_RTC_TAMPER_NOERASE_TAMPER3 \
        TAMP_CR2_TAMP3NOERASE /*!< Tamper 3 event does not erase the backup registers */
#elif ( RTC_TAMP_NB == 8U )
#define LL_RTC_TAMPER_NOERASE_TAMPER3 \
        TAMP_CR2_TAMP3NOERASE /*!< Tamper 3 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER4 \
        TAMP_CR2_TAMP4NOERASE /*!< Tamper 4 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER5 \
        TAMP_CR2_TAMP5NOERASE /*!< Tamper 5 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER6 \
        TAMP_CR2_TAMP6NOERASE /*!< Tamper 6 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER7 \
        TAMP_CR2_TAMP7NOERASE /*!< Tamper 7 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_TAMPER8 \
        TAMP_CR2_TAMP8NOERASE /*!< Tamper 8 event does not erase the backup registers */
#endif                        /* RTC_TAMP_NB */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_DURATION_2RTCCLK                                                         \
        TAMP_FLTCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before sampling during 2 RTCCLK \
                                 cycles */
#define LL_RTC_TAMPER_DURATION_4RTCCLK                                                         \
        TAMP_FLTCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before sampling during 4 RTCCLK \
                                 cycles */
#define LL_RTC_TAMPER_DURATION_8RTCCLK                                                       \
        TAMP_FLTCR_TAMPPRCH /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK \
                               cycles */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_FILTER_2SAMPLE                                                            \
        TAMP_FLTCR_TAMPFLT_0 /*!< Tamper is activated after 2 consecutive samples at the active \
                                level */
#define LL_RTC_TAMPER_FILTER_4SAMPLE                                                            \
        TAMP_FLTCR_TAMPFLT_1 /*!< Tamper is activated after 4 consecutive samples at the active \
                                level */
#define LL_RTC_TAMPER_FILTER_8SAMPLE                                                          \
        TAMP_FLTCR_TAMPFLT /*!< Tamper is activated after 8 consecutive samples at the active \
                              level */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_32768 \
        0U /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 32768 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_16384                                                           \
        TAMP_FLTCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK \
                                 / 16384 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_8192                                                            \
        TAMP_FLTCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK \
                                 / 8192  */
#define LL_RTC_TAMPER_SAMPLFREQDIV_4096                                                           \
        ( TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_0 ) /*!< Each of the tamper inputs are      \
                                                             sampled with a frequency =  RTCCLK / \
                                                             4096  */
#define LL_RTC_TAMPER_SAMPLFREQDIV_2048                                                            \
        TAMP_FLTCR_TAMPFREQ_2 /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK \
                                 / 2048  */
#define LL_RTC_TAMPER_SAMPLFREQDIV_1024                                                           \
        ( TAMP_FLTCR_TAMPFREQ_2 | TAMP_FLTCR_TAMPFREQ_0 ) /*!< Each of the tamper inputs are      \
                                                             sampled with a frequency =  RTCCLK / \
                                                             1024  */
#define LL_RTC_TAMPER_SAMPLFREQDIV_512                                                            \
        ( TAMP_FLTCR_TAMPFREQ_2 | TAMP_FLTCR_TAMPFREQ_1 ) /*!< Each of the tamper inputs are      \
                                                             sampled with a frequency =  RTCCLK / \
                                                             512   */
#define LL_RTC_TAMPER_SAMPLFREQDIV_256                                                            \
        TAMP_FLTCR_TAMPFREQ /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK \
                               / 256   */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                                          \
        TAMP_CR2_TAMP1TRG /*!< Tamper 1 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                                          \
        TAMP_CR2_TAMP2TRG /*!< Tamper 2 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#if ( RTC_TAMP_NB == 3U )
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                          \
        TAMP_CR2_TAMP3TRG /*!< Tamper 3 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#elif ( RTC_TAMP_NB == 8U )
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                          \
        TAMP_CR2_TAMP3TRG /*!< Tamper 3 input falling edge (if TAMPFLT = 00) or staying high (if \
...
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP4                                                          \
        TAMP_CR2_TAMP4TRG /*!< Tamper 4 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP5                                                          \
        TAMP_CR2_TAMP5TRG /*!< Tamper 5 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP6                                                          \
        TAMP_CR2_TAMP6TRG /*!< Tamper 6 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP7                                                          \
        TAMP_CR2_TAMP7TRG /*!< Tamper 7 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP8                                                          \
        TAMP_CR2_TAMP8TRG /*!< Tamper 8 input falling edge (if TAMPFLT = 00) or staying high (if \
                             TAMPFLT != 00) triggers a tamper detection event */
#endif                    /* RTC_TAMP_NB */
/**
 * @}
...
#define LL_RTC_TAMPER_ITAMP7                                                                    \
        TAMP_CR1_ITAMP7E /*!< Internal tamper 7: Voltage monitoring (VCORE, VREF+), through ADC \
                            analog watchdog  */
...
#define LL_RTC_TAMPER_ITAMP11 \
        TAMP_CR1_ITAMP11E /*!< Internal tamper 11: IWDG reset when tamper flag is set */
#define LL_RTC_TAMPER_ITAMP12                                                                     \
        TAMP_CR1_ITAMP12E /*!< Internal tamper 12: Voltage monitoring (VCORE, VREF+), through ADC \
                             analog watchdog */
#define LL_RTC_TAMPER_ITAMP13                                                                     \
        TAMP_CR1_ITAMP13E /*!< Internal tamper 13: Voltage monitoring (VCORE, VREF+), through ADC \
                             analog watchdog */
...
#define LL_RTC_TAMPER_NOERASE_ITAMPER1 \
        TAMP_CR3_ITAMP1NOER /*!< Internal tamper 1 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER2 \
        TAMP_CR3_ITAMP2NOER /*!< Internal tamper 2 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER3 \
        TAMP_CR3_ITAMP3NOER /*!< Internal tamper 3 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER4 \
        TAMP_CR3_ITAMP4NOER /*!< Internal tamper 4 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER5 \
        TAMP_CR3_ITAMP5NOER /*!< Internal tamper 5 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER6 \
        TAMP_CR3_ITAMP6NOER /*!< Internal tamper 6 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER7 \
        TAMP_CR3_ITAMP7NOER /*!< Internal tamper 7 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER8 \
        TAMP_CR3_ITAMP8NOER /*!< Internal tamper 8 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER9 \
        TAMP_CR3_ITAMP9NOER /*!< Internal tamper 9 event does not erase the backup registers  */
#define LL_RTC_TAMPER_NOERASE_ITAMPER11 \
        TAMP_CR3_ITAMP11NOER /*!< Internal tamper 10 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_ITAMPER12 \
        TAMP_CR3_ITAMP12NOER /*!< Internal tamper 11 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_ITAMPER13 \
        TAMP_CR3_ITAMP13NOER /*!< Internal tamper 12 event does not erase the backup registers */
#define LL_RTC_TAMPER_NOERASE_ITAMPER15 \
        TAMP_CR3_ITAMP15NOER /*!< Internal tamper 13 event does not erase the backup registers */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_ATAMP_ASYNCPRES_RTCCLK_2048 \
        ( TAMP_ATCR1_ATCKSEL_3 | TAMP_ATCR1_ATCKSEL_1 | TAMP_ATCR1_ATCKSEL_0 ) /*!< RTCCLK/2048 */
...
#define LL_RTC_BINARY_MIX_BCDU_1                                                                   \
        ( 0x1UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[8:0] = \
                                          0  */
#define LL_RTC_BINARY_MIX_BCDU_2                                                                   \
        ( 0x2UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[9:0] = \
                                          0  */
#define LL_RTC_BINARY_MIX_BCDU_3                                                                  \
        ( 0x3UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[10:0] \
                                          = 0 */
#define LL_RTC_BINARY_MIX_BCDU_4                                                                  \
        ( 0x4UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[11:0] \
                                          = 0 */
#define LL_RTC_BINARY_MIX_BCDU_5                                                                  \
        ( 0x5UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[12:0] \
                                          = 0 */
#define LL_RTC_BINARY_MIX_BCDU_6                                                                  \
        ( 0x6UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[13:0] \
                                          = 0 */
#define LL_RTC_BINARY_MIX_BCDU_7                                                                  \
        ( 0x7UL << RTC_ICSR_BCDU_Pos ) /*!< 1s calendar increment is generated each time SS[14:0] \
                                          = 0 */
/**
 * @}
 */
...
#define LL_RTC_SECURE_FULL_NO                                                                    \
        0U /*!< RTC is not full secure, features can be secure. See RTC_LL_EC_SECURE_RTC_FEATURE \
            */
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_RTC_GetBinaryMode( RTC_TypeDef const* RTCx )
{
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_RTC_GetBinMixBCDU( RTC_TypeDef const* RTCx )
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_TIME_Config(
    RTC_TypeDef* RTCx,
...
LL_RTC_TIME_Synchronize( RTC_TypeDef* RTCx, uint32_t ShiftSecond, uint32_t Fraction )
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DATE_Config(
    RTC_TypeDef* RTCx,
    uint32_t     WeekDay,
    uint32_t     Day,
    uint32_t     Month,
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetMask( RTC_TypeDef const* RTCx )
{
        return (uint32_t) ( READ_BIT(
            RTCx->ALRMAR, RTC_ALRMAR_MSK4 | RTC_ALRMAR_MSK3 | RTC_ALRMAR_MSK2 | RTC_ALRMAR_MSK1 ) );
}
 ...
 *         @arg @ref LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES
 */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetBinAutoClr( RTC_TypeDef const* RTCx )
{
...
{
        return (uint32_t) ( READ_BIT(
            RTCx->ALRMBR, RTC_ALRMBR_MSK4 | RTC_ALRMBR_MSK3 | RTC_ALRMBR_MSK2 | RTC_ALRMBR_MSK1 ) );
}
 ...
 * @retval Combination of hours, minutes and seconds.
 */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetTime( RTC_TypeDef const* RTCx )
{
 ...
 *         @arg @ref LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES
 */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetBinAutoClr( RTC_TypeDef const* RTCx )
{
...
{
        return (uint32_t) ( READ_BIT(
            RTCx->TSDR, RTC_TSDR_WDU | RTC_TSDR_MT | RTC_TSDR_MU | RTC_TSDR_DT | RTC_TSDR_DU ) );
}
 ...
 */
__STATIC_INLINE void
LL_RTC_TAMPER_ITAMP_EnableEraseBKP( RTC_TypeDef const* RTCx, uint32_t InternalTamper )
{
        UNUSED( RTCx );
 ...
 */
__STATIC_INLINE void
LL_RTC_TAMPER_ITAMP_DisableEraseBKP( RTC_TypeDef const* RTCx, uint32_t InternalTamper )
{
        UNUSED( RTCx );
...
__STATIC_INLINE void LL_RTC_TAMPER_ATAMP_SetSharedOuputSelection( uint32_t OutputSelection )
{
        ...
        MODIFY_REG(
            TAMP->ATCR2,
            ( TAMP_ATCR2_ATOSEL1 | TAMP_ATCR2_ATOSEL2 | TAMP_ATCR2_ATOSEL3 | TAMP_ATCR2_ATOSEL4 |
...
#elif ( RTC_TAMP_NB == 3U )
        return ( READ_BIT(
            TAMP->ATCR2, ( TAMP_ATCR2_ATOSEL1 | TAMP_ATCR2_ATOSEL2 | TAMP_ATCR2_ATOSEL3 ) ) );
#elif ( RTC_TAMP_NB == 8U )
        return ( READ_BIT(
            TAMP->ATCR2,
            ( TAMP_ATCR2_ATOSEL1 | TAMP_ATCR2_ATOSEL2 | TAMP_ATCR2_ATOSEL3 | TAMP_ATCR2_ATOSEL4 |
 ...
 */
__STATIC_INLINE void
LL_RTC_BKP_SetRegister( RTC_TypeDef const* RTCx, uint32_t BackupRegister, uint32_t Data )
{
        __IO uint32_t tmp;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SSRU( RTC_TypeDef const* RTCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SSRUM( RTC_TypeDef const* RTCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP7( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP9( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP11( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP12( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP13( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP15( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP1M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP1MF ) == ( TAMP_MISR_ITAMP1MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP2M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP2MF ) == ( TAMP_MISR_ITAMP2MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP3M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP3MF ) == ( TAMP_MISR_ITAMP3MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP4M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP4MF ) == ( TAMP_MISR_ITAMP4MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP5M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP5MF ) == ( TAMP_MISR_ITAMP5MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP6M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP6MF ) == ( TAMP_MISR_ITAMP6MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP7M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP7MF ) == ( TAMP_MISR_ITAMP7MF ) ) ? 1U : 0U );
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP8M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP8MF ) == ( TAMP_MISR_ITAMP8MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP9M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP9MF ) == ( TAMP_MISR_ITAMP9MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP11M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP11MF ) == ( TAMP_MISR_ITAMP11MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP12M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP12MF ) == ( TAMP_MISR_ITAMP12MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP13M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP13MF ) == ( TAMP_MISR_ITAMP13MF ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITAMP15M( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->MISR, TAMP_MISR_ITAMP15MF ) == ( TAMP_MISR_ITAMP15MF ) ) ? 1U : 0U );
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP7( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP9( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP11( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP12( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP13( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ITAMP15( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
...
__STATIC_INLINE void LL_RTC_SetRtcSecure( RTC_TypeDef* RTCx, uint32_t rtcSecure )
{
        MODIFY_REG(
            RTCx->SECCFGR,
            RTC_SECCFGR_SEC | RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | RTC_SECCFGR_TSSEC |
...
__STATIC_INLINE void LL_RTC_SetRtcPrivilege( RTC_TypeDef* RTCx, uint32_t rtcPrivilege )
{
        MODIFY_REG(
            RTCx->PRIVCFGR,
            RTC_PRIVCFGR_PRIV | RTC_PRIVCFGR_INITPRIV | RTC_PRIVCFGR_CALPRIV | RTC_PRIVCFGR_TSPRIV |
 ...
 */
__STATIC_INLINE void
LL_RTC_SetBackupRegisterPrivilege( RTC_TypeDef const* RTCx, uint32_t bckupRegisterPrivilege )
{
        UNUSED( RTCx );
        MODIFY_REG(
            TAMP->PRIVCFGR,
 ...
 */
__STATIC_INLINE void
LL_RTC_SetBackupRegProtection( RTC_TypeDef const* RTCx, uint32_t startZone2, uint32_t startZone3 )
{
        UNUSED( RTCx );
        MODIFY_REG(
            TAMP->SECCFGR,
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_SSRU( RTC_TypeDef const* RTCx )
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP7( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP7( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP9( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP9( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP11( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP11( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP12( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP12( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP13( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP13( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ITAMP15( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ITAMP15( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP7( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP9( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP11( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->IER, TAMP_IER_ITAMP11IE ) == ( TAMP_IER_ITAMP11IE ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP12( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->IER, TAMP_IER_ITAMP12IE ) == ( TAMP_IER_ITAMP12IE ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP13( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->IER, TAMP_IER_ITAMP13IE ) == ( TAMP_IER_ITAMP13IE ) ) ? 1U : 0U );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP15( RTC_TypeDef const* RTCx )
{
        UNUSED( RTCx );
        return (
            ( READ_BIT( TAMP->IER, TAMP_IER_ITAMP15IE ) == ( TAMP_IER_ITAMP15IE ) ) ? 1U : 0U );
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableRemapRtcOut2( RTC_TypeDef const* RTCx )
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableRemapRtcOut2( RTC_TypeDef const* RTCx )
{
        /* Prevent unused argument(s) compilation warning */
        UNUSED( RTCx );
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledRemapRtcOut2( RTC_TypeDef const* RTCx )
{
        /* Prevent unused argument(s) compilation warning */
        UNUSED( RTCx );
        /* Disable  RTC OUT2 remap */
...
ErrorStatus
LL_RTC_ALMA_Init( RTC_TypeDef* RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef* RTC_AlarmStruct );
ErrorStatus
LL_RTC_ALMB_Init( RTC_TypeDef* RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef* RTC_AlarmStruct );
