...
typedef struct
{
        ...
        uint32_t PLL2FRACN; /*!<PLL2FRACN: Specifies Fractional Part Of The Multiplication Factor
        ...
        uint32_t PLL2ClockOut; /*!< PLL2ClockOut: specifies PLL2 output clock to be enabled.
                                        This parameter must be a value or a combination of @ref
                                  RCC_PLL2_Clock_Output */
} RCC_PLL2InitTypeDef;
...
typedef struct
{
        ...
        uint32_t PLL3FRACN; /*!<PLL3FRACN: Specifies Fractional Part Of The Multiplication Factor
...
typedef struct
{
        ...
        uint32_t AdcDacClockSelection; /*!< Specifies ADC1, ADC2 and DAC interface clock source.
                                            This parameter can be a value of @ref
                                          RCCEx_ADCDAC_Clock_Source */

        uint32_t DacLowPowerClockSelection; /*!< Specifies DAC low-power clock source used in Sample
                                               and hold mode. This parameter can be a value of @ref
...
typedef struct
{
        ...
        uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter
                                 with each SYNC event. It can be calculated in using macro
        ...
        uint32_t ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured
                                     frequency error value. This parameter must be a number between
                                     0 and 0xFF or a value of
                                     @ref RCCEx_CRS_ErrorLimitDefault */

        uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the
                                           HSI48 oscillator. This parameter must be a number between
                                           0 and 0x7F or a value of
...
typedef struct
{
        ...
        uint32_t HSI48CalibrationValue; /*!< Specifies value loaded in HSI48 oscillator smooth
                                           trimming. This parameter must be a number between 0 and
                                           0x3F */

        uint32_t FreqErrorCapture; /*!< Specifies the value loaded in the .FECAP, the frequency
                                      error counter value latched in the time of the last SYNC
                                      event. This parameter must be a number between 0 and 0xFFFF */

        uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting
                                        direction of the frequency error counter latched in the time
                                        of the last SYNC event. It shows whether the actual
                                        frequency is below or above the target. This parameter must
                                        be a value of @ref RCCEx_CRS_FreqErrorDirection */
...
#define RCC_LSCOSOURCE_LSE \
        RCC_BDCR_LSCOSEL /*!< LSE selection for low speed microcontroller clock output */
/**
 * @}
 */
...
#define RCC_PLL2_VCIRANGE_3                                                                      \
        ( RCC_PLL2CFGR_PLL2RGE_0 | RCC_PLL2CFGR_PLL2RGE_1 ) /*!< Clock range frequency between 8 \
                                                               and 16 MHz */
/**
 * @}
 */
...
#define RCC_PLL3_VCIRANGE_3                                                                      \
        ( RCC_PLL3CFGR_PLL3RGE_0 | RCC_PLL3CFGR_PLL3RGE_1 ) /*!< Clock range frequency between 8 \
                                                               and 16 MHz */
/**
 * @}
 */
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                   \
        ( (uint32_t) 0x00000020U ) /*!< The default value is 32, which corresponds to the  \
...
#define RCC_CRS_FREQERRORDIR_UP                                                                 \
        ( (uint32_t) 0x00000000U ) /*!< Upcounting direction, the actual frequency is above the \
                                      target */
...
/** @brief  Macros to enable or disable the HSI and CSI divided clock for Timers 12, 15 and LPTimer2
 * input capture.
 * @note   HSI and CSI clocks without division are available when TIMIC is enabled
 * @retval None
 */
#define __HAL_RCC_TIMIC_ENABLE()                                                                   \
        SET_BIT( RCC->CCIPR1, RCC_CCIPR1_TIMICSEL ) /*!< HSI/1024, CSI/128 and HSI/8 generation    \
                                                       for Timers 12,15 and LPTimer2 Input capture \
                                                     */
#define __HAL_RCC_TIMIC_DISABLE()                                                              \
        CLEAR_BIT( RCC->CCIPR1, RCC_CCIPR1_TIMICSEL ) /*!< No clock available for Timers Input \
                                                         capture */
 ...
 *         output frequency is between 192 and 836 MHz (Wide range) or 150 and 420 Mhz (Medium
 * range). PLL2 clock frequency = f(PLL2) multiplied by PLL2N
 *
...
#define __HAL_RCC_PLL2_CONFIG(                                                 \
    __PLL2SOURCE__, __PLL2M__, __PLL2N__, __PLL2P__, __PLL2Q__, __PLL2R__ )    \
        do {                                                                   \
                MODIFY_REG(                                                    \
                    RCC->PLL2CFGR,                                             \
                    ( RCC_PLL2CFGR_PLL2SRC | RCC_PLL2CFGR_PLL2M ),             \
 ...
 * @note   Enabling/disabling those clocks can be done at any time without the need to stop the
 * PLL2, This is mainly used to save Power.
 ...
 *                                high-quality audio performance on SAI interface, SPI/I2S and LPTIM
 * peripherals.
 *            @arg RCC_PLL2_DIVQ: This clock is used to generate kernel clock for the random number
 * generator RNG
 *                                (<=48 MHz), SPI, FDCAN and UART/USART peripherals.
 *            @arg RCC_PLL2_DIVR: This clock is used to generate kernel clock for ADC and DAC
 * peripherals.
 * @retval None
 */
 ...
 * @note   Enabling/disabling  Fractional Part can be done at any time without the need to stop the
 * PLL2
 * @retval None
 */
 ...
 * @retval None
 */
#define __HAL_RCC_PLL3_CONFIG(                                                 \
    __PLL3SOURCE__, __PLL3M__, __PLL3N__, __PLL3P__, __PLL3Q__, __PLL3R__ )    \
        do {                                                                   \
                MODIFY_REG(                                                    \
                    RCC->PLL3CFGR,                                             \
                    ( RCC_PLL3CFGR_PLL3SRC | RCC_PLL3CFGR_PLL3M ),             \
 ...
 * @note   You have to set the PLL3N parameter correctly to ensure that the VCO
 *         output frequency is between 192 and 836 MHz (Wide range) or 150 and 420 Mhz (Medium
 * range). PLL3 clock frequency = f(PLL3) multiplied by PLL3N
 *
 * @retval None
 */
 ...
 *            @arg RCC_PLL3_DIVQ: This clock is used to generate kernel clock for SPI, LPUART,
 * UART/USART and USB peripherals.
 *            @arg RCC_PLL3_DIVR: This clock is used to generate kernel clock for I2C, I3C and LPTIM
 * peripherals.
 *
 * @retval None
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_ADCDACCLKSOURCE_HCLK   AHB bus clock selected as ADC and DAC kernel
 * clock
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_DACLPCLKSOURCE_LSE LSE oscillator selected as DAC kernel clock in
 * low-power mode
 *            @arg @ref RCC_DACLPCLKSOURCE_LSI LSI oscillator selected as DAC kernel clock in
 * low-power mode
 * @retval None
 */
 ...
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_DACLPCLKSOURCE_LSE LSE oscillator used as DAC kernel clock in low-power
 * mode
 *            @arg @ref RCC_DACLPCLKSOURCE_LSI LSI oscillator used as DAC kernel clock in low-power
 * mode
 */
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
        ( RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |                     \
          RCC_PERIPHCLK_UART4 | RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_USART6 | RCC_PERIPHCLK_UART7 | \
          RCC_PERIPHCLK_UART8 | RCC_PERIPHCLK_UART9 | RCC_PERIPHCLK_USART10 |                      \
          RCC_PERIPHCLK_USART11 | RCC_PERIPHCLK_UART12 | RCC_PERIPHCLK_LPUART1 |                   \
          RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_I2C4 |      \
          RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |   \
          RCC_PERIPHCLK_LPTIM3 | RCC_PERIPHCLK_LPTIM4 | RCC_PERIPHCLK_LPTIM5 |                     \
          RCC_PERIPHCLK_LPTIM6 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_ADCDAC |  \
          RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_SDMMC1 |    \
          RCC_PERIPHCLK_SDMMC2 | RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 |    \
          RCC_PERIPHCLK_SPI4 | RCC_PERIPHCLK_SPI5 | RCC_PERIPHCLK_SPI6 | RCC_PERIPHCLK_OSPI |      \
          RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_CKPER )
#elif defined( UART7 )
#define RCC_PERIPHCLOCK_ALL                                                                        \
        ( RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |                     \
          RCC_PERIPHCLK_UART4 | RCC_PERIPHCLK_UART5 | RCC_PERIPHCLK_USART6 | RCC_PERIPHCLK_UART7 | \
          ...
          RCC_PERIPHCLK_SPI5 | RCC_PERIPHCLK_SPI6 | RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_FDCAN |     \
...
#define RCC_PERIPHCLOCK_ALL                                                                        \
        ( RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |                     \
          ...
          RCC_PERIPHCLK_I3C1 | RCC_PERIPHCLK_I3C2 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 |     \
          RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RNG | \
          RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 |     \
          RCC_PERIPHCLK_SPI3 | RCC_PERIPHCLK_SPI4 | RCC_PERIPHCLK_OSPI | RCC_PERIPHCLK_FDCAN |     \
          RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_CKPER )
#else
#define RCC_PERIPHCLOCK_ALL                                                                      \
        ( RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |                   \
          RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I3C1 | \
          RCC_PERIPHCLK_I3C2 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | \
          RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_RTC |  \
          RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 | RCC_PERIPHCLK_FDCAN |   \
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig( RCC_PeriphCLKInitTypeDef const* pPeriphClkInit );
