...
typedef struct
{
        uint32_t psc_ucpdclk; /*!< Specify the prescaler for the UCPD clock.
                                   ...
                                   This feature can be modified afterwards using function @ref
                                 LL_UCPD_SetPSCClk().
                              */

        uint32_t transwin; /*!< Specify the number of cycles (minus 1) of the half bit clock (see
                              HBITCLKDIV) to achieve a legal tTransitionWindow (set according to
                              peripheral clock to define an interval of between 12 and 20 us). This
                              parameter can be a value between Min_Data=0x1 and Max_Data=0x1F This
                              value can be modified afterwards using function @ref
                              LL_UCPD_SetTransWin().
                           */

        uint32_t IfrGap; /*!< Specify the definition of the clock divider (minus 1) in order to
                            generate tInterframeGap from the peripheral clock. This parameter can be
                            a value between Min_Data=0x1 and Max_Data=0x1F This feature can be
                            modified afterwards using function @ref LL_UCPD_SetIfrGap().
                         */

        uint32_t HbitClockDiv; /*!< Specify the number of cycles (minus one) at UCPD peripheral for
                                  a half bit clock e.g. program 3 for a bit clock that takes 8
                                  cycles of the peripheral clock : "UCPD1_CLK". This parameter can
                                  be a value between Min_Data=0x0 and Max_Data=0x3F. This feature
                                  can be modified using function @ref LL_UCPD_SetHbitClockDiv().
                               */
...
#define LL_UCPD_IMR_RXORDDET \
        UCPD_IMR_RXORDDETIE /*!< Enable Rx ordered set (4 K-codes) detected interrupt */
...
#define LL_UCPD_SNK_CC1_VRP30A                                                                   \
        ( UCPD_SR_TYPEC_VSTATE_CC1_0 | UCPD_SR_TYPEC_VSTATE_CC1_1 ) /*!< CC1 Sink vRP 3.0A state \
                                                                     */
...
#define LL_UCPD_SNK_CC2_VRP30A                                                                   \
        ( UCPD_SR_TYPEC_VSTATE_CC2_0 | UCPD_SR_TYPEC_VSTATE_CC2_1 ) /*!< CC2 Sink vRP 3.0A state \
                                                                     */
...
#define LL_UCPD_PSC_DIV8                                                                          \
        ( UCPD_CFG1_PSC_UCPDCLK_1 | UCPD_CFG1_PSC_UCPDCLK_0 ) /*!< Pre-scale clock by dividing by \
                                                                 8  */
...
#define LL_UCPD_CCENABLE_CC1CC2                                                             \
        ( UCPD_CR_CCENABLE_0 | UCPD_CR_CCENABLE_1 ) /*!< Controls apply to both CC1 and CC2 \
                                                       (normal usage for sink/source) */
/**
 * @}
 */
...
#define LL_UCPD_TXMODE_BIST_CARRIER2 \
        UCPD_CR_TXMODE_1 /*!< Trigger a BIST test sequence send (BIST Carrier Mode 2)  */
/**
 * @}
 */
...
#define LL_UCPD_RXORDSET_SOP1_DEBUG                                                                \
        ( UCPD_RX_ORDSET_RXORDSET_0 | UCPD_RX_ORDSET_RXORDSET_1 ) /*!< SOP' Debug code detected in \
                                                                     receiver       */
...
#define LL_UCPD_RXORDSET_CABLE_RESET                                                             \
        ( UCPD_RX_ORDSET_RXORDSET_2 | UCPD_RX_ORDSET_RXORDSET_0 ) /*!< Cable Reset code detected \
                                                                     in receiver      */
#define LL_UCPD_RXORDSET_SOPEXT1                                                            \
        ( UCPD_RX_ORDSET_RXORDSET_2 | UCPD_RX_ORDSET_RXORDSET_1 ) /*!< SOP extension#1 code \
...
{
        return (
            ( READ_BIT( UCPDx->CFG1, UCPD_CFG1_UCPDEN ) == ( UCPD_CFG1_UCPDEN ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_TYPECEVT2IE ) == UCPD_IMR_TYPECEVT2IE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_TYPECEVT1IE ) == UCPD_IMR_TYPECEVT1IE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_RXMSGENDIE ) == UCPD_IMR_RXMSGENDIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_RXHRSTDETIE ) == UCPD_IMR_RXHRSTDETIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_RXORDDETIE ) == UCPD_IMR_RXORDDETIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_HRSTSENTIE ) == UCPD_IMR_HRSTSENTIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_HRSTDISCIE ) == UCPD_IMR_HRSTDISCIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_TXMSGABTIE ) == UCPD_IMR_TXMSGABTIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_TXMSGSENTIE ) == UCPD_IMR_TXMSGSENTIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->IMR, UCPD_IMR_TXMSGDISCIE ) == UCPD_IMR_TXMSGDISCIE ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->CFG1, UCPD_CFG1_TXDMAEN ) == ( UCPD_CFG1_TXDMAEN ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( UCPDx->CFG1, UCPD_CFG1_RXDMAEN ) == ( UCPD_CFG1_RXDMAEN ) ) ? 1UL : 0UL );
}
...
ErrorStatus LL_UCPD_Init( UCPD_TypeDef* UCPDx, LL_UCPD_InitTypeDef const* UCPD_InitStruct );
