...
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
{
...
#if ( USE_HAL_DCMI_REGISTER_CALLBACKS == 1 )
        void ( *FrameEventCallback )( struct __DCMI_HandleTypeDef* hdcmi ); /*!< DCMI Frame Event
                                                                               Callback */
        void ( *VsyncEventCallback )( struct __DCMI_HandleTypeDef* hdcmi ); /*!< DCMI Vsync Event
                                                                               Callback */
        void ( *LineEventCallback )( struct __DCMI_HandleTypeDef* hdcmi );  /*!< DCMI Line Event
                                                                               Callback  */
        ...
        void ( *MspInitCallback )( struct __DCMI_HandleTypeDef* hdcmi ); /*!< DCMI Msp Init callback
                                                                          */
        void ( *MspDeInitCallback )( struct __DCMI_HandleTypeDef* hdcmi ); /*!< DCMI Msp DeInit
                                                                              callback  */
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
} DCMI_HandleTypeDef;
 ...
 */
typedef void ( *pDCMI_CallbackTypeDef )( DCMI_HandleTypeDef* hdcmi ); /*!< pointer to a DCMI
                                                                         callback function */
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
...
#define DCMI_FLAG_FRAMEMI                                                                          \
        ( (uint32_t) DCMI_MIS_INDEX | DCMI_MIS_FRAME_MIS ) /*!< DCMI Frame capture complete masked \
                  interrupt status */
...
#define DCMI_FLAG_ERRMI                                                                         \
        ( (uint32_t) DCMI_MIS_INDEX | DCMI_MIS_ERR_MIS ) /*!< DCMI Synchronization error masked \
                                                            interrupt status  */
...
#define DCMI_BSM_ALTERNATE_2                                                                      \
        ( (uint32_t) ( DCMI_CR_BSM_0 | DCMI_CR_BSM_1 ) ) /*!< Interface captures two bytes out of \
                                                            four */
...
#define DCMI_OEBS_EVEN                                                       \
        ( (uint32_t) DCMI_CR_OEBS ) /*!< Interface captures second data from \
...
#if ( USE_HAL_DCMI_REGISTER_CALLBACKS == 1 )
HAL_StatusTypeDef HAL_DCMI_RegisterCallback(
    DCMI_HandleTypeDef*        hdcmi,
    HAL_DCMI_CallbackIDTypeDef CallbackID,
    pDCMI_CallbackTypeDef      pCallback );
HAL_StatusTypeDef
HAL_DCMI_UnRegisterCallback( DCMI_HandleTypeDef* hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID );
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
/**
 * @}
 */
...
HAL_StatusTypeDef
HAL_DCMI_ConfigSyncUnmask( DCMI_HandleTypeDef* hdcmi, DCMI_SyncUnmaskTypeDef* SyncUnmask );
...
HAL_DCMI_StateTypeDef HAL_DCMI_GetState( DCMI_HandleTypeDef const* hdcmi );
uint32_t              HAL_DCMI_GetError( DCMI_HandleTypeDef const* hdcmi );
/**
 * @}
 */
