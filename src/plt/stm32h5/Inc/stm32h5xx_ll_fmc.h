...
#define IS_FMC_WRITE_FIFO( __FIFO__ ) \
        ( ( ( __FIFO__ ) == FMC_WRITE_FIFO_DISABLE ) || ( ( __FIFO__ ) == FMC_WRITE_FIFO_ENABLE ) )
...
#define IS_FMC_ECC_STATE( __STATE__ ) \
        ( ( ( __STATE__ ) == FMC_NAND_ECC_DISABLE ) || ( ( __STATE__ ) == FMC_NAND_ECC_ENABLE ) )
...
typedef struct
{
        ...
        uint32_t TARSetupTime; /*!< Defines the number of HCLK cycles to configure the
                                    ...
                                    This parameter can be a number between Min_Data = 0 and Max_Data
                                  = 255 */
...
typedef struct
{
        ...
        uint32_t WaitSetupTime; /*!< Defines the minimum number of HCLK cycles to assert the
                                     ...
                                     This parameter can be a number between Min_Data = 0 and
                                   Max_Data = 254   */
...
typedef struct
{
        ...
        uint32_t AutoRefreshNumber; /*!< Defines the number of consecutive auto refresh command
                                       issued in auto refresh mode. This parameter can be a value
