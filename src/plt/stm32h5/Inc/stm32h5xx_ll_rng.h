...
#define LL_RNG_ARDIS_DISABLE                                              \
        RNG_CR_ARDIS /*!< ARDIS disabled no automatic reset to clear SECS \
                        bit*/
/**
 * @}
 */
...
#define LL_RNG_CLKDIV_BY_8 \
        ( RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0 ) /*!< 8 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_16 \
        ( RNG_CR_CLKDIV_2 ) /*!< 16 RNG clock cycles per internal RNG clock    */
#define LL_RNG_CLKDIV_BY_32 \
        ( RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_0 ) /*!< 32 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_64 \
        ( RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1 ) /*!< 64 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_128                                                                  \
        ( RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0 ) /*!< 128 RNG clock cycles per \
                                                                   internal RNG clock   */
#define LL_RNG_CLKDIV_BY_256 \
        ( RNG_CR_CLKDIV_3 ) /*!< 256 RNG clock cycles per internal RNG clock   */
#define LL_RNG_CLKDIV_BY_512 \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_0 ) /*!< 512 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_1024 \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_1 ) /*!< 1024 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_2048                                                                  \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0 ) /*!< 2048 RNG clock cycles per \
                                                                   internal RNG clock  */
#define LL_RNG_CLKDIV_BY_4096 \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 ) /*!< 4096 RNG clock cycles per internal RNG clock */
#define LL_RNG_CLKDIV_BY_8192                                                                  \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_0 ) /*!< 8192 RNG clock cycles per \
                                                                   internal RNG clock  */
#define LL_RNG_CLKDIV_BY_16384                                                                  \
        ( RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1 ) /*!< 16384 RNG clock cycles per \
                                                                   internal RNG clock */
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabled( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledClkErrorDetect( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledCondReset( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsConfigLocked( RNG_TypeDef const* RNGx )
{
...
{
        MODIFY_REG(
            RNGx->CR, RNG_CR_NISTC | RNG_CR_CONDRST, LL_RNG_NIST_COMPLIANT | RNG_CR_CONDRST );
        CLEAR_BIT( RNGx->CR, RNG_CR_CONDRST );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledNistCompliance( RNG_TypeDef const* RNGx )
{
...
__STATIC_INLINE void LL_RNG_SetConfig1( RNG_TypeDef* RNGx, uint32_t Config1 )
{
        MODIFY_REG(
            RNGx->CR,
            RNG_CR_RNG_CONFIG1 | RNG_CR_CONDRST,
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_GetConfig1( RNG_TypeDef const* RNGx )
{
...
__STATIC_INLINE void LL_RNG_SetConfig2( RNG_TypeDef* RNGx, uint32_t Config2 )
{
        MODIFY_REG(
            RNGx->CR,
            RNG_CR_RNG_CONFIG2 | RNG_CR_CONDRST,
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_GetConfig2( RNG_TypeDef const* RNGx )
{
...
__STATIC_INLINE void LL_RNG_SetConfig3( RNG_TypeDef* RNGx, uint32_t Config3 )
{
        MODIFY_REG(
            RNGx->CR,
            RNG_CR_RNG_CONFIG3 | RNG_CR_CONDRST,
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_GetConfig3( RNG_TypeDef const* RNGx )
{
 ...
 *         @arg @ref LL_RNG_CLKDIV_BY_32768
 */
__STATIC_INLINE uint32_t LL_RNG_GetClockDivider( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_DRDY( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_CECS( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_SECS( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_CEIS( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_SEIS( RNG_TypeDef const* RNGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledIT( RNG_TypeDef const* RNGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_ReadRandData32( RNG_TypeDef const* RNGx )
{
...
{
        MODIFY_REG(
            RNGx->CR, RNG_CR_ARDIS | RNG_CR_CONDRST, LL_RNG_ARDIS_DISABLE | RNG_CR_CONDRST );
        CLEAR_BIT( RNGx->CR, RNG_CR_CONDRST );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledArdis( RNG_TypeDef const* RNGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_GetHealthConfig( RNG_TypeDef const* RNGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_RNG_GetNoiseConfig( RNG_TypeDef const* RNGx )
{
 ...
 * @{
 */
ErrorStatus LL_RNG_Init( RNG_TypeDef* RNGx, LL_RNG_InitTypeDef const* RNG_InitStruct );
void        LL_RNG_StructInit( LL_RNG_InitTypeDef* RNG_InitStruct );
ErrorStatus LL_RNG_DeInit( RNG_TypeDef const* RNGx );
