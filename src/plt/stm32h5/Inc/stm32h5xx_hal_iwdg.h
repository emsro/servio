...
typedef struct
{
        ...
        uint32_t EWI; /*!< Specifies if IWDG Early Wakeup Interrupt is enable or not and the
                         comparator value. This parameter must be a number between Min_Data = 0 and
                         Max_Data = 0x0FFF value 0 means that EWI is disabled */
} IWDG_InitTypeDef;
...
#if ( USE_HAL_IWDG_REGISTER_CALLBACKS == 1 )
        void ( *EwiCallback )( struct __IWDG_HandleTypeDef* hiwdg );     /*!< IWDG Early WakeUp
                                                                            Interrupt callback */
 ...
 */
typedef void ( *pIWDG_CallbackTypeDef )( IWDG_HandleTypeDef* hppp ); /*!< pointer to a IWDG common
                                                                        callback functions */
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
...
#if ( USE_HAL_IWDG_REGISTER_CALLBACKS == 1 )
HAL_StatusTypeDef HAL_IWDG_RegisterCallback(
    IWDG_HandleTypeDef*        hiwdg,
    HAL_IWDG_CallbackIDTypeDef CallbackID,
    pIWDG_CallbackTypeDef      pCallback );
HAL_StatusTypeDef
HAL_IWDG_UnRegisterCallback( IWDG_HandleTypeDef* hiwdg, HAL_IWDG_CallbackIDTypeDef CallbackID );
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
/**
 * @}
 */
...
uint32_t          HAL_IWDG_GetActiveStatus( IWDG_HandleTypeDef const* hiwdg );
