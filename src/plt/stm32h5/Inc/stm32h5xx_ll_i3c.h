...
/* Exported types ------------------------------------------------------------*/
/** @defgroup I3C_LL_ES_CONTROLLER_BUS_CONFIG_STRUCTURE_DEFINITION I3C Controller Bus Configuration
...
typedef struct
{
        ...
        uint32_t WaitTime; /*!< Specifies the time that the main and the new controllers should wait
                              before issuing a start. This parameter must be a value of @ref
                              I3C_LL_EC_OWN_ACTIVITY_STATE              */

        uint8_t SCLPPLowDuration; /*!< Specifies the I3C SCL low duration in number of kernel clock
                                     cycles in I3C push-pull phases. This parameter must be a number
                                     between Min_Data=0 and Max_Data=0xFF.            */

        uint8_t SCLI3CHighDuration; /*!< Specifies the I3C SCL high duration in number of kernel
                                       clock cycles, used for I3C messages for I3C open-drain and
                                       push pull phases. This parameter must be a number between
                                       Min_Data=0 and Max_Data=0xFF.            */

        uint8_t SCLODLowDuration; /*!< Specifies the I3C SCL low duration in number of kernel clock
                                     cycles in open-drain phases, used for legacy I2C commands and
                                     for I3C open-drain phases. This parameter must be a number
                                     between Min_Data=0 and Max_Data=0xFF.            */

        uint8_t SCLI2CHighDuration; /*!< Specifies the I3C SCL high duration in number of kernel
                                       clock cycles, used for legacy I2C commands. This parameter
                                       must be a number between Min_Data=0 and Max_Data=0xFF. */

        uint8_t BusFreeDuration; /*!< Specifies the I3C controller duration in number of kernel
                                    clock cycles, after a stop and before a start. This parameter
                                    must be a number between Min_Data=0 and Max_Data=0xFF. */

        uint8_t BusIdleDuration; /*!< Specifies the I3C controller duration in number of kernel
                                    clock cycles to be elapsed, after that both SDA and SCL are
                                    continuously high and stable before issuing a hot-join event.
...
/** @defgroup I3C_LL_ES_TARGET_BUS_CONFIG_STRUCTURE_DEFINITION I3C Target Bus Configuration
 * Structure definition
...
typedef struct
{
        uint8_t BusAvailableDuration; /*!< Specifies the I3C target duration in number of kernel
                                         clock cycles, when the SDA and the SCL are high for at
                                         least taval. This parameter must be a number between
                                         Min_Data=0 and Max_Data=0xFF.            */
...
typedef struct
{
        LL_I3C_CtrlBusConfTypeDef CtrlBusCharacteristic; /*!< Specifies the I3C controller bus
                                                            characteristic configuration when
                                                            Controller mode */

        LL_I3C_TgtBusConfTypeDef TgtBusCharacteristic; /*!< Specifies the I3C target bus
                                                          characteristic configuration when Target
                                                          mode */
 ...
 * @param  __PAYLOAD__ specifies the Bus Characteristics capabilities retrieve during ENTDAA
 ...
 * @note   Controller mode: before clearing EN, all possible target requests must be disabled using
 * DISEC CCC. Target mode: software is not expected clearing EN unless a partial reset of the IP is
 * needed
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabled( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledReset( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->DEVR0, I3C_DEVR0_RSTVAL ) == ( I3C_DEVR0_RSTVAL ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_I3C_MODE_TARGET
 */
__STATIC_INLINE uint32_t LL_I3C_GetMode( I3C_TypeDef const* I3Cx )
{
...
/**
 * @brief  An arbitration header (7'h7E) is sent after Start in case of legacy I2C or I3C private
 * transfers.
...
/**
 * @brief  Target address is sent directly after a Start in case of legacy I2C or I3C private
 * transfers.
 * @note   This bit can be modified only when there is no frame ongoing
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledArbitrationHeader( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledResetPattern( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledExitPattern( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->CFGR, I3C_CFGR_EXITPTRN ) == ( I3C_CFGR_EXITPTRN ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledHighKeeperSDA( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledHJAck( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_DMA_GetRegAddr( I3C_TypeDef const* I3Cx, uint32_t Direction )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledDMAReq_RX( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_RXFIFO_THRESHOLD_4_4
 */
__STATIC_INLINE uint32_t LL_I3C_GetRxFIFOThreshold( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledDMAReq_TX( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_GetTxFIFOThreshold( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledDMAReq_Status( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledStatusFIFO( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledControlFIFO( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledDMAReq_Control( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledOwnDynAddress( I3C_TypeDef const* I3Cx )
{
 ...
 * @note   This bit can be programmed in controller mode or during Dynamic Address procedure from
 * current controller.
 ...
 */
__STATIC_INLINE uint8_t LL_I3C_GetOwnDynamicAddress( I3C_TypeDef const* I3Cx )
{
 ...
 * @note   This bit can be programmed when the I3C is disabled (EN = 0) or updated by HW upon
 * reception of DISEC CCC.
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIBI( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledControllerRoleReq( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledHotJoin( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetMaxReadLength( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_PAYLOAD_4_BYTES
 */
__STATIC_INLINE uint32_t LL_I3C_GetConfigNbIBIAddData( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0x0 and Max_Data=0xFFFFF
 */
__STATIC_INLINE uint32_t LL_I3C_GetMaxWriteLength( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetClockWaveForm( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetPeriodClockLowPP( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetPeriodClockHighI3C( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetPeriodClockLowOD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetPeriodClockHighI2C( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_SDA_HOLD_TIME_1_5
 */
__STATIC_INLINE uint32_t LL_I3C_GetDataHoldTime( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetAvalTiming( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetFreeTiming( I3C_TypeDef const* I3Cx )
{
...
LL_I3C_SetControllerActivityState( I3C_TypeDef* I3Cx, uint32_t ControllerActivityState )
{
 ...
 *         @arg @ref LL_I3C_OWN_ACTIVITY_STATE_3
 */
__STATIC_INLINE uint32_t LL_I3C_GetControllerActivityState( I3C_TypeDef const* I3Cx )
{
 ...
 * @param  I3Cx I3C Instance.
 * @param  CtrlBusCharacteristic This parameter must be a value between Min_Data=0 and
 * Max_Data=0x107F03FF.
 * @retval None
 */
__STATIC_INLINE void
LL_I3C_SetCtrlBusCharacteristic( I3C_TypeDef* I3Cx, uint32_t CtrlBusCharacteristic )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetCtrlBusCharacteristic( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetTgtBusCharacteristic( I3C_TypeDef* I3Cx, uint32_t TgtBusCharacteristic )
{
        MODIFY_REG(
            I3Cx->TIMINGR1, I3C_TIMINGR1_AVAL, ( TgtBusCharacteristic & I3C_TIMINGR1_AVAL ) );
}
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetTgtBusCharacteristic( I3C_TypeDef const* I3Cx )
{
        return (uint32_t) ( READ_BIT( I3Cx->TIMINGR1, I3C_TIMINGR1_AVAL ) );
}
...
{
        MODIFY_REG(
            I3Cx->TIMINGR2, I3C_TIMINGR2_STALL, ( ControllerStallTime << I3C_TIMINGR2_STALL_Pos ) );
}
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetStallTime( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledStallACK( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->TIMINGR2, I3C_TIMINGR2_STALLA ) == ( I3C_TIMINGR2_STALLA ) ) ? 1UL :
                                                                                             0UL );
}
...
/**
 * @brief  Check if stall on Parity bit of Command Code byte is enabled or disabled (controller
 * mode).
 * @rmtoll TIMINGR2     STALLC       LL_I3C_IsEnabledStallParityCCC
 * @param  I3Cx I3C Instance.
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledStallParityCCC( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->TIMINGR2, I3C_TIMINGR2_STALLC ) == ( I3C_TIMINGR2_STALLC ) ) ? 1UL :
                                                                                             0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledStallParityData( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->TIMINGR2, I3C_TIMINGR2_STALLD ) == ( I3C_TIMINGR2_STALLD ) ) ? 1UL :
                                                                                             0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledStallTbit( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->TIMINGR2, I3C_TIMINGR2_STALLT ) == ( I3C_TIMINGR2_STALLT ) ) ? 1UL :
                                                                                             0UL );
}

/**
 * @brief  Configure the Device Capability on Bus as Target or Controller (MIPI Bus Characteristics
 * Register BCR6).
 ...
 */
__STATIC_INLINE void
LL_I3C_SetDeviceCapabilityOnBus( I3C_TypeDef* I3Cx, uint32_t DeviceCapabilityOnBus )
{
        MODIFY_REG( I3Cx->BCR, I3C_BCR_BCR6, DeviceCapabilityOnBus );
}

/**
 * @brief  Get the Device Capability on Bus as Target or Controller (MIPI Bus Characteristics
 * Register BCR6).
 ...
 *         @arg @ref LL_I3C_DEVICE_ROLE_AS_CONTROLLER
 */
__STATIC_INLINE uint32_t LL_I3C_GetDeviceCapabilityOnBus( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_IBI_ADDITIONAL_DATA
 */
__STATIC_INLINE uint32_t LL_I3C_GetDeviceIBIPayload( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_MAX_DATA_SPEED_LIMITATION
 */
__STATIC_INLINE uint32_t LL_I3C_GetDataSpeedLimitation( I3C_TypeDef const* I3Cx )
{
 ...
 * @param  I3Cx I3C Instance.
 * @param  DeviceCharacteristics This parameter must be a value between Min_Data=0 and
 * Max_Data=0xFF.
 * @retval None
 */
__STATIC_INLINE void
LL_I3C_SetDeviceCharacteristics( I3C_TypeDef* I3Cx, uint32_t DeviceCharacteristics )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetDeviceCharacteristics( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_MDB_PENDING_READ_NOTIFICATION
 */
__STATIC_INLINE uint32_t LL_I3C_GetPendingReadMDB( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetGrpAddrHandoffSupport( I3C_TypeDef* I3Cx, uint32_t GrpAddrHandoffSupport )
{
 ...
 *         @arg @ref LL_I3C_HANDOFF_GRP_ADDR_SUPPORTED
 */
__STATIC_INLINE uint32_t LL_I3C_GetGrpAddrHandoffSupport( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetControllerHandoffDelayed( I3C_TypeDef* I3Cx, uint32_t ControllerHandoffDelayed )
{
 ...
 *         @arg @ref LL_I3C_HANDOFF_DELAYED
 */
__STATIC_INLINE uint32_t LL_I3C_GetControllerHandoffDelayed( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetHandoffActivityState( I3C_TypeDef* I3Cx, uint32_t HandoffActivityState )
{
 ...
 *         @arg @ref LL_I3C_HANDOFF_ACTIVITY_STATE_3
 */
__STATIC_INLINE uint32_t LL_I3C_GetHandoffActivityState( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_GETMXDS_FORMAT_2_MSB
 */
__STATIC_INLINE uint32_t LL_I3C_GetMaxDataSpeedFormat( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetMiddleByteTurnAround( I3C_TypeDef* I3Cx, uint32_t MiddleByteTurnAround )
{
        MODIFY_REG(
            I3Cx->GETMXDSR,
            I3C_GETMXDSR_RDTURN,
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetMiddleByteTurnAround( I3C_TypeDef const* I3Cx )
{
 ...
 *         @arg @ref LL_I3C_TURNAROUND_TIME_TSCO_GREATER_12NS
 */
__STATIC_INLINE uint32_t LL_I3C_GetDataTurnAroundTime( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0xF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetMIPIInstanceID( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetIDTypeSelector( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetMIPIManufacturerID( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetActivityState( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetResetAction( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I3C_ControllerHandleMessage(
    I3C_TypeDef* I3Cx,
    uint32_t     TargetAddr,
    ...
    uint32_t     EndMode )
{
        WRITE_REG(
            I3Cx->CR,
            ( ( TargetAddr << I3C_CR_ADD_Pos ) | TransferSize | Direction | MessageType |
              EndMode ) &
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I3C_ControllerHandleCCC(
    I3C_TypeDef* I3Cx,
    uint32_t     CCCValue,
 ...
 */
__STATIC_INLINE void
LL_I3C_TargetHandleMessage( I3C_TypeDef* I3Cx, uint32_t MessageType, uint32_t IBISize )
{
 ...
 */
__STATIC_INLINE uint8_t LL_I3C_ReceiveData8( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_ReceiveData32( I3C_TypeDef const* I3Cx )
{
...
/**
 * @brief  Get the own IBI data payload (target mode), or get the Target IBI received (controller
 * mode).
 * @note   Content of register is filled in Little Endian.
 *         Mean MSB correspond to last IBI data byte,
 *         LSB correspond to first IBI data byte.
 ...
 * @retval Value between Min_Data=0 to Max_Data=0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_I3C_GetIBIPayload( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetNbIBIAddData( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetIBITargetAddr( I3C_TypeDef const* I3Cx )
{
 ...
 * @note   Set high by Software, cleared by hardware when all the bytes to transmit have been loaded
 * to TX FIFO.
...
__STATIC_INLINE void LL_I3C_ConfigTxPreload( I3C_TypeDef* I3Cx, uint16_t TxDataCount )
{
        MODIFY_REG(
            I3Cx->TGTTDR,
            ( I3C_TGTTDR_PRELOAD | I3C_TGTTDR_TGTTDCNT ),
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveTxPreload( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->TGTTDR, I3C_TGTTDR_PRELOAD ) == ( I3C_TGTTDR_PRELOAD ) ) ? 1UL :
                                                                                         0UL );
}
 ...
 */
__STATIC_INLINE uint16_t LL_I3C_GetTxPreloadDataCount( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 to Max_Data=0xFFFF
 */
__STATIC_INLINE uint32_t LL_I3C_GetXferDataCount( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsTargetAbortPrivateRead( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetMessageDirection( I3C_TypeDef const* I3Cx )
{
 ...
 * @param  I3Cx I3C Instance.
 * @retval Value between Min_Data=0 to Max_Data=0xFF, representing the internal hardware counter
 * value.
 */
__STATIC_INLINE uint32_t LL_I3C_GetMessageIdentifier( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_I3C_GetMessageErrorCode( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval Value between Min_Data=0 to Max_Data=0xFF.
 */
__STATIC_INLINE uint32_t LL_I3C_GetReceiveCommandCode( I3C_TypeDef const* I3Cx )
{
 ...
 */
__STATIC_INLINE void
LL_I3C_SetTargetDynamicAddress( I3C_TypeDef* I3Cx, uint32_t TargetId, uint32_t DynamicAddr )
{
...
LL_I3C_GetTargetDynamicAddress( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
...
/**
 * @brief  Indicates if IBI from target x will be Acknowledged or Not Acknowledged (controller
 * mode). RESET: IBI Not Acknowledged. SET: IBI Acknowledged.
 * @rmtoll DEVRX        IBIACK        LL_I3C_IsEnabledTargetIBIAck
 * @param  I3Cx I3C Instance.
 * @param  TargetId This parameter must be a value between Min_Data=1 and Max_Data=4
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledTargetIBIAck( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
        return (
            ( READ_BIT( I3Cx->DEVRX[TargetId - 1U], I3C_DEVRX_IBIACK ) == I3C_DEVRX_IBIACK ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledTargetCRAck( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
        return (
            ( READ_BIT( I3Cx->DEVRX[TargetId - 1U], I3C_DEVRX_CRACK ) == I3C_DEVRX_CRACK ) ? 1UL :
                                                                                             0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIBIAddData( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
        return (
            ( READ_BIT( I3Cx->DEVRX[TargetId - 1U], I3C_DEVRX_IBIDEN ) == I3C_DEVRX_IBIDEN ) ?
                1UL :
                0UL );
}
 ...
 * @note   When set, this feature will allow controller to continue CR FIFO treatment after IBI
 * treatment.
...
/**
 * @brief  Indicates if I3C transfer must be Suspended or not Suspended during IBI treatment from
 * target x. RESET: Transfer is not suspended. Instruction in CR FIFO are executed after IBI. SET:
 * Transfer is suspended (a Stop condition is sent). CR FIFO is flushed.
 * @rmtoll DEVRX        SUSP          LL_I3C_IsFrameMustBeSuspended
 * @param  I3Cx I3C Instance.
 * @param  TargetId This parameter must be a value between Min_Data=1 and Max_Data=4
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsFrameMustBeSuspended( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
        return (
            ( READ_BIT( I3Cx->DEVRX[TargetId - 1U], I3C_DEVRX_SUSP ) == I3C_DEVRX_SUSP ) ? 1UL :
                                                                                           0UL );
}
 ...
 * @note   Used to prevent software writing during reception of an IBI or Controller-role Request
 * from target x.
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsAllowedPayloadUpdate( I3C_TypeDef const* I3Cx, uint32_t TargetId )
{
        return (
            ( READ_BIT( I3Cx->DEVRX[TargetId - 1U], I3C_DEVRX_DIS ) != I3C_DEVRX_DIS ) ? 1UL :
                                                                                         0UL );
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I3C_ConfigDeviceCapabilities(
    I3C_TypeDef* I3Cx,
    uint32_t     TargetId,
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_CFE( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_TXFE( I3C_TypeDef const* I3Cx )
{
 ...
 * @note   When a transfer is ongoing, the Control FIFO shall not be written unless this flag is
 * set.
 * @rmtoll EVR          CFNFF         LL_I3C_IsActiveFlag_CFNF
 * @param  I3Cx I3C Instance.
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_CFNF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_SFNE( I3C_TypeDef const* I3Cx )
{
 ...
 * @note   When a transfer is ongoing, the Transmit FIFO shall not be written unless this flag is
 * set.
 * @rmtoll EVR          TXFNFF        LL_I3C_IsActiveFlag_TXFNF
 * @param  I3Cx I3C Instance.
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_TXFNF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_RXFNE( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_RXLAST( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_TXLAST( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_FC( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_RXTGTEND( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->EVR, I3C_EVR_RXTGTENDF ) == ( I3C_EVR_RXTGTENDF ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_ERR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_IBI( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_IBIEND( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_CR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_CRUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_HJ( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_WKP( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_GET( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_STA( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_DAUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_MWLUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_MRLUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_RST( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_ASUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_INTUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_DEF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_GRP( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_PERR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_STALL( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_DOVR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_COVR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_ANACK( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_DNACK( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsActiveFlag_DERR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_CFNF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_SFNE( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_TXFNF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_RXFNE( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_FC( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_RXTGTEND( I3C_TypeDef const* I3Cx )
{
        return (
            ( READ_BIT( I3Cx->IER, I3C_IER_RXTGTENDIE ) == ( I3C_IER_RXTGTENDIE ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_ERR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_IBI( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_IBIEND( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_CR( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_CRUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_HJ( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_WKP( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_GET( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_STA( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_DAUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_MWLUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_MRLUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_RST( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_ASUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_INTUPD( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_DEF( I3C_TypeDef const* I3Cx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_I3C_IsEnabledIT_GRP( I3C_TypeDef const* I3Cx )
{
...
ErrorStatus LL_I3C_DeInit( I3C_TypeDef const* I3Cx );
