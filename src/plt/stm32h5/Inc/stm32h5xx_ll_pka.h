 ...
 */
__STATIC_INLINE uint32_t LL_PKA_IsEnabled( PKA_TypeDef const* PKAx )
{
 ...
 *         @arg @ref LL_PKA_MODE_MODULAR_EXP_FAST
 */
__STATIC_INLINE uint32_t LL_PKA_GetMode( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsEnabledIT_ADDRERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsEnabledIT_RAMERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsEnabledIT_OPERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsEnabledIT_PROCEND( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsActiveFlag_ADDRERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsActiveFlag_RAMERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsActiveFlag_OPERR( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsActiveFlag_PROCEND( PKA_TypeDef const* PKAx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_PKA_IsActiveFlag_BUSY( PKA_TypeDef const* PKAx )
{
...
ErrorStatus LL_PKA_DeInit( PKA_TypeDef const* PKAx );
