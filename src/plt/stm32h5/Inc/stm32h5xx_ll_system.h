...
#define LL_SBS_VDDIO_REGISTER_CODE                                                      \
        SBS_CCCSR_CS2 /*!< VDDIO I/Os code from the SBS compensation cell code register \
                         (SBS_CCSWCR)*/
/**
 * @}
 */
...
#define LL_SBS_ETH_RMII \
        SBS_PMCR_ETH_SEL_PHY_2 /*!< Select the Reduced Media Independent Interface (RMII) */
...
#define LL_SBS_MEMORIES_ERASE_MCLR_ON_GOING                                                    \
        0x0UL /*!< Erase after Power-on Reset of SRAM2, BKPRAM, ICACHE, DCACHE and PKA RAMs on \
                 going or cleared by SW */
#define LL_SBS_MEMORIES_ERASE_MCLR_ENDED                                                       \
        SBS_MESR_MCLR /*!< Erase after Power-on Reset of SRAM2, BKPRAM, ICACHE, DCACHE and PKA \
                         RAMs done */
#define LL_SBS_MEMORIES_ERASE_IPMEE_ON_GOING                                                       \
        0x0UL /*!< Erase after Power-on Reset or Tamper detection for ICACHE and PKA RAMs on going \
                 or cleared by SW */
#define LL_SBS_MEMORIES_ERASE_IPMEE_ENDED                                                          \
        SBS_MESR_IPMEE /*!< Erase after Power-on Reset or Tamper detection for ICACHE and PKA RAMs \
                          done */
/**
 * @}
 */
...
#define LL_SBS_OBKHDPL_INCR_0                                                                     \
        0x00000000U /*!< Index to add to the current HDPL to point (through OBK-HDPL) to the next \
                       secure storage areas */
#define LL_SBS_OBKHDPL_INCR_1                                                             \
        SBS_NEXTHDPLCR_NEXTHDPL_0 /*!< Index to add to the current HDPL to point (through \
                                     OBK-HDPL) to the next secure storage areas */
#define LL_SBS_OBKHDPL_INCR_2                                                             \
        SBS_NEXTHDPLCR_NEXTHDPL_1 /*!< Index to add to the current HDPL to point (through \
                                     OBK-HDPL) to the next secure storage areas */
#define LL_SBS_OBKHDPL_INCR_3                                                                     \
        SBS_NEXTHDPLCR_NEXTHDPL /*!< Index to add to the current HDPL to point (through OBK-HDPL) \
                                   to the next secure storage areas */
/**
 * @}
 */
...
#define LL_SBS_MPU_NSEC \
        SBS_CNSLCKR_LOCKNSMPU /*!< Non-secure MPU lock (privileged secure or non-secure only) */
#define LL_SBS_VTOR_NSEC \
        SBS_CNSLCKR_LOCKNSVTOR /*!< Non-secure VTOR lock (privileged secure or non-secure only) */
#define LL_SBS_LOCK_ALL_NSEC                                                                   \
        ( LL_SBS_MPU_NSEC | LL_SBS_VTOR_NSEC ) /*!< lock all Non-secure  (privileged secure or \
                                                  non-secure only) */
/**
 * @}
 */
...
#define LL_SBS_VTOR_AIRCR_SEC \
        SBS_CSLCKR_LOCKSVTAIRCR /*!< VTOR_S and AIRCR lock (privileged secure code only) */
#define LL_SBS_LOCK_ALL_SEC                                                                      \
        ( LL_SBS_SAU | LL_SBS_MPU_SEC | LL_SBS_VTOR_AIRCR_SEC ) /*!< lock all secure (privileged \
                                                                   secure only)  */
/**
 * @}
 */
...
#define LL_DBGMCU_TRACE_SYNCH_SIZE1                                                            \
        ( DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_0 ) /*!< TRACE pin assignment for        \
                                                             Synchronous Mode with a TRACEDATA \
                                                             size of 1 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE2                                                            \
        ( DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_1 ) /*!< TRACE pin assignment for        \
                                                             Synchronous Mode with a TRACEDATA \
                                                             size of 2 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE4                                                               \
        ( DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE ) /*!< TRACE pin assignment for Synchronous \
                                                           Mode with a TRACEDATA size of 4 */
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP1_TIM12_STOP                                                             \
        DBGMCU_APB1FZR1_DBG_TIM12_STOP /*!< The counter clock of TIM12 is stopped when the core is \
                                          halted*/
#endif                                 /* TIM12 */
#if defined( TIM13 )
#define LL_DBGMCU_APB1_GRP1_TIM13_STOP                                                             \
        DBGMCU_APB1FZR1_DBG_TIM13_STOP /*!< The counter clock of TIM13 is stopped when the core is \
                                          halted*/
#endif                                 /* TIM13 */
#if defined( TIM14 )
#define LL_DBGMCU_APB1_GRP1_TIM14_STOP                                                             \
        DBGMCU_APB1FZR1_DBG_TIM14_STOP /*!< The counter clock of TIM14 is stopped when the core is \
                                          halted*/
#endif                                 /* TIM14 */
...
#define LL_DBGMCU_APB2_GRP1_TIM8_STOP                                                           \
        DBGMCU_APB2FZR_DBG_TIM8_STOP /*!< The counter clock of TIM8 is stopped when the core is \
                                        halted*/
#endif                               /* TIM8 */
#if defined( TIM15 )
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                                            \
        DBGMCU_APB2FZR_DBG_TIM15_STOP /*!< The counter clock of TIM15 is stopped when the core is \
                                         halted*/
#endif                                /* TIM15 */
#if defined( TIM16 )
#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                                            \
        DBGMCU_APB2FZR_DBG_TIM16_STOP /*!< The counter clock of TIM16 is stopped when the core is \
                                         halted*/
#endif                                /* TIM16 */
#if defined( TIM17 )
#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                                            \
        DBGMCU_APB2FZR_DBG_TIM17_STOP /*!< The counter clock of TIM17 is stopped when the core is \
                                         halted*/
#endif                                /* TIM17 */
/**
 * @}
...
#define LL_DBGMCU_APB3_GRP1_I2C3_STOP                                                           \
        DBGMCU_APB3FZR_DBG_I2C3_STOP /*!< The counter clock of I2C3 is stopped when the core is \
                                        halted*/
#endif                               /* I2C3 */
#if defined( I2C4 )
#define LL_DBGMCU_APB3_GRP1_I2C4_STOP                                                           \
        DBGMCU_APB3FZR_DBG_I2C4_STOP /*!< The counter clock of I2C4 is stopped when the core is \
                                        halted*/
#endif                               /* I2C4 */
#if defined( I3C2 )
#define LL_DBGMCU_APB3_GRP1_I3C2_STOP                                                           \
        DBGMCU_APB3FZR_DBG_I3C2_STOP /*!< The counter clock of I3C2 is stopped when the core is \
                                        halted*/
#endif                               /* I3C2 */
#define LL_DBGMCU_APB3_GRP1_LPTIM1_STOP                                                          \
        DBGMCU_APB3FZR_DBG_LPTIM1_STOP /*!< The counter clock of LPTIM1 is stopped when the core \
                                          is halted*/
#if defined( LPTIM3 )
#define LL_DBGMCU_APB3_GRP1_LPTIM3_STOP                                                          \
        DBGMCU_APB3FZR_DBG_LPTIM3_STOP /*!< The counter clock of LPTIM3 is stopped when the core \
                                          is halted*/
#endif                                 /* LPTIM3 */
#if defined( LPTIM4 )
#define LL_DBGMCU_APB3_GRP1_LPTIM4_STOP                                                          \
        DBGMCU_APB3FZR_DBG_LPTIM4_STOP /*!< The counter clock of LPTIM4 is stopped when the core \
                                          is halted*/
#endif                                 /* LPTIM4 */
#if defined( LPTIM5 )
#define LL_DBGMCU_APB3_GRP1_LPTIM5_STOP                                                          \
        DBGMCU_APB3FZR_DBG_LPTIM5_STOP /*!< The counter clock of LPTIM5 is stopped when the core \
                                          is halted*/
#endif                                 /* LPTIM5 */
#if defined( LPTIM6 )
#define LL_DBGMCU_APB3_GRP1_LPTIM6_STOP                                                          \
        DBGMCU_APB3FZR_DBG_LPTIM6_STOP /*!< The counter clock of LPTIM6 is stopped when the core \
                                          is halted*/
#endif                                 /* LPTIM6 */
#define LL_DBGMCU_APB3_GRP1_RTC_STOP                                                          \
        DBGMCU_APB3FZR_DBG_RTC_STOP /*!< The counter clock of RTC is stopped when the core is \
                                       halted*/
/**
 * @}
 */
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_0 ) == SBS_FPUIMR_FPU_IE_0 ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_1 ) == SBS_FPUIMR_FPU_IE_1 ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_2 ) == SBS_FPUIMR_FPU_IE_2 ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_3 ) == SBS_FPUIMR_FPU_IE_3 ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_4 ) == SBS_FPUIMR_FPU_IE_4 ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->FPUIMR, SBS_FPUIMR_FPU_IE_5 ) == SBS_FPUIMR_FPU_IE_5 ) ? 1UL : 0UL );
}
...
{
        MODIFY_REG(
            SBS->CFGR2, SBS_CFGR2_CLL | SBS_CFGR2_SEL | SBS_CFGR2_PVDL | SBS_CFGR2_ECCL, Break );
}
...
__STATIC_INLINE uint32_t LL_SBS_GetTIMBreakInputs( void )
{
        return (uint32_t) ( READ_BIT(
            SBS->CFGR2, SBS_CFGR2_CLL | SBS_CFGR2_SEL | SBS_CFGR2_PVDL | SBS_CFGR2_ECCL ) );
}
...
{
        MODIFY_REG(
            SBS->DBGCR, SBS_DBGCR_DBG_AUTH_SEC, ( Security << SBS_DBGCR_DBG_AUTH_SEC_Pos ) );
}
...
{
        return (
            ( READ_BIT( SBS->DBGCR, SBS_DBGCR_DBG_UNLOCK ) == LL_SBS_DBG_UNLOCK ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( SBS->DBGCR, SBS_DBGCR_AP_UNLOCK ) == LL_SBS_ACCESS_PORT_UNLOCK ) ? 1UL :
                                                                                           0UL );
}
...
{
        return (
            ( READ_BIT( SBS->DBGLOCKR, SBS_DBGLOCKR_DBGCFG_LOCK ) != LL_SBS_DBG_CONFIG_UNLOCK ) ?
                1UL :
                0UL );
}
 ...
 *   @arg LL_SBS_VDD_REGISTER_CODE: Select Code from the SBS compensation cell code register
 * (SBS_CCSWCR)
 * @retval None
 */
 ...
 *   @arg LL_SBS_VDDIO_REGISTER_CODE: Select Code from the SBS compensation cell code register
 * (SBS_CCSWCR)
 * @retval None
 */
 ...
 *   @arg LL_SBS_VDD_REGISTER_CODE: Selected Code is from the SBS compensation cell code register
 * (SBS_CCSWCR)
 */
 ...
 *   @arg LL_SBS_VDDIO_REGISTER_CODE: Selected Code is from the SBS compensation cell code register
 * (SBS_CCSWCR)
 */
...
{
        return (
            ( READ_BIT( DBGMCU->CR, DBGMCU_CR_TRACE_CLKEN ) == DBGMCU_CR_TRACE_CLKEN ) ? 1UL :
                                                                                         0UL );
}
 ...
 * @retval Returned value can be one of the following values:
 *   @arg LL_SBS_MEMORIES_ERASE_IPMEE_ON_GOING : Erase of ICACHE and PKA RAMs on going or flag
 * cleared by SW
...
/**
 * @brief  Clear Status of End of Erase after Power-on Reset for SRAM2, BKPRAM, ICACHE, DCACHE and
 * PKA RAMs
...
/**
 * @brief  Get Status of End of Erase after Power-on Reset for SRAM2, BKPRAM, ICACHE, DCACHE and PKA
 * RAMs
