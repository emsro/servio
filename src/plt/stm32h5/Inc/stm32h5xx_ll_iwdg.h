 ...
 *         @arg @ref LL_IWDG_PRESCALER_1024
 */
__STATIC_INLINE uint32_t LL_IWDG_GetPrescaler( IWDG_TypeDef const* IWDGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_IWDG_GetReloadCounter( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0x0FFF
 */
__STATIC_INLINE uint32_t LL_IWDG_GetWindow( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval Value between Min_Data=0 and Max_Data=0x0FFF
 */
__STATIC_INLINE uint32_t LL_IWDG_GetEwiTime( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_IWDG_IsEnabledIT_EWI( IWDG_TypeDef const* IWDGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_PVU( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_RVU( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_WVU( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_EWU( IWDG_TypeDef const* IWDGx )
{
        return ( ( READ_BIT( IWDGx->SR, IWDG_SR_EWU ) == ( IWDG_SR_EWU ) ) ? 1UL : 0UL );
}

/**
 * @brief  Check if all flags Prescaler, Reload, Window & Early Interrupt Value Update are reset or
 * not
 ...
 */
__STATIC_INLINE uint32_t LL_IWDG_IsReady( IWDG_TypeDef const* IWDGx )
{
        return (
            ( READ_BIT( IWDGx->SR, IWDG_SR_PVU | IWDG_SR_RVU | IWDG_SR_WVU | IWDG_SR_EWU ) == 0U ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_ONF( IWDG_TypeDef const* IWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_IWDG_IsActiveFlag_EWIF( IWDG_TypeDef const* IWDGx )
{
