...
typedef struct
{
        ...
        uint32_t TrimmingValueP; /*!< Specifies the offset trimming value (PMOS) in Normal Mode
                                    ...
                                    Max_Data = 31. 16 is typical default value */
        ...
        uint32_t TrimmingValuePHighSpeed; /*!< Specifies the offset trimming value (PMOS) in High
                                             Speed Mode i.e. when UserTrimming is
                                             OPAMP_TRIMMING_USER. This parameter must be a number
                                             between Min_Data = 0 and Max_Data = 31. 16 is typical
                                             default value */

        uint32_t TrimmingValueNHighSpeed; /*!< Specifies the offset trimming value (NMOS) in High
                                             Speed Mode i.e. when UserTrimming is
                                             OPAMP_TRIMMING_USER. This parameter must be a number
                                             between Min_Data = 0 and Max_Data = 31. 16 is typical
                                             default value */
...
typedef enum
{
        ...
        HAL_OPAMP_STATE_BUSYLOCKED =
            0x00000005U /*!< OPAMP is locked. Only system reset allows reconfiguring the opamp.   */
...
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_IO0_IO1_BIAS                                        \
        ( OPAMP_CSR_PGGAIN_2 | OPAMP_CSR_PGGAIN_3 ) /*!< In PGA mode, the inverting input is \
