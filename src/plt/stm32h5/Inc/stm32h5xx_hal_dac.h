...
typedef struct
{
        ...
        FunctionalState DAC_DMADoubleDataMode; /*!< Specifies if DMA double data mode should be
                                                  enabled or not for the selected channel. This
                                                  parameter can be ENABLE or DISABLE */

        FunctionalState DAC_SignedFormat; /*!< Specifies if signed format should be used or not for
                                             the selected channel. This parameter can be ENABLE or
                                             DISABLE */
...
#define DAC_TRIGGER_NONE                                                                         \
        0x00000000UL /*!< conversion is automatic once the DAC_DHRxxxx register has been loaded, \
                        and not by external trigger */
#define DAC_TRIGGER_SOFTWARE \
        ( DAC_CR_TEN1 ) /*!< conversion started by software trigger for DAC channel */
#define DAC_TRIGGER_T1_TRGO                                                                     \
        ( DAC_CR_TSEL1_0 | DAC_CR_TEN1 ) /*!< TIM1 TRGO selected as external conversion trigger \
                                            for DAC channel. */
#define DAC_TRIGGER_T2_TRGO                                                                     \
        ( DAC_CR_TSEL1_1 | DAC_CR_TEN1 ) /*!< TIM2 TRGO selected as external conversion trigger \
                                            for DAC channel */
#define DAC_TRIGGER_T6_TRGO                                                                   \
        ( DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 ) /*!< TIM6 TRGO selected as external \
                                                             conversion trigger for DAC channel */
#define DAC_TRIGGER_T7_TRGO                                                                   \
        ( DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TEN1 ) /*!< TIM7 TRGO selected as external \
                                                             conversion trigger for DAC channel */
...
#define DAC_TRIGGER_LPTIM2_CH1                                                                 \
        ( DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TEN1 ) /*!< LPTIM2 CH1 selected as external \
                                                             conversion trigger for DAC channel */
#define DAC_TRIGGER_EXT_IT9                                                                   \
        ( DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 |                                  \
          DAC_CR_TEN1 ) /*!< EXTI Line9 event selected as external conversion trigger for DAC \
                           channel */
...
#define DAC_TRIGGER_T4_TRGO                                                                   \
        ( DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 ) /*!< TIM4 TRGO selected as external \
                                                             conversion trigger for DAC channel */
#define DAC_TRIGGER_T5_TRGO                                                                     \
        ( DAC_CR_TSEL1_2 | DAC_CR_TEN1 ) /*!< TIM5 TRGO selected as external conversion trigger \
                                            for DAC channel */
...
#define DAC_TRIGGER_T15_TRGO                                                                     \
        ( DAC_CR_TSEL1_3 | DAC_CR_TEN1 ) /*!< TIM15 TRGO selected as external conversion trigger \
                                            for DAC channel */
#else
/* Devices STM32H503xx */
#define DAC_TRIGGER_T3_TRGO                                                                   \
        ( DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 ) /*!< TIM3 TRGO selected as external \
                                                             conversion trigger for DAC channel */
...
#define DAC_DELAY_STARTUP_US                                                               \
        ( 15UL ) /*!< Delay for DAC channel voltage settling time from DAC channel startup \
                    (transition from disable to enable) */
