...
#define PWR_ALL                                                                               \
        ( PWR_WKUP1 | PWR_WKUP2 | PWR_WKUP3 | PWR_WKUP4 | PWR_WKUP5 | PWR_WKUP6 | PWR_WKUP7 | \
          PWR_WKUP8 | PWR_LPM | PWR_SCM | PWR_VB | PWR_VUSB | PWR_RET )
#else
...
#define PWR_NSEC_PRIV \
        ( PWR_ITEM_ATTR_NSEC_PRIV_MASK | 0x01U )        /*!< NSecure and Privileged attribute  */
 ...
 *                                                   Indicates that the device was resumed from Stop
 * mode.
 ...
 *                                                   Indicates that the Vcore level at or above VOS
 * selected level.
 ...
 *                    @arg @ref PWR_FLAG_VBATL     : Backup domain voltage level flag (versus low
 * threshold). Indicates the backup domain voltage level is equal or above low threshold.
 *                    @arg @ref PWR_FLAG_VBATH     : Backup domain voltage level flag (versus high
 * threshold). Indicates the backup domain voltage level is equal or above high threshold.
 *                    @arg @ref PWR_FLAG_TEMPL     : Temperature level flag (versus low threshold).
 *                                                   Indicates the temperature is equal or above low
 * threshold.
 *                    @arg @ref PWR_FLAG_TEMPH     : Temperature level flag (versus high threshold).
 *                                                   Indicates the temperature is equal or above
 * high threshold.
 ...
 *                                                   Indicates that VDDIO2 is equal or above the
 * threshold of the VDDIO2 voltage monitor (around 0.9 V).
 ...
 *                                                   Indicates that VDDUSB is equal or above the
 ...
 *                                                   Indicates that a wakeup event was received from
 * the WKUP line 8.
 * @note   The PWR_WAKEUP_FLAG6, PWR_WAKEUP_FLAG7 AND PWR_WAKEUP_FLAG8 are not available for
 * STM32H503xx devices.
