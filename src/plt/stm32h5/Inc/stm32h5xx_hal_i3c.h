...
/** @defgroup I3C_Controller_Config_Structure_definition I3C Controller Configuration Structure
 * definition
...
typedef struct
{
        uint8_t DynamicAddr; /*!< Specifies the dynamic address of the controller when goes in
                                target mode. This parameter must be a number between Min_Data=0x00
                                and Max_Data=0x7F        */

        uint8_t StallTime; /*!< Specifies the controller clock stall time in number of kernel clock
                              cycles. This parameter must be a number between Min_Data=0x00 and
                              Max_Data=0xFF        */

        FunctionalState HotJoinAllowed; /*!< Specifies the Enable/Disable state of the controller
                                           Hot Join acknowledgement when receiving a hot join
                                           request from target. This parameter can be set to ENABLE
                                           or DISABLE                                 */

        FunctionalState ACKStallState; /*!< Specifies the Enable/Disable state of the controller
                                          clock stall on the ACK phase. This parameter can be set to
                                          ENABLE or DISABLE                                 */

        FunctionalState CCCStallState; /*!< Specifies the Enable/Disable state of the controller
                                          clock stall on the T bit phase of a CCC communication to
                                          allow the target to decode command. This parameter can be
                                          set to ENABLE or DISABLE */

        FunctionalState TxStallState; /*!< Specifies the Enable/Disable state of the controller
                                         clock stall on parity phase of data to allow the target to
                                         read received data. This parameter can be set to ENABLE or
                                         DISABLE                                 */

        FunctionalState RxStallState; /*!< Specifies the Enable/Disable state of the controller
                                         clock stall on the T bit phase of data enable to allow the
                                         target to prepare data to be sent. This parameter can be
                                         set to ENABLE or DISABLE                                 */

        FunctionalState HighKeeperSDA; /*!< Specifies the Enable/Disable state of the controller SDA
                                          high keeper. This parameter can be set to ENABLE or
                                          DISABLE                                 */
} I3C_CtrlConfTypeDef;
...
typedef struct
{
        ...
        uint8_t MIPIIdentifier; /*!< Specifies the bits [12-15] of the 48-provisioned ID
                                     (MIPI named reference PID), other 48-provisioned ID are
                                   hardcoded. This parameter must be a number between Min_Data=0x00
                                   and Max_Data=0x0F   */

        FunctionalState CtrlRoleRequest; /*!< Specifies the Enable/Disable state of the target
                                            authorization request for a second master Chip. This
                                            parameter can be set to ENABLE or DISABLE */

        FunctionalState HotJoinRequest; /*!< Specifies the Enable/Disable state of the target hot
                                           join authorization request. This parameter can be set to
                                           ENABLE or DISABLE                            */

        FunctionalState IBIRequest; /*!< Specifies the Enable/Disable state of the target in Band
                                       Interrupt authorization request. This parameter can be set to
                                       ENABLE or DISABLE                            */

        FunctionalState IBIPayload; /*!< Specifies the Enable/Disable state of sending data payload
                                       after an accepted IBI. This parameter can be set to ENABLE or
                                       DISABLE                            */

        uint32_t IBIPayloadSize; /*!< Specifies the I3C target payload data size.
                                      This parameter must be a value of @ref I3C_PAYLOAD_SIZE */

        uint16_t MaxReadDataSize; /*!< Specifies the numbers of data bytes that the target can read
                                     at maximum. This parameter must be a number between
                                     Min_Data=0x00 and Max_Data=0xFFFF */

        uint16_t MaxWriteDataSize; /*!< Specifies the numbers of data bytes that the target can
                                      write at maximum. This parameter must be a number between
                                      Min_Data=0x00 and Max_Data=0xFFFF */

        FunctionalState CtrlCapability; /*!< Specifies the Enable/Disable state of the target
                                           controller capability. This parameter can be set to
                                           ENABLE or DISABLE                            */

        FunctionalState GroupAddrCapability; /*!< Specifies the Enable/Disable state of the target
                                                support of group address after a controller role
                                                hand-off. This parameter can be set to ENABLE or
                                                DISABLE                            */

        uint32_t DataTurnAroundDuration; /*!< Specifies the I3C target clock-to-data turnaround
                                            time. This parameter must be a value of @ref
                                            I3C_TURNAROUND_TIME_TSCO           */
        ...
        FunctionalState MaxSpeedLimitation; /*!< Specifies the Enable/Disable state of the target
                                               max data speed limitation. This parameter can be set
                                               to ENABLE or DISABLE                            */

        uint32_t HandOffActivityState; /*!< Specifies the I3C target activity state when becoming
                                          controller. This parameter must be a value of @ref
                                          I3C_HANDOFF_ACTIVITY_STATE         */

        FunctionalState HandOffDelay; /*!< Specifies the Enable/Disable state of the target need of
                                         delay to process the controller role hand-off. This
                                         parameter can be set to ENABLE or DISABLE */

        FunctionalState PendingReadMDB; /*!< Specifies the Enable/Disable state of the transmission
                                           of a mandatory data bytes indicating a pending read
                                           notification for GETCAPR CCC command. This parameter can
...
typedef struct
{
        ...
        uint8_t TargetDynamicAddr; /*!< Specifies the dynamic address of the target x (1 to 4)
                                      connected on the bus. This parameter must be a number between
                                      Min_Data=0x00 and Max_Data=0x7F     */

        FunctionalState IBIAck; /*!< Specifies the Enable/Disable state of the controller's ACK when
                                   receiving an IBI from a target x (1 to 4) connected on the bus.
                                     This parameter can be set to ENABLE or DISABLE */

        FunctionalState IBIPayload; /*!< Specifies the Enable/Disable state of the controller's
                                       receiving IBI payload after acknowledging an IBI requested
                                       from a target x (1 to 4) connected on the bus. This parameter
                                       can be set to ENABLE or DISABLE */

        FunctionalState CtrlRoleReqAck; /*!< Specifies the Enable/Disable state of the controller's
                                           ACK when receiving a control request from a target x (1
                                           to 4) connected on the bus. This parameter can be set to
                                           ENABLE or DISABLE                              */

        FunctionalState CtrlStopTransfer; /*!< Specifies the Enable/Disable state of the
                                             controller's stop transfer after receiving an IBI
                                             request from a target x (1 to 4) connected on the bus.
                                               This parameter can be set to ENABLE or DISABLE */
...
typedef struct
{
        uint32_t DynamicAddrValid; /*!< I3C target Dynamic Address Valid (updated during
                                      ENTDAA/RSTDAA/SETNEWDA CCC) This parameter can be Valid=1U or
                                      Not Valid=0U                                   */
        uint32_t DynamicAddr; /*!< I3C target Dynamic Address (updated during ENTDAA/RSTDAA/SETNEWDA
                                 CCC)           */
        ...
        uint32_t InBandAllowed;   /*!< I3C target In Band Interrupt (updated during ENEC/DISEC CCC)
                                       This parameter can be Allowed=1U or Not Allowed=0U  */
        uint32_t CtrlRoleAllowed; /*!< I3C target Controller Role Request (updated during ENEC/DISEC
                                     CCC) This parameter can be Allowed=1U or Not Allowed=0U */
        uint32_t IBICRTgtAddr; /*!< I3C controller receive Target Address during IBI or Controller
                                  Role Request event*/
...
typedef struct
{
        uint32_t* pBuffer; /*!< Pointer to the buffer containing the control or status register
                              values */
...
typedef struct
{
        ...
        I3C_DataTypeDef CCCBuf; /*!< Contain size of associated data and size of defining byte if
...
/** @defgroup I3C_ENTDAAPayloadTypeDef_Structure_definition I3C ENTDAAPayloadTypeDef Structure
 * definition
...
typedef struct __I3C_HandleTypeDef
{
        ...
        I3C_CCCTypeDef const* pCCCDesc; /*!< I3C CCC descriptor pointer                */

        I3C_PrivateTypeDef const* pPrivateDesc; /*!< I3C private transfer descriptor pointer   */
        ...
        void ( *TgtReqDynamicAddrCallback )(
            struct __I3C_HandleTypeDef* hi3c,
            uint64_t                    targetPayload );
        /*!< I3C Controller request dynamic address callback during Dynamic Address Assignment
         * processus */
...
typedef void (
    *pI3C_TgtReqDynamicAddrCallbackTypeDef )( I3C_HandleTypeDef* hi3c, uint64_t targetPayload );
/**
 * @}
 */
#endif /* USE_HAL_I3C_REGISTER_CALLBACKS == 1U */
...
#define HAL_I3C_ERROR_CE0                                                                    \
        ( I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE0 ) /*!< Controller detected an illegally \
                                                            formatted CCC */
#define HAL_I3C_ERROR_CE1                                                                        \
        ( I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE1 ) /*!< Controller detected that transmitted \
                                                          data on the bus is different than      \
                                                          expected    */
#define HAL_I3C_ERROR_CE2                                                                      \
        ( I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE2 ) /*!< Controller detected that broadcast \
                                                          address 7'h7E has been nacked */
#define HAL_I3C_ERROR_CE3                                                                        \
        ( I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE3 ) /*!< Controller detected that new         \
                                                          Controller did not drive the bus after \
                                                            Controller-role handoff */
#define HAL_I3C_ERROR_TE0                                                                    \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE0 ) /*!< Target detected an invalid broadcast \
                                                        address */
#define HAL_I3C_ERROR_TE1 \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE1 ) /*!< Target detected an invalid CCC Code */
#define HAL_I3C_ERROR_TE2                                                                     \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE2 ) /*!< Target detected a parity error during \
                                                        a write data */
#define HAL_I3C_ERROR_TE3                                                                          \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE3 ) /*!< Target detected a parity error on assigned \
                                                        address during dynamic address             \
                                                        arbitration */
#define HAL_I3C_ERROR_TE4                                                                       \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE4 ) /*!< Target detected 7'h7E missing after     \
                                                      Restart during Dynamic Address Assignment \
                                                        procedure */
#define HAL_I3C_ERROR_TE5                                                            \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE5 ) /*!< Target detected an illegally \
                                                        formatted CCC */
#define HAL_I3C_ERROR_TE6                                                                        \
        ( I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE6 ) /*!< Target detected that transmitted data on \
...
#define HAL_I3C_PAYLOAD_EMPTY \
        LL_I3C_PAYLOAD_EMPTY /*!< Empty payload, no additional data after IBI acknowledge */
...
#define HAL_I3C_PAYLOAD_3_BYTES \
        LL_I3C_PAYLOAD_3_BYTES /*!< Three additional data bytes after IBI acknowledge       */
...
#define HAL_I3C_GETMXDS_FORMAT_2_LSB                                                   \
        LL_I3C_GETMXDS_FORMAT_2_LSB /*!< GETMXDS CCC Format 2 is used, MaxRdTurn field \
                                         in response, LSB = RDTURN[7:0]                 */
#define HAL_I3C_GETMXDS_FORMAT_2_MID                                                   \
        LL_I3C_GETMXDS_FORMAT_2_MID /*!< GETMXDS CCC Format 2 is used, MaxRdTurn field \
                                         in response, Middle byte = RDTURN[7:0]         */
#define HAL_I3C_GETMXDS_FORMAT_2_MSB                                                   \
        LL_I3C_GETMXDS_FORMAT_2_MSB /*!< GETMXDS CCC Format 2 is used, MaxRdTurn field \
...
#define HAL_I3C_ALL_COMMON_ITS \
        ( uint32_t )( LL_I3C_IER_TXFNFIE | LL_I3C_IER_RXFNEIE | LL_I3C_IER_FCIE | LL_I3C_IER_ERRIE )
/**
 * @}
 */
...
#define HAL_I3C_ALL_TGT_ITS                                                                     \
        ( uint32_t )(                                                                           \
            LL_I3C_IER_IBIENDIE | LL_I3C_IER_CRUPDIE | LL_I3C_IER_WKPIE | LL_I3C_IER_GETIE |    \
            LL_I3C_IER_STAIE | LL_I3C_IER_DAUPDIE | LL_I3C_IER_MWLUPDIE | LL_I3C_IER_MRLUPDIE | \
            LL_I3C_IER_RSTIE | LL_I3C_IER_ASUPDIE | LL_I3C_IER_INTUPDIE | LL_I3C_IER_DEFIE |    \
            LL_I3C_IER_GRPIE )
/**
 * @}
 */
...
#define HAL_I3C_ALL_CTRL_ITS                                                            \
        ( uint32_t )(                                                                   \
            LL_I3C_IER_CFNFIE | LL_I3C_IER_SFNEIE | LL_I3C_IER_HJIE | LL_I3C_IER_CRIE | \
            LL_I3C_IER_IBIIE | LL_I3C_IER_RXTGTENDIE )
/**
 * @}
 */
...
#define __HAL_I3C_GET_IBI_CAPABLE( __BCR__ ) \
        ( ( ( ( ( __BCR__ ) & I3C_BCR_BCR1_Msk ) >> I3C_BCR_BCR1_Pos ) == 1U ) ? ENABLE : DISABLE )
...
#define __HAL_I3C_GET_IBI_PAYLOAD( __BCR__ ) \
        ( ( ( ( ( __BCR__ ) & I3C_BCR_BCR2_Msk ) >> I3C_BCR_BCR2_Pos ) == 1U ) ? ENABLE : DISABLE )
...
#define __HAL_I3C_GET_CR_CAPABLE( __BCR__ ) \
        ( ( ( ( ( __BCR__ ) & I3C_BCR_BCR6_Msk ) >> I3C_BCR_BCR6_Pos ) == 1U ) ? ENABLE : DISABLE )
...
HAL_StatusTypeDef
HAL_I3C_Ctrl_Config( I3C_HandleTypeDef* hi3c, I3C_CtrlConfTypeDef const* pConfig );
...
HAL_StatusTypeDef
HAL_I3C_Ctrl_TransmitCCC_IT( I3C_HandleTypeDef* hi3c, I3C_XferTypeDef* pXferData );
HAL_StatusTypeDef
...
HAL_StatusTypeDef
HAL_I3C_Ctrl_ReceiveCCC_DMA( I3C_HandleTypeDef* hi3c, I3C_XferTypeDef* pXferData );
...
#define IS_I3C_MODE( __MODE__ )                                                                   \
        ( ( ( __MODE__ ) == HAL_I3C_MODE_NONE ) || ( ( __MODE__ ) == HAL_I3C_MODE_CONTROLLER ) || \
...
#define IS_I3C_ENTDAA_OPTION( __OPTION__ ) \
        ( ( ( __OPTION__ ) == I3C_RSTDAA_THEN_ENTDAA ) || ( ( __OPTION__ ) == I3C_ONLY_ENTDAA ) )
