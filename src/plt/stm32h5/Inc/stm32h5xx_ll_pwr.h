...
#define LL_PWR_FLAG_VDDIO2RDY \
        PWR_VMSR_VDDIO2RDY /*!< VDDIO2 ready flag                                        */
#define LL_PWR_FLAG_PVDO \
        PWR_VMSR_PVDO /*!< Programmable voltage detect output flag                  */
#define LL_PWR_FLAG_USB33RDY \
        PWR_VMSR_USB33RDY /*!< VDDUSB ready flag                                        */
...
#define LL_PWR_REGU_VOLTAGE_SVOS_SCALE3                                                           \
        ( PWR_PMCR_SVOS_0 | PWR_PMCR_SVOS_1 ) /*!< Select voltage scale 3 when system enters STOP \
                                                 mode */
/**
 * @}
 */
...
#define LL_PWR_PVDLEVEL_3 \
        ( PWR_VMCR_PLS_0 | PWR_VMCR_PLS_1 ) /*!< Voltage threshold detected by PVD 2.40 V  */
#define LL_PWR_PVDLEVEL_4 PWR_VMCR_PLS_2    /*!< Voltage threshold detected by PVD 2.55 V  */
#define LL_PWR_PVDLEVEL_5 \
        ( PWR_VMCR_PLS_0 | PWR_VMCR_PLS_2 ) /*!< Voltage threshold detected by PVD 2.70 V  */
#define LL_PWR_PVDLEVEL_6 \
        ( PWR_VMCR_PLS_1 | PWR_VMCR_PLS_2 ) /*!< Voltage threshold detected by PVD 2.85 V  */
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_AVD_READY ) == ( PWR_PMCR_AVD_READY ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_SRAM2_48SO ) == ( PWR_PMCR_SRAM2_48SO ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_SRAM2_16SO ) == ( PWR_PMCR_SRAM2_16SO ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_SRAM2_16HSO ) == ( PWR_PMCR_SRAM2_16HSO ) ) ? 1UL :
                                                                                          0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_SRAM2_16LSO ) == ( PWR_PMCR_SRAM2_16LSO ) ) ? 1UL :
                                                                                          0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PMCR, PWR_PMCR_ETHERNETSO ) == ( PWR_PMCR_ETHERNETSO ) ) ? 1UL : 0UL );
}
 ...
 *       SRAM can still be used but its content will be lost in the Standby and VBAT modes. Once
 * set, the application must wait that the Backup Regulator Ready flag (BRR) is set to indicate that
...
{
        return (
            ( READ_BIT( PWR->UCPDR, PWR_UCPDR_UCPD_STBY ) == ( PWR_UCPDR_UCPD_STBY ) ) ? 1UL :
                                                                                         0UL );
}
...
{
        return (
            ( READ_BIT( PWR->UCPDR, PWR_UCPDR_UCPD_DBDIS ) == ( PWR_UCPDR_UCPD_DBDIS ) ) ? 0UL :
                                                                                           1UL );
}
...
{
        return (
            ( READ_BIT( PWR->USBSCR, PWR_USBSCR_USB33DEN ) == ( PWR_USBSCR_USB33DEN ) ) ? 1UL :
                                                                                          0UL );
}
...
{
        return (
            ( READ_BIT( PWR->USBSCR, PWR_USBSCR_USB33SV ) == ( PWR_USBSCR_USB33SV ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->WUCR, ( WakeUpPin << PWR_WUCR_WUPP1_Pos ) ) ==
...
__STATIC_INLINE uint32_t LL_PWR_GetWakeUpPinPull( uint32_t WakeUpPin )
{
        ...
        return (uint32_t) ( regValue >>
                            ( ( PWR_WUCR_WUPPUPD1_Pos + ( ( LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET *
...
{
        return (
            ( READ_BIT( PWR->IORETR, PWR_IORETR_IORETEN ) == ( PWR_IORETR_IORETEN ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->IORETR, PWR_IORETR_JTAGIORETEN ) == ( PWR_IORETR_JTAGIORETEN ) ) ?
                1UL :
                0UL );
}
...
{
        return (
            ( READ_BIT( PWR->VOSSR, PWR_VOSSR_ACTVOSRDY ) == ( PWR_VOSSR_ACTVOSRDY ) ) ? 1UL :
                                                                                         0UL );
}
...
{
        return (
            ( READ_BIT( PWR->VMSR, PWR_VMSR_USB33RDY ) == ( PWR_VMSR_USB33RDY ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->VMCR, PWR_VMSR_VDDIO2RDY ) == ( PWR_VMSR_VDDIO2RDY ) ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PRIVCFGR, PWR_PRIVCFGR_NSPRIV ) == PWR_PRIVCFGR_NSPRIV ) ? 1UL : 0UL );
}
#else
/**
 * @brief  Enable privileged mode for nsecure items.
...
{
        return (
            ( READ_BIT( PWR->PRIVCFGR, PWR_PRIVCFGR_PRIV ) == PWR_PRIVCFGR_PRIV ) ? 1UL : 0UL );
}
...
{
        return (
            ( READ_BIT( PWR->PRIVCFGR, PWR_PRIVCFGR_SPRIV ) == PWR_PRIVCFGR_SPRIV ) ? 1UL : 0UL );
}
