...
#endif /* USE_HAL_RNG_REGISTER_CALLBACKS */
{
        ...
        void ( *MspDeInitCallback )( struct __RNG_HandleTypeDef* hrng ); /*!< RNG Msp DeInit
                                                                            callback    */
#endif /* USE_HAL_RNG_REGISTER_CALLBACKS */
 ...
 */
typedef void ( *pRNG_CallbackTypeDef )( RNG_HandleTypeDef* hrng ); /*!< pointer to a common RNG
                                                                      callback function */
...
#if ( USE_HAL_RNG_REGISTER_CALLBACKS == 1 )
HAL_StatusTypeDef HAL_RNG_RegisterCallback(
    RNG_HandleTypeDef*        hrng,
    HAL_RNG_CallbackIDTypeDef CallbackID,
    pRNG_CallbackTypeDef      pCallback );
HAL_StatusTypeDef
HAL_RNG_UnRegisterCallback( RNG_HandleTypeDef* hrng, HAL_RNG_CallbackIDTypeDef CallbackID );

HAL_StatusTypeDef HAL_RNG_RegisterReadyDataCallback(
    RNG_HandleTypeDef*            hrng,
...
uint32_t          HAL_RNG_ReadLastRandomNumber( RNG_HandleTypeDef const* hrng );
 ...
 * @{
 */
HAL_RNG_StateTypeDef HAL_RNG_GetState( RNG_HandleTypeDef const* hrng );
uint32_t             HAL_RNG_GetError( RNG_HandleTypeDef const* hrng );
/**
 * @}
 */
