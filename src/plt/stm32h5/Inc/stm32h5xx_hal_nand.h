...
typedef struct
{
        ...
        FunctionalState ExtraCommandEnable; /*!< NAND extra command needed for Page reading mode.
                                               This parameter is mandatory for some NAND parts after
                                               the read command (NAND_CMD_AREA_TRUE1) and before
                                               DATA reading sequence. This parameter could be ENABLE
                                               or DISABLE Please check the Read Mode sequence in the
...
#endif /* USE_HAL_NAND_REGISTER_CALLBACKS  */
{
        ...
        void ( *MspInitCallback )( struct __NAND_HandleTypeDef* hnand ); /*!< NAND Msp Init callback
                                                                          */
        void ( *MspDeInitCallback )( struct __NAND_HandleTypeDef* hnand ); /*!< NAND Msp DeInit
                                                                              callback            */
...
HAL_StatusTypeDef HAL_NAND_Init(
...
HAL_StatusTypeDef
HAL_NAND_ConfigDevice( NAND_HandleTypeDef* hnand, NAND_DeviceConfigTypeDef const* pDeviceConfig );
...
HAL_StatusTypeDef HAL_NAND_Read_Page_8b(
    NAND_HandleTypeDef*        hnand,
    NAND_AddressTypeDef const* pAddress,
    uint8_t*                   pBuffer,
...
HAL_StatusTypeDef
HAL_NAND_Erase_Block( NAND_HandleTypeDef* hnand, NAND_AddressTypeDef const* pAddress );

uint32_t HAL_NAND_Address_Inc( NAND_HandleTypeDef const* hnand, NAND_AddressTypeDef* pAddress );
...
HAL_StatusTypeDef
HAL_NAND_UnRegisterCallback( NAND_HandleTypeDef* hnand, HAL_NAND_CallbackIDTypeDef CallbackId );
#endif /* USE_HAL_NAND_REGISTER_CALLBACKS */
...
HAL_NAND_StateTypeDef HAL_NAND_GetState( NAND_HandleTypeDef const* hnand );
uint32_t              HAL_NAND_Read_Status( NAND_HandleTypeDef const* hnand );
/**
 * @}
 */
