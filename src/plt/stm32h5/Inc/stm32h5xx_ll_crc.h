 ...
 *         @arg @ref LL_CRC_POLYLENGTH_7B
 */
__STATIC_INLINE uint32_t LL_CRC_GetPolynomialSize( CRC_TypeDef const* CRCx )
{
 ...
 *         @arg @ref LL_CRC_INDATA_REVERSE_WORD
 */
__STATIC_INLINE uint32_t LL_CRC_GetInputDataReverseMode( CRC_TypeDef const* CRCx )
{
 ...
 *         @arg @ref LL_CRC_OUTDATA_REVERSE_BIT
 */
__STATIC_INLINE uint32_t LL_CRC_GetOutputDataReverseMode( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CRC_GetInitialData( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CRC_GetPolynomialCoef( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CRC_ReadData32( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint16_t LL_CRC_ReadData16( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_CRC_ReadData8( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_CRC_ReadData7( CRC_TypeDef const* CRCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_CRC_Read_IDR( CRC_TypeDef const* CRCx )
{
...
ErrorStatus LL_CRC_DeInit( CRC_TypeDef const* CRCx );
