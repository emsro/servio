...
typedef struct
{
        uint32_t FifoThresholdByte; /*!< This is the threshold used by the Peripheral to generate
                                       the interrupt indicating that data are available in reception
                                       or free place is available in transmission. For OCTOSPI, this
        ...
        uint32_t ChipSelectHighTimeCycle; /*!< It defines the minimum number of clocks which the
                                             chip select must remain high between commands. This
                                             parameter can be a value between 1 and 64U */
        ...
        uint32_t WrapSize;  /*!< It indicates the wrap-size corresponding the external device
                               configuration.  This parameter can be a value of @ref XSPI_WrapSize */
        ...
        uint32_t ChipSelectBoundary;    /*!< It enables the transaction boundary feature and
                                             ...
                                             This parameter can be a value of @ref
                                           XSPI_ChipSelectBoundary  */
        uint32_t DelayBlockBypass; /*!< It enables the delay block bypass, so the sampling is not
                                      affected by the delay block. This parameter can be a value of
                                      @ref XSPI_DelayBlockBypass */
        uint32_t Refresh; /*!< It enables the refresh rate feature. The chip select is released
                             every Refresh+1 clock cycles. This parameter can be a value between 0
                             and 0xFFFFFFFF */
} XSPI_InitTypeDef;
...
typedef struct
{
        uint32_t OperationType; /*!< It indicates if the configuration applies to the common
                                   registers or to the registers for the write operation (these
                                   registers are only used for memory-mapped mode). This parameter
                                   can be a value of @ref XSPI_OperationType */
        ...
        uint32_t InstructionDTRMode; /*!< It enables or not the DTR mode for the instruction phase.
                                          This parameter can be a value of @ref
                                        XSPI_InstructionDTRMode */
        uint32_t Address;            /*!< It contains the address to be sent to the device.
                                          This parameter can be a value between 0 and 0xFFFFFFFF */
        uint32_t AddressMode;    /*!< It indicates the address mode. Address mode precises number of
                                    lines    for address (except no address).    This parameter can be
                                    a    value of @ref XSPI_AddressMode */
        ...
        uint32_t AlternateBytesDTRMode; /*!< It enables or not the DTR mode for the alternate bytes
                                           phase. This parameter can be a value of @ref
                                           XSPI_AlternateBytesDTRMode */
        ...
        uint32_t DummyCycles; /*!< It indicates the number of dummy cycles inserted before data
                                 phase. This parameter can be a value between 0 and 31U */
...
typedef struct
{
        uint32_t RWRecoveryTimeCycle; /*!< It indicates the number of cycles for the device read
                                         write recovery time. This parameter can be a value between
                                         0 and 255U */
...
typedef struct
{
        uint32_t MatchValue; /*!< Specifies the value to be compared with the masked status register
                                to get a match. This parameter can be any value between 0 and
                                0xFFFFFFFFU */
        ...
        uint32_t IntervalTime;  /*!< Specifies the number of clock cycles between two read during
                                   automatic  polling phases.  This parameter can be any value
...
typedef struct
{
        uint32_t TimeOutActivation;  /*!< Specifies if the timeout counter is enabled to release the
                                        ...
                                        XSPI_TimeOutActivation */
        uint32_t TimeoutPeriodClock; /*!< Specifies the number of clock to wait when the FIFO is
                                        full before to release the chip select. This parameter can
                                        be any value between 0 and 0xFFFFU */
...
#define HAL_XSPI_STATE_HYPERBUS_INIT                                                           \
        ( 0x00000001U ) /*!< Initialization done in hyperbus mode but timing configuration not \
                           done */
#define HAL_XSPI_STATE_CMD_CFG \
        ( 0x00000004U ) /*!< Command (regular or hyperbus) configured, ready for an action */
#define HAL_XSPI_STATE_READ_CMD_CFG                                                               \
        ( 0x00000014U ) /*!< Read command configuration done, not the write command configuration \
                         */
#define HAL_XSPI_STATE_WRITE_CMD_CFG                                                              \
        ( 0x00000024U ) /*!< Write command configuration done, not the read command configuration \
                         */
...
#define HAL_XSPI_WRAP_16_BYTES \
        ( (uint32_t) XSPI_DCR2_WRAPSIZE_1 ) /*!< external memory supports wrap size of 16 bytes */
#define HAL_XSPI_WRAP_32_BYTES                                                                     \
        ( (uint32_t) ( XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_1 ) ) /*!< external memory        \
                                                                          supports wrap size of 32 \
                                                                          bytes  */
#define HAL_XSPI_WRAP_64_BYTES \
        ( (uint32_t) XSPI_DCR2_WRAPSIZE_2 ) /*!< external memory supports wrap size of 64 bytes */
#define HAL_XSPI_WRAP_128_BYTES                                                                 \
        ( (uint32_t) ( XSPI_DCR2_WRAPSIZE_0 | XSPI_DCR2_WRAPSIZE_2 ) ) /*!< external memory     \
                                                                          supports wrap size of \
                                                                          128 bytes */
/**
 * @}
 */
...
#define HAL_XSPI_ADDRESS_4_LINES \
        ( (uint32_t) ( XSPI_CCR_ADMODE_0 | XSPI_CCR_ADMODE_1 ) )  /*!< Address on four lines    */
...
#define HAL_XSPI_ALT_BYTES_4_LINES                                                            \
        ( (uint32_t) ( XSPI_CCR_ABMODE_0 | XSPI_CCR_ABMODE_1 ) ) /*!< Alternate bytes on four \
                                                                    lines    */
...
#define HAL_XSPI_TIMEOUT_COUNTER_ENABLE                                                     \
        ( (uint32_t) XSPI_CR_TCEN ) /*!< Timeout counter enabled, nCS released when timeout \
                                       expires */
/**
 * @}
 */
...
#define HAL_XSPI_FLAG_SM \
        XSPI_SR_SMF /*!< Status match flag: received data matches in autopolling mode */
#define HAL_XSPI_FLAG_FT                                                                          \
        XSPI_SR_FTF /*!< Fifo threshold flag: Fifo threshold reached or data left after read from \
                       memory is complete              */
#define HAL_XSPI_FLAG_TC                                                                         \
        XSPI_SR_TCF /*!< Transfer complete flag: programmed number of data have been transferred \
                       or the transfer has been aborted */
...
HAL_StatusTypeDef
HAL_XSPI_Command( XSPI_HandleTypeDef* hxspi, XSPI_RegularCmdTypeDef* const pCmd, uint32_t Timeout );
HAL_StatusTypeDef
HAL_XSPI_Command_IT( XSPI_HandleTypeDef* hxspi, XSPI_RegularCmdTypeDef* const pCmd );
HAL_StatusTypeDef HAL_XSPI_HyperbusCfg(
    XSPI_HandleTypeDef*            hxspi,
    XSPI_HyperbusCfgTypeDef* const pCfg,
    uint32_t                       Timeout );
HAL_StatusTypeDef HAL_XSPI_HyperbusCmd(
    XSPI_HandleTypeDef*            hxspi,
...
HAL_StatusTypeDef
HAL_XSPI_Transmit( XSPI_HandleTypeDef* hxspi, uint8_t const* pData, uint32_t Timeout );
HAL_StatusTypeDef
HAL_XSPI_Receive( XSPI_HandleTypeDef* hxspi, uint8_t* const pData, uint32_t Timeout );
...
HAL_StatusTypeDef HAL_XSPI_AutoPolling(
    XSPI_HandleTypeDef*            hxspi,
    XSPI_AutoPollingTypeDef* const pCfg,
    uint32_t                       Timeout );
HAL_StatusTypeDef
HAL_XSPI_AutoPolling_IT( XSPI_HandleTypeDef* hxspi, XSPI_AutoPollingTypeDef* const pCfg );

/* XSPI memory-mapped mode functions */
HAL_StatusTypeDef
HAL_XSPI_MemoryMapped( XSPI_HandleTypeDef* hxspi, XSPI_MemoryMappedTypeDef* const pCfg );
...
HAL_StatusTypeDef HAL_XSPI_RegisterCallback(
    XSPI_HandleTypeDef*        hxspi,
    HAL_XSPI_CallbackIDTypeDef CallbackID,
    pXSPI_CallbackTypeDef      pCallback );
HAL_StatusTypeDef
HAL_XSPI_UnRegisterCallback( XSPI_HandleTypeDef* hxspi, HAL_XSPI_CallbackIDTypeDef CallbackID );
#endif /* (USE_HAL_XSPI_REGISTER_CALLBACKS) && (USE_HAL_XSPI_REGISTER_CALLBACKS == 1U) */
...
uint32_t          HAL_XSPI_GetFifoThreshold( XSPI_HandleTypeDef const* hxspi );
...
uint32_t          HAL_XSPI_GetError( XSPI_HandleTypeDef const* hxspi );
uint32_t          HAL_XSPI_GetState( XSPI_HandleTypeDef const* hxspi );
...
HAL_StatusTypeDef
HAL_XSPI_DLYB_SetConfig( XSPI_HandleTypeDef* hxspi, HAL_XSPI_DLYB_CfgTypeDef* const pdlyb_cfg );
HAL_StatusTypeDef
HAL_XSPI_DLYB_GetConfig( XSPI_HandleTypeDef* hxspi, HAL_XSPI_DLYB_CfgTypeDef* const pdlyb_cfg );
HAL_StatusTypeDef HAL_XSPI_DLYB_GetClockPeriod(
    XSPI_HandleTypeDef*             hxspi,
...
#define IS_XSPI_FREE_RUN_CLK( CLK ) \
        ( ( ( CLK ) == HAL_XSPI_FREERUNCLK_DISABLE ) || ( ( CLK ) == HAL_XSPI_FREERUNCLK_ENABLE ) )
...
#define IS_XSPI_DLYB_BYPASS( DLYB ) \
        ( ( ( DLYB ) == HAL_XSPI_DELAY_BLOCK_ON ) || ( ( DLYB ) == HAL_XSPI_DELAY_BLOCK_BYPASS ) )

#define IS_XSPI_OPERATION_TYPE( TYPE )                                                             \
        ( ( ( TYPE ) == HAL_XSPI_OPTYPE_COMMON_CFG ) ||                                            \
          ( ( TYPE ) == HAL_XSPI_OPTYPE_READ_CFG ) || ( ( TYPE ) == HAL_XSPI_OPTYPE_WRITE_CFG ) || \
...
#define IS_XSPI_DATA_DTR_MODE( MODE ) \
        ( ( ( MODE ) == HAL_XSPI_DATA_DTR_DISABLE ) || ( ( MODE ) == HAL_XSPI_DATA_DTR_ENABLE ) )
