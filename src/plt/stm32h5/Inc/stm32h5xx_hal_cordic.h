...
#endif /* USE_HAL_CORDIC_REGISTER_CALLBACKS */
{
        ...
        int32_t const* pInBuff; /*!< Pointer to CORDIC input data buffer */
...
#if USE_HAL_CORDIC_REGISTER_CALLBACKS == 1
        void ( *ErrorCallback )( struct __CORDIC_HandleTypeDef* hcordic ); /*!< CORDIC error
                                                                              callback */
        void ( *CalculateCpltCallback )(
            struct __CORDIC_HandleTypeDef* hcordic ); /*!< CORDIC calculate complete callback */

        void ( *MspInitCallback )( struct __CORDIC_HandleTypeDef* hcordic );   /*!< CORDIC Msp Init
                                                                                  callback */
        void ( *MspDeInitCallback )( struct __CORDIC_HandleTypeDef* hcordic ); /*!< CORDIC Msp
                                                                                  DeInit callback */
 ...
 */
typedef void ( *pCORDIC_CallbackTypeDef )( CORDIC_HandleTypeDef* hcordic ); /*!< pointer to a CORDIC
                                                                               callback function */
 ...
 * @param  __SCALE__ Number of cycles for calculation, 1 cycle corresponding to 4 algorithm
 * iterations.
...
#define IS_CORDIC_INSIZE( __INSIZE__ ) \
        ( ( ( __INSIZE__ ) == CORDIC_INSIZE_32BITS ) || ( ( __INSIZE__ ) == CORDIC_INSIZE_16BITS ) )
...
#define IS_CORDIC_DMA_DIRECTION( __DMADIR__ )                                                    \
        ( ( ( __DMADIR__ ) == CORDIC_DMA_DIR_IN ) || ( ( __DMADIR__ ) == CORDIC_DMA_DIR_OUT ) || \
...
HAL_StatusTypeDef HAL_CORDIC_RegisterCallback(
...
HAL_StatusTypeDef
HAL_CORDIC_Configure( CORDIC_HandleTypeDef* hcordic, CORDIC_ConfigTypeDef const* sConfig );
HAL_StatusTypeDef HAL_CORDIC_Calculate(
    CORDIC_HandleTypeDef* hcordic,
    int32_t const*        pInBuff,
    int32_t*              pOutBuff,
    uint32_t              NbCalc,
    uint32_t              Timeout );
HAL_StatusTypeDef HAL_CORDIC_CalculateZO(
    CORDIC_HandleTypeDef* hcordic,
    int32_t const*        pInBuff,
    int32_t*              pOutBuff,
    uint32_t              NbCalc,
    uint32_t              Timeout );
HAL_StatusTypeDef HAL_CORDIC_Calculate_IT(
    CORDIC_HandleTypeDef* hcordic,
    int32_t const*        pInBuff,
    int32_t*              pOutBuff,
    uint32_t              NbCalc );
HAL_StatusTypeDef HAL_CORDIC_Calculate_DMA(
    CORDIC_HandleTypeDef* hcordic,
    int32_t const*        pInBuff,
    int32_t*              pOutBuff,
    uint32_t              NbCalc,
...
HAL_CORDIC_StateTypeDef HAL_CORDIC_GetState( CORDIC_HandleTypeDef const* hcordic );
uint32_t                HAL_CORDIC_GetError( CORDIC_HandleTypeDef const* hcordic );
