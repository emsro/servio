...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
        ...
        void ( *SetupStageCallback )( struct __PCD_HandleTypeDef* hpcd ); /*!< USB OTG PCD Setup
                                                                             Stage callback */
        void ( *ResetCallback )( struct __PCD_HandleTypeDef* hpcd ); /*!< USB OTG PCD Reset callback
                                                                      */
        void ( *SuspendCallback )( struct __PCD_HandleTypeDef* hpcd );    /*!< USB OTG PCD Suspend
                                                                             callback            */
        void ( *ResumeCallback )( struct __PCD_HandleTypeDef* hpcd );     /*!< USB OTG PCD Resume
                                                                             callback             */
        void ( *ConnectCallback )( struct __PCD_HandleTypeDef* hpcd );    /*!< USB OTG PCD Connect
                                                                             callback            */
        void ( *DisconnectCallback )( struct __PCD_HandleTypeDef* hpcd ); /*!< USB OTG PCD
                                                                             Disconnect callback */
        ...
        void ( *MspInitCallback )( struct __PCD_HandleTypeDef* hpcd );   /*!< USB OTG PCD Msp Init
                                                                            callback           */
        void ( *MspDeInitCallback )( struct __PCD_HandleTypeDef* hpcd ); /*!< USB OTG PCD Msp DeInit
                                                                            callback         */
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
} PCD_HandleTypeDef;
...
typedef void ( *pPCD_CallbackTypeDef )( PCD_HandleTypeDef* hpcd ); /*!< pointer to a common USB OTG
                                                                      PCD callback function  */
 ...
 * @retval Counter value
 */
__STATIC_INLINE uint16_t PCD_GET_EP_RX_CNT( PCD_TypeDef const* Instance, uint16_t bEpNum )
{
        UNUSED( Instance );
 ...
 * @retval Counter value
 */
__STATIC_INLINE uint16_t PCD_GET_EP_DBUF0_CNT( PCD_TypeDef const* Instance, uint16_t bEpNum )
{
        UNUSED( Instance );
        __IO uint32_t count = PCD_RX_PMA_CNT;
 ...
 * @retval Counter value
 */
__STATIC_INLINE uint16_t PCD_GET_EP_DBUF1_CNT( PCD_TypeDef const* Instance, uint16_t bEpNum )
{
        UNUSED( Instance );
        __IO uint32_t count = PCD_RX_PMA_CNT;
