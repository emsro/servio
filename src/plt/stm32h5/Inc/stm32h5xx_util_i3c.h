...
typedef struct
{
        ...
        uint32_t dutyCycle; /*!< Specifies the I3C duty cycle for Pure I3C bus or I2C duty cycle for
                               Mixed bus in percent This parameter must be a value less than or
                               equal to 50 percent.                         */
