...
#define LL_WWDG_PRESCALER_128                                                                \
        ( WWDG_CFR_WDGTB_2 | WWDG_CFR_WDGTB_1 | WWDG_CFR_WDGTB_0 ) /*!< WWDG counter clock = \
                                                                      (PCLK1/4096)/128 */
/**
 * @}
 */
 ...
 */
__STATIC_INLINE uint32_t LL_WWDG_IsEnabled( WWDG_TypeDef const* WWDGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_WWDG_GetCounter( WWDG_TypeDef const* WWDGx )
{
 ...
 *         @arg @ref LL_WWDG_PRESCALER_128
 */
__STATIC_INLINE uint32_t LL_WWDG_GetPrescaler( WWDG_TypeDef const* WWDGx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_WWDG_GetWindow( WWDG_TypeDef const* WWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_WWDG_IsActiveFlag_EWKUP( WWDG_TypeDef const* WWDGx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_WWDG_IsEnabledIT_EWKUP( WWDG_TypeDef const* WWDGx )
{
