...
typedef struct
{
        ...
        uint32_t IsFilterMatchingFrame; /*!< Specifies whether the accepted frame did not match any
                                           ...
                                           parameter takes 0 if the frame matched an Rx filter or 1
                                           if it did not match any Rx filter */
...
typedef struct
{
        ...
        uint32_t ErrorLogging; /*!< Specifies the Transmit/Receive error logging counter value.
                                    This parameter can be a number between 0 and 255.
                                    This counter is incremented each time when a FDCAN protocol
                                  error causes the TxErrorCnt or the RxErrorCnt to be incremented.
                                  The counter stops at 255; the next increment of TxErrorCnt or
...
#endif /* USE_HAL_FDCAN_REGISTER_CALLBACKS */
{
        ...
        void ( *TxFifoEmptyCallback )( struct __FDCAN_HandleTypeDef* hfdcan ); /*!< FDCAN Tx Fifo
                                                                                  Empty callback */
        ...
        void ( *HighPriorityMessageCallback )(
            struct __FDCAN_HandleTypeDef* hfdcan ); /*!< FDCAN High priority message callback */
        void ( *TimestampWraparoundCallback )(
            struct __FDCAN_HandleTypeDef* hfdcan ); /*!< FDCAN Timestamp wraparound callback  */
        void ( *TimeoutOccurredCallback )(
            struct __FDCAN_HandleTypeDef* hfdcan ); /*!< FDCAN Timeout occurred callback      */
        ...
        void ( *MspInitCallback )( struct __FDCAN_HandleTypeDef* hfdcan );   /*!< FDCAN Msp Init
                                                                                callback   */
        void ( *MspDeInitCallback )( struct __FDCAN_HandleTypeDef* hfdcan ); /*!< FDCAN Msp DeInit
                                                                                callback */
 ...
 */
typedef void ( *pFDCAN_CallbackTypeDef )( FDCAN_HandleTypeDef* hfdcan ); /*!< pointer to a common
                                                                            FDCAN callback function
                                                                          */
...
#define FDCAN_FILTER_RANGE_NO_EIDM                                                              \
        ( (uint32_t) 0x00000003U ) /*!< Range filter from FilterID1 to FilterID2, EIDM mask not \
                                      applied */
/**
 * @}
 */
...
#define FDCAN_IT_LIST_BIT_LINE_ERROR                                                         \
        ( FDCAN_IT_ERROR_PASSIVE | FDCAN_IT_ERROR_LOGGING_OVERFLOW ) /*!< Bit and Line Error \
                                                                        Interrupts List */
