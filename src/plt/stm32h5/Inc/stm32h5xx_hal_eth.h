...
typedef struct
{
        ...
        uint32_t MaxSegmentSize; /*!< Sets TCP maximum segment size only when TCP segmentation is
                                    enabled. This parameter can be a value from 0x0 to 0x3FFF */
        ...
        uint32_t InnerVlanCtrl; /*!< Specifies Inner VLAN Tag insertion control only when Inner VLAN
...
typedef struct
{
        uint32_t SourceAddrControl; /*!< Selects the Source Address Insertion or Replacement
                                       Control. This parameter can be a value of @ref
                                       ETH_Source_Addr_Control */

        FunctionalState ChecksumOffload; /*!< Enables or Disable the checksum checking for received
        ...
        FunctionalState GiantPacketSizeLimitControl; /*!< Enables or disables the Giant Packet Size
                                                        Limit Control. */

        FunctionalState Support2KPacket; /*!< Enables or disables the IEEE 802.3as Support for 2K
                                            length Packets */

        FunctionalState CRCStripTypePacket; /*!< Enables or disables the CRC stripping for Type
                                               packets.*/

        FunctionalState AutomaticPadCRCStrip; /*!< Enables or disables  the Automatic MAC Pad/CRC
                                                 Stripping.*/
        ...
        FunctionalState CarrierSenseBeforeTransmit; /*!< Enables or disables the Carrier Sense
        ...
        FunctionalState CarrierSenseDuringTransmit; /*!< Enables or disables the Carrier Sense
                                                       During Transmission in the Half Duplex mode
                                                     */

        FunctionalState RetryTransmission; /*!< Enables or disables the MAC retry transmission, when
                                              a collision occurs in Half Duplex mode.*/

        uint32_t BackOffLimit; /*!< Selects the BackOff limit value.
                                       This parameter can be a value of @ref ETH_Back_Off_Limit */

        FunctionalState DeferralCheck; /*!< Enables or disables the deferral check function in Half
                                          Duplex mode. */

        uint32_t PreambleLength; /*!< Selects or not the Preamble Length for Transmit packets (Full
                                    Duplex mode). This parameter can be a value of @ref
                                    ETH_Preamble_Length */

        FunctionalState UnicastSlowProtocolPacketDetect; /*!< Enable or disables the Detection of
                                                            Slow Protocol Packets with unicast
                                                            address. */

        FunctionalState SlowProtocolDetect; /*!< Enable or disables the Slow Protocol Detection. */

        FunctionalState CRCCheckingRxPackets; /*!< Enable or disables the CRC Checking for Received
                                                 Packets. */

        uint32_t GiantPacketSizeLimit; /*!< Specifies the packet size that the MAC will declare it
                                          as Giant, If it's size is greater than the value
                                          programmed in this field in units of bytes This parameter
                                          must be a number between Min_Data = 0x618 (1518 byte) and
                                          Max_Data = 0x3FFF (32 Kbyte). */

        FunctionalState ExtendedInterPacketGap; /*!< Enable or disables the extended inter packet
                                                   gap. */

        uint32_t ExtendedInterPacketGapVal; /*!< Sets the Extended IPG between Packet during
                                               transmission. This parameter can be a value from 0x0
                                               to 0xFF */
        ...
        uint32_t PauseTime; /*!< This field holds the value to be used in the Pause Time field in
                               the transmit control packet. This parameter must be a number between
                                                Min_Data = 0x0 and Max_Data = 0xFFFF.*/

        FunctionalState ZeroQuantaPause; /*!< Enable or disables the automatic generation of Zero
                                            Quanta Pause Control packets.*/

        uint32_t PauseLowThreshold; /*!< This field configures the threshold of the PAUSE to be
                                       checked for automatic retransmission of PAUSE Packet. This
                                       parameter can be a value of @ref ETH_Pause_Low_Threshold */

        FunctionalState TransmitFlowControl; /*!< Enables or disables the MAC to transmit Pause
                                                packets in Full Duplex mode or the MAC back pressure
                                                operation in Half Duplex mode */

        FunctionalState UnicastPausePacketDetect; /*!< Enables or disables the MAC to detect Pause
                                                     packets with unicast address of the station */

        FunctionalState ReceiveFlowControl; /*!< Enables or disables the MAC to decodes the received
                                              Pause packet and disables its transmitter for a
        ...
        FunctionalState DropTCPIPChecksumErrorPacket; /*!< Enables or disables Dropping of TCPIP
...
typedef struct
{
        ...
        FunctionalState AddressAlignedBeats; /*!< Enables or disables the AHB Master interface
        ...
        FunctionalState RebuildINCRxBurst; /*!< Enables or disables the AHB Master to rebuild the
        ...
        uint32_t TxDMABurstLength; /*!< Indicates the maximum number of beats to be transferred in
                                      one Tx DMA transaction. This parameter can be a value of @ref
                                      ETH_Tx_DMA_Burst_Length */

        FunctionalState SecondPacketOperate; /*!< Enables or disables the Operate on second Packet
                                                mode, which allows the DMA to process a second
                                                                        Packet of Transmit data even
                                                before obtaining the status for the first one. */

        uint32_t RxDMABurstLength; /*!< Indicates the maximum number of beats to be transferred in
                                      one Rx DMA transaction. This parameter can be a value of @ref
        ...
        uint32_t MaximumSegmentSize; /*!< Sets the maximum segment size that should be used while
                                        segmenting the packet This parameter can be a value from
                                        0x40 to 0x3FFF */
...
typedef struct
{
        ...
        ETH_MediaInterfaceTypeDef MediaInterface; /*!< Selects the MII interface or the RMII
                                                     interface. */

        ETH_DMADescTypeDef* TxDesc; /*!< Provides the address of the first DMA Tx descriptor in the
                                       list */

        ETH_DMADescTypeDef* RxDesc; /*!< Provides the address of the first DMA Rx descriptor in the
                                       list */
...
typedef struct
{
        ...
        uint32_t TimestampChecksumCorrection; /*!< Enable checksum correction during OST for PTP
                                                 over UDP/IPv4 packets */
 ...
 */
typedef void ( *pETH_rxAllocateCallbackTypeDef )( uint8_t** buffer ); /*!< pointer to an ETH Rx Get
                                                                         Buffer Function */
/**
 *
 */
 ...
 */
typedef void ( *pETH_txFreeCallbackTypeDef )( uint32_t* buffer ); /*!< pointer to an ETH Tx Free
                                                                     function */
/**
 *
 */
...
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
{
        ...
        __IO HAL_ETH_StateTypeDef gState; /*!< ETH state information related to global Handle
                                             management and also related to Tx operations. This
                                             parameter can be a value of @ref ETH_State_Codes */
        ...
        __IO uint32_t DMAErrorCode; /*!< Holds the DMA Rx Tx Error code when a DMA AIS interrupt
                                       occurs This parameter can be a combination of
                                                                    @ref ETH_DMA_Status_Flags */

        __IO uint32_t MACErrorCode; /*!< Holds the MAC Rx Tx Error code when a MAC Rx or Tx status
                                       interrupt occurs This parameter can be a combination of
                                                                    @ref ETH_MAC_Rx_Tx_Status */

        __IO uint32_t MACWakeUpEvent; /*!< Holds the Wake Up event when the MAC exit the power down
        ...
        void ( *PMTCallback )( struct __ETH_HandleTypeDef* heth );    /*!< ETH Power Management
                                                                         Callback            */
        ...
        void ( *MspDeInitCallback )( struct __ETH_HandleTypeDef* heth ); /*!< ETH Msp DeInit
                                                                            callback            */
 ...
 */
typedef void ( *pETH_CallbackTypeDef )( ETH_HandleTypeDef* heth ); /*!< pointer to an ETH callback
                                                                      function */
...
typedef struct
{
        ...
        FunctionalState HachOrPerfectFilter; /*!< Enable or Disable Perfect filtering in addition to
                                                Hash filtering */
        ...
        FunctionalState SrcAddrInverseFiltering; /*!< Enable or Disable source address inverse
                                                    filtering */

        FunctionalState DestAddrInverseFiltering; /*!< Enable or Disable destination address inverse
                                                     filtering */
...
typedef struct
{
        FunctionalState WakeUpPacket; /*!< Enable or Disable Wake up packet detection in power down
                                         mode */

        FunctionalState MagicPacket; /*!< Enable or Disable Magic packet detection in power down
                                        mode */

        FunctionalState GlobalUnicast; /*!< Enable or Disable Global unicast packet detection in
                                          power down mode */
...
#define ETH_DMATXNDESCRF_CIC_IPHDR_INSERT \
        0x00010000U /*!< Only IP header checksum calculation and insertion are enabled. */
#define ETH_DMATXNDESCRF_CIC_IPHDR_PAYLOAD_INSERT                                              \
        0x00020000U /*!< IP header checksum and payload checksum calculation and insertion are \
                                  enabled, but pseudo header                                   \
                                  checksum is not                                              \
                                  calculated in hardware */
#define ETH_DMATXNDESCRF_CIC_IPHDR_PAYLOAD_INSERT_PHDR_CALC                                    \
        0x00030000U /*!< IP Header checksum and payload checksum calculation and insertion are \
...
#define ETH_DMATXNDESCWBF_ES                                                                      \
        0x00008000U /*!< Error summary: OR of the following bits: IHE || UF || ED || EC || LCO || \
                       PCE || NC || LCA || FF || JT */
...
#define ETH_DMATXCDESC_IVTIR_REMOVE \
        0x00040000U /*!< Remove the inner VLAN tag from the packets before transmission. */
...
/*
  ...
  ---------------------------------------------------------------------------------------------------------------------
  RDES2 |      MAC Filter Status[31:16]        | VF(15) | Reserved [14:12] | ARP Status [11:10] |
  Header Length [9:0] |
  ---------------------------------------------------------------------------------------------------------------------
  RDES3 | OWN(31) | CTXT(30) |  FD(29) | LD(28) |   Status[27:16]     | ES(15) |        Packet
  Length[14:0]           |
  ---------------------------------------------------------------------------------------------------------------------
*/
...
#define ETH_DMARXNDESCWBF_PMT_PDREQ \
        0x00000500U /*!< PTP Message Type: Pdelay_Req (in peer-to-peer transparent clock)  */
#define ETH_DMARXNDESCWBF_PMT_PDRESP \
        0x00000600U /*!< PTP Message Type: Pdelay_Resp (in peer-to-peer transparent clock)  */
#define ETH_DMARXNDESCWBF_PMT_PDRESPFUP                                                       \
        0x00000700U /*!< PTP Message Type: Pdelay_Resp_Follow_Up (in peer-to-peer transparent \
                       clock)  */
...
#define ETH_DMARXNDESCWBF_L3L4FM                                                                \
        0x20000000U /*!< L3 and L4 Filter Number Matched: if reset filter 0 is matched , if set \
                       filter 1 is matched */
...
#if ( USE_HAL_ETH_REGISTER_CALLBACKS == 1 )
HAL_StatusTypeDef HAL_ETH_RegisterCallback(
...
HAL_StatusTypeDef HAL_ETH_RegisterRxLinkCallback(
    ETH_HandleTypeDef*         heth,
    pETH_rxLinkCallbackTypeDef rxLinkCallback );
HAL_StatusTypeDef HAL_ETH_UnRegisterRxLinkCallback( ETH_HandleTypeDef* heth );
HAL_StatusTypeDef HAL_ETH_GetRxDataErrorCode( ETH_HandleTypeDef const* heth, uint32_t* pErrorCode );
HAL_StatusTypeDef HAL_ETH_RegisterTxFreeCallback(
    ETH_HandleTypeDef*         heth,
...
HAL_StatusTypeDef HAL_ETH_PTP_AddTimeOffset(
    ETH_HandleTypeDef*   heth,
...
HAL_StatusTypeDef
HAL_ETH_Transmit( ETH_HandleTypeDef* heth, ETH_TxPacketConfigTypeDef* pTxConfig, uint32_t Timeout );
HAL_StatusTypeDef
HAL_ETH_Transmit_IT( ETH_HandleTypeDef* heth, ETH_TxPacketConfigTypeDef* pTxConfig );

HAL_StatusTypeDef HAL_ETH_WritePHYRegister(
    ETH_HandleTypeDef const* heth,
    uint32_t                 PHYAddr,
    uint32_t                 PHYReg,
    uint32_t                 RegValue );
...
HAL_StatusTypeDef
HAL_ETH_GetMACConfig( ETH_HandleTypeDef const* heth, ETH_MACConfigTypeDef* macconf );
HAL_StatusTypeDef
HAL_ETH_GetDMAConfig( ETH_HandleTypeDef const* heth, ETH_DMAConfigTypeDef* dmaconf );
...
HAL_StatusTypeDef HAL_ETH_GetMACFilterConfig(
    ETH_HandleTypeDef const*    heth,
    ETH_MACFilterConfigTypeDef* pFilterConfig );
HAL_StatusTypeDef HAL_ETH_SetMACFilterConfig(
    ETH_HandleTypeDef*                heth,
    ETH_MACFilterConfigTypeDef const* pFilterConfig );
HAL_StatusTypeDef HAL_ETH_SetHashTable( ETH_HandleTypeDef* heth, uint32_t* pHashTable );
HAL_StatusTypeDef HAL_ETH_SetSourceMACAddrMatch(
    ETH_HandleTypeDef const* heth,
    uint32_t                 AddrNbr,
    uint8_t const*           pMACAddr );

/* MAC Power Down APIs    *****************************************************/
void HAL_ETH_EnterPowerDownMode(
    ETH_HandleTypeDef*                heth,
    ETH_PowerDownConfigTypeDef const* pPowerDownConfig );
void HAL_ETH_ExitPowerDownMode( ETH_HandleTypeDef* heth );
HAL_StatusTypeDef
HAL_ETH_SetWakeUpFilter( ETH_HandleTypeDef* heth, uint32_t* pFilter, uint32_t Count );
...
HAL_ETH_StateTypeDef HAL_ETH_GetState( ETH_HandleTypeDef const* heth );
uint32_t             HAL_ETH_GetError( ETH_HandleTypeDef const* heth );
uint32_t             HAL_ETH_GetDMAError( ETH_HandleTypeDef const* heth );
uint32_t             HAL_ETH_GetMACError( ETH_HandleTypeDef const* heth );
uint32_t             HAL_ETH_GetMACWakeUpSource( ETH_HandleTypeDef const* heth );
uint32_t             HAL_ETH_GetTxBuffersNumber( ETH_HandleTypeDef const* heth );
/**
 * @}
 */
