...
#endif /* USE_HAL_SRAM_REGISTER_CALLBACKS  */
{
        ...
        void ( *MspInitCallback )( struct __SRAM_HandleTypeDef* hsram ); /*!< SRAM Msp Init callback
                                                                          */
        void ( *MspDeInitCallback )( struct __SRAM_HandleTypeDef* hsram ); /*!< SRAM Msp DeInit
                                                                              callback            */
        void ( *DmaXferCpltCallback )( DMA_HandleTypeDef* hdma );  /*!< SRAM DMA Xfer Complete
                                                                      callback     */
...
HAL_StatusTypeDef HAL_SRAM_RegisterCallback(
    SRAM_HandleTypeDef*        hsram,
...
HAL_StatusTypeDef HAL_SRAM_RegisterDmaCallback(
    SRAM_HandleTypeDef*        hsram,
    HAL_SRAM_CallbackIDTypeDef CallbackId,
...
HAL_SRAM_StateTypeDef HAL_SRAM_GetState( SRAM_HandleTypeDef const* hsram );
