...
typedef struct
{
        ...
        uint32_t ProcedureOnGoing; /*!< Internal variable to indicate which procedure is ongoing or
                                      not in IT context */
...
#if defined( FLASH_SR_OBKERR )
#define FLASH_IT_ALL                                                                              \
        ( FLASH_IT_EOP | FLASH_IT_WRPERR | FLASH_IT_PGSERR | FLASH_IT_STRBERR | FLASH_IT_INCERR | \
          FLASH_IT_OBKERR | FLASH_IT_OBKWERR | FLASH_IT_OPTCHANGEERR |                            \
                ...
                if ( ( ( __FLAG__ ) & ~( FLASH_FLAG_ECCR_ERRORS | FLASH_FLAG_OPTCHANGEERR ) ) != \
                     0U ) {                                                                      \
                        WRITE_REG(                                                               \
                            FLASH->SECCCR,                                                       \
                            ( ( __FLAG__ ) &                                                     \
                              ~( FLASH_FLAG_ECCR_ERRORS | FLASH_FLAG_OPTCHANGEERR ) ) );         \
                }                                                                                \
        } while ( 0 )
