 ...
 *         @arg @ref LL_FMAC_WM_3_THRESHOLD_8
 */
__STATIC_INLINE uint32_t LL_FMAC_GetX1FullWatermark( FMAC_TypeDef const* FMACx )
{
 ...
 * @param  FMACx FMAC instance
 * @param  BufferSize Number of 16-bit words allocated to the input buffer (including the optional
 * "headroom"). This parameter must be a number between Min_Data=0x01 and Max_Data=0xFF.
 * @retval None
 */
 ...
 *                 (including the optional "headroom") (value between Min_Data=0x01 and
 * Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetX1BufferSize( FMAC_TypeDef const* FMACx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_FMAC_GetX1Base( FMAC_TypeDef const* FMACx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_FMAC_GetX2BufferSize( FMAC_TypeDef const* FMACx )
{
 ...
 *                      (value between Min_Data=0x00 and Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetX2Base( FMAC_TypeDef const* FMACx )
{
 ...
 *         @arg @ref LL_FMAC_WM_3_THRESHOLD_8
 */
__STATIC_INLINE uint32_t LL_FMAC_GetYEmptyWatermark( FMAC_TypeDef const* FMACx )
{
 ...
 * @param  FMACx FMAC instance
 * @param  BufferSize Number of 16-bit words allocated to the output buffer (including the optional
 * "headroom"). This parameter must be a number between Min_Data=0x01 and Max_Data=0xFF.
 * @retval None
 */
 ...
 * Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetYBufferSize( FMAC_TypeDef const* FMACx )
{
...
{
        MODIFY_REG(
            FMACx->YBUFCFG, FMAC_YBUFCFG_Y_BASE, ( (uint32_t) Base ) << FMAC_YBUFCFG_Y_BASE_Pos );
}
 ...
 *                      (value between Min_Data=0x00 and Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetYBase( FMAC_TypeDef const* FMACx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledStart( FMAC_TypeDef const* FMACx )
{
        return (
            ( READ_BIT( FMACx->PARAM, FMAC_PARAM_START ) == ( FMAC_PARAM_START ) ) ? 1UL : 0UL );
}
 ...
 *         @arg @ref LL_FMAC_FUNC_IIR_DIRECT_FORM_1
 */
__STATIC_INLINE uint32_t LL_FMAC_GetFunction( FMAC_TypeDef const* FMACx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_FMAC_GetParamR( FMAC_TypeDef const* FMACx )
{
 ...
 * @param  FMACx FMAC instance
 * @retval uint8_t Parameter Q (vector length, etc.) (value between Min_Data=0x00 and
 * Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetParamQ( FMAC_TypeDef const* FMACx )
{
 ...
 *                 (value between Min_Data=0x00 and Max_Data=0xFF).
 */
__STATIC_INLINE uint8_t LL_FMAC_GetParamP( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledReset( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledClipping( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledDMAReq_WRITE( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledDMAReq_READ( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledIT_SAT( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledIT_UNFL( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledIT_OVFL( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledIT_WR( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsEnabledIT_RD( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsActiveFlag_SAT( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsActiveFlag_UNFL( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsActiveFlag_OVFL( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsActiveFlag_X1FULL( FMAC_TypeDef const* FMACx )
{
 ...
 * @retval uint32_t State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_FMAC_IsActiveFlag_YEMPTY( FMAC_TypeDef const* FMACx )
{
 ...
 * @param  FMACx FMAC instance
 * @retval uint16_t 16-bit output data of FMAC processing (value between Min_Data=0x0000 and
 * Max_Data=0xFFFF).
 */
__STATIC_INLINE uint16_t LL_FMAC_ReadData( FMAC_TypeDef const* FMACx )
{
...
LL_FMAC_ConfigX1( FMAC_TypeDef* FMACx, uint32_t Watermark, uint8_t Base, uint8_t BufferSize )
{
        MODIFY_REG(
            FMACx->X1BUFCFG,
            FMAC_X1BUFCFG_FULL_WM | FMAC_X1BUFCFG_X1_BASE | FMAC_X1BUFCFG_X1_BUF_SIZE,
 ...
 */
__STATIC_INLINE void
LL_FMAC_ConfigY( FMAC_TypeDef* FMACx, uint32_t Watermark, uint8_t Base, uint8_t BufferSize )
{
        MODIFY_REG(
            FMACx->YBUFCFG,
            FMAC_YBUFCFG_EMPTY_WM | FMAC_YBUFCFG_Y_BASE | FMAC_YBUFCFG_Y_BUF_SIZE,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FMAC_ConfigFunc(
    FMAC_TypeDef* FMACx,
    uint8_t       Start,
    uint32_t      Function,
    uint8_t       ParamP,
    ...
    uint8_t       ParamR )
{
        MODIFY_REG(
            FMACx->PARAM,
            FMAC_PARAM_START | FMAC_PARAM_FUNC | FMAC_PARAM_P | FMAC_PARAM_Q | FMAC_PARAM_R,
...
ErrorStatus LL_FMAC_DeInit( FMAC_TypeDef const* FMACx );
