...
typedef struct
{
        ...
        uint32_t BlkHWRequest; /*!< Specifies the Block hardware request mode for DMA channel.
                                    Block Hardware request feature can be used only with dedicated
                                  peripherals. This parameter can be a value of @ref
                                  DMA_Block_Request                        */
        ...
        uint32_t SrcBurstLength; /*!< Specifies the source burst length (number of beats within a
                                    burst) for the DMA channel. This parameter can be a value
                                    between 1 and 64                                 */

        uint32_t DestBurstLength; /*!< Specifies the destination burst length (number of beats
                                     within a burst) for the DMA channel. This parameter can be a
...
typedef struct
{
        ...
        uint32_t LinkAllocatedPort; /*!< Specifies the linked-list allocated port for the DMA
...
typedef struct __DMA_HandleTypeDef
{
        ...
        void ( *XferCpltCallback )( struct __DMA_HandleTypeDef* hdma ); /*!< DMA transfer complete
                                                                           callback          */

        void ( *XferHalfCpltCallback )( struct __DMA_HandleTypeDef* hdma ); /*!< DMA half transfer
                                                                               complete callback */

        void ( *XferErrorCallback )( struct __DMA_HandleTypeDef* hdma ); /*!< DMA transfer error
                                                                            callback             */

        void ( *XferAbortCallback )( struct __DMA_HandleTypeDef* hdma ); /*!< DMA transfer Abort
                                                                            callback             */

        void ( *XferSuspendCallback )( struct __DMA_HandleTypeDef* hdma ); /*!< DMA transfer Suspend
                                                                              callback           */
...
#define DMA_TCEM_REPEATED_BLOCK_TRANSFER                                                \
        DMA_CTR2_TCEM_0 /*!< The TC event is generated at the end of the repeated block \
                             and the HT event is generated at the half of the repeated  \
                             block                                                   */
#define DMA_TCEM_EACH_LL_ITEM_TRANSFER                                                \
        DMA_CTR2_TCEM_1 /*!< The TC event is generated at the end of each linked-list \
...
#define DMA_CHANNEL_DEST_SEC \
        ( DMA_CHANNEL_ATTR_SEC_DEST_MASK | 0x08U ) /*!< Channel destination is secure     */
...
#define IS_DMA_DIRECTION( DIRECTION )                  \
        ( ( ( DIRECTION ) == DMA_PERIPH_TO_MEMORY ) || \
          ( ( DIRECTION ) == DMA_MEMORY_TO_PERIPH ) || ( ( DIRECTION ) == DMA_MEMORY_TO_MEMORY ) )
...
#define IS_DMA_SOURCE_DATA_WIDTH( WIDTH )            \
        ( ( ( WIDTH ) == DMA_SRC_DATAWIDTH_BYTE ) || \
          ( ( WIDTH ) == DMA_SRC_DATAWIDTH_HALFWORD ) || ( ( WIDTH ) == DMA_SRC_DATAWIDTH_WORD ) )
