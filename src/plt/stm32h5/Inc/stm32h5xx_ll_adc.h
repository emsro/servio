...
#define VREFINT_CAL_ADDR                                                                 \
        ( (const uint16_t*) ( 0x08FFF810UL ) ) /* Internal voltage reference, address of \
...
#define TEMPSENSOR_CAL1_ADDR                                                    \
        ( (const uint16_t*) ( 0x08FFF814UL ) ) /* Address of parameter TS_CAL1: \
            temperature sensor ADC raw data acquired at temperature  30 DegC    \
            (tolerance: +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                    \
        ( (const uint16_t*) ( 0x08FFF818UL ) ) /* Address of parameter TS_CAL2: \
...
typedef struct
{
        uint32_t CommonClock; /*!< Set parameter common to several ADC: Clock source and prescaler.
                                 ...
                                 clock ratio constraints between ADC clock and AHB clock must be
                                 respected. Refer to reference manual. This feature can be modified
        ...
        uint32_t Multimode; /*!< Set ADC multimode configuration to operate in independent mode or
                               ...
                               can be a value of @ref ADC_LL_EC_MULTI_MODE This feature can be
                               modified afterwards using unitary function
                                 @ref LL_ADC_SetMultimode(). */

        uint32_t MultiDMATransfer; /*!< Set ADC multimode conversion data transfer: no transfer or
                                      transfer by DMA. This parameter can be a value of @ref
                                      ADC_LL_EC_MULTI_DMA_TRANSFER This feature can be modified
                                      afterwards using unitary function
                                        @ref LL_ADC_SetMultiDMATransfer(). */

        uint32_t MultiTwoSamplingDelay; /*!< Set ADC multimode delay between 2 sampling phases.
                                             This parameter can be a value of @ref
                                           ADC_LL_EC_MULTI_TWOSMP_DELAY This feature can be modified
                                           afterwards using unitary function
...
typedef struct
{
        uint32_t TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW
                                   ...
                                   for compatibility with some ADC on other STM32 series having this
                                   setting set by HW default value). In case of need to modify
                                   trigger edge, use function
        ...
        uint32_t SequencerLength; /*!< Set ADC group regular sequencer length.
                                       This parameter can be a value of @ref
                                     ADC_LL_EC_REG_SEQ_SCAN_LENGTH This feature can be modified
                                     afterwards using unitary function
        ...
        uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode: sequence
                                      ...
                                      sequencer is enabled (scan length of 2 ranks or more). This
        ...
        uint32_t DMATransfer; /*!< Set ADC group regular conversion data transfer: no transfer or
                                 transfer by DMA, and DMA requests mode. This parameter can be a
                                 value of @ref ADC_LL_EC_REG_DMA_TRANSFER This feature can be
                                 modified afterwards using unitary function
...
typedef struct
{
        ...
        uint32_t SequencerLength; /*!< Set ADC group injected sequencer length.
                                       This parameter can be a value of @ref
                                     ADC_LL_EC_INJ_SEQ_SCAN_LENGTH This feature can be modified
                                     afterwards using unitary function
        ...
        uint32_t TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC
                              ...
                              trigger. This feature can be modified afterwards using unitary
                              function
...
#define LL_ADC_CHANNEL_0                                                                       \
        ( ADC_CHANNEL_0_NUMBER | ADC_CHANNEL_0_SMP | ADC_CHANNEL_0_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN0 */
#define LL_ADC_CHANNEL_1                                                                       \
        ( ADC_CHANNEL_1_NUMBER | ADC_CHANNEL_1_SMP | ADC_CHANNEL_1_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN1 */
#define LL_ADC_CHANNEL_2                                                                       \
        ( ADC_CHANNEL_2_NUMBER | ADC_CHANNEL_2_SMP | ADC_CHANNEL_2_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN2 */
#define LL_ADC_CHANNEL_3                                                                       \
        ( ADC_CHANNEL_3_NUMBER | ADC_CHANNEL_3_SMP | ADC_CHANNEL_3_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN3 */
#define LL_ADC_CHANNEL_4                                                                       \
        ( ADC_CHANNEL_4_NUMBER | ADC_CHANNEL_4_SMP | ADC_CHANNEL_4_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN4 */
#define LL_ADC_CHANNEL_5                                                                       \
        ( ADC_CHANNEL_5_NUMBER | ADC_CHANNEL_5_SMP | ADC_CHANNEL_5_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN5 */
#define LL_ADC_CHANNEL_6                                                                       \
        ( ADC_CHANNEL_6_NUMBER | ADC_CHANNEL_6_SMP | ADC_CHANNEL_6_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN6 */
#define LL_ADC_CHANNEL_7                                                                       \
        ( ADC_CHANNEL_7_NUMBER | ADC_CHANNEL_7_SMP | ADC_CHANNEL_7_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN7 */
#define LL_ADC_CHANNEL_8                                                                       \
        ( ADC_CHANNEL_8_NUMBER | ADC_CHANNEL_8_SMP | ADC_CHANNEL_8_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN8 */
#define LL_ADC_CHANNEL_9                                                                       \
        ( ADC_CHANNEL_9_NUMBER | ADC_CHANNEL_9_SMP | ADC_CHANNEL_9_BITFIELD ) /*!< ADC channel \
                                                                                 ADCx_IN9 */
#define LL_ADC_CHANNEL_10                                                                         \
        ( ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP | ADC_CHANNEL_10_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN10 */
#define LL_ADC_CHANNEL_11                                                                         \
        ( ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP | ADC_CHANNEL_11_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN11 */
#define LL_ADC_CHANNEL_12                                                                         \
        ( ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP | ADC_CHANNEL_12_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN12 */
#define LL_ADC_CHANNEL_13                                                                         \
        ( ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP | ADC_CHANNEL_13_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN13 */
#define LL_ADC_CHANNEL_14                                                                         \
        ( ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP | ADC_CHANNEL_14_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN14 */
#define LL_ADC_CHANNEL_15                                                                         \
        ( ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP | ADC_CHANNEL_15_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN15 */
#define LL_ADC_CHANNEL_16                                                                         \
        ( ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP | ADC_CHANNEL_16_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN16 */
#define LL_ADC_CHANNEL_17                                                                         \
        ( ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP | ADC_CHANNEL_17_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN17 */
#define LL_ADC_CHANNEL_18                                                                         \
        ( ADC_CHANNEL_18_NUMBER | ADC_CHANNEL_18_SMP | ADC_CHANNEL_18_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN18 */
#define LL_ADC_CHANNEL_19                                                                         \
        ( ADC_CHANNEL_19_NUMBER | ADC_CHANNEL_19_SMP | ADC_CHANNEL_19_BITFIELD ) /*!< ADC channel \
                                                                                    ADCx_IN19 */
#if defined( ADC2 )
...
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                               \
        ( ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group   \
                            regular conversion trigger from external peripheral: TIM2 channel 2    \
...
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                          \
        ( ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                            regular conversion trigger from external peripheral: external        \
                            interrupt line 11 event. Trigger edge set to rising edge (default    \
                            setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO                                                             \
        ( ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group  \
                            regular conversion trigger from external peripheral: TIM1 TRGO event. \
                            Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                                             \
        ( ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group   \
                            regular conversion trigger from external peripheral: TIM1 TRGO2 event. \
                            Trigger edge set to rising edge (default setting). */
...
#define LL_ADC_REG_TRIG_EXT_LPTIM1_CH1                                                             \
        ( ADC_CFGR_EXTSEL_4 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group   \
                            regular conversion trigger from external peripheral: LPTIM2 OUT event. \
                            Trigger edge set to rising edge (default setting). */
...
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                                               \
        ( ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group   \
                            regular conversion trigger from external peripheral: TIM4 channel 4    \
                            event (capture compare: input capture or output capture). Trigger edge \
                            set to rising edge (default setting). Specific to devices:             \
                            STM32H563/H573xx. */
...
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                                             \
        ( ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group  \
                            regular conversion trigger from external peripheral: TIM4 TRGO event. \
                            Trigger edge set to rising edge (default setting).                    \
                            Specific to devices: STM32H563/H573xx. */
...
#define LL_ADC_REG_TRIG_EXT_TIM7_TRGO                                                             \
        ( ADC_CFGR_EXTSEL_4 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group  \
                            regular conversion trigger from external peripheral: TIM7 TRGO event. \
                            Trigger edge set to rising edge (default setting).                    \
...
/** @defgroup ADC_LL_EC_SAMPLINGTIME_COMMON_CONFIG ADC instance - ADC sampling time common
 * configuration
 * @{
 */
...
#define LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS                                                        \
        ( ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1 | ADC_SQR1_L_0 ) /*!< ADC group regular      \
                                                                         sequencer enable with 16 \
...
#define LL_ADC_REG_SEQ_DISCONT_4RANKS                                                              \
        ( ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN ) /*!< ADC group regular       \
                            sequencer discontinuous mode enable with sequence interruption every 4 \
                            ranks */
...
#define LL_ADC_REG_SEQ_DISCONT_6RANKS                                                              \
        ( ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN ) /*!< ADC group regular       \
                            sequencer discontinuous mode enable with sequence interruption every 6 \
                            ranks */
#define LL_ADC_REG_SEQ_DISCONT_7RANKS                                                              \
        ( ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCEN ) /*!< ADC group regular       \
                            sequencer discontinuous mode enable with sequence interruption every 7 \
                            ranks */
...
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                               \
        ( ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM2 channel 1 \
                              event (capture compare: input capture or output capture). Trigger    \
...
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                            \
        ( ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: external       \
                              interrupt line 15. Trigger edge set to rising edge (default          \
                              setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO                                                              \
        ( ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM3 TRGO      \
...
#define LL_ADC_INJ_TRIG_EXT_LPTIM1_CH1                                                             \
        ( ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: LPTIM1 channel \
                              1 event. Trigger edge set to rising edge (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                                              \
        ( ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM4 TRGO      \
                              event. Trigger edge set to rising edge (default setting). Specific   \
                              to devices: STM32H563/H573xx. */
...
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO                                                              \
        ( ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM12 TRGO     \
                              event. Trigger edge set to rising edge (default setting). Specific   \
                              to devices: STM32H563/H573xx. */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2                                                             \
        ( ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM9 TRGO      \
                              event. Trigger edge set to rising edge (default setting). Specific   \
                              to devices: STM32H563/H573xx. */
...
#define LL_ADC_INJ_TRIG_EXT_TIM7_TRGO                                                              \
        ( ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT ) /*!< ADC group \
                              injected conversion trigger from external peripheral: TIM7 TRGO      \
                              event. Trigger edge set to rising edge (default setting). */
#endif /* Devices STM32H563/H573xx or STM32H503xx */
/**
 * @}
...
#define LL_ADC_INJ_RANK_1                                                                        \
        ( ADC_JDR1_REGOFFSET | ADC_INJ_RANK_1_JSQR_BITOFFSET_POS ) /*!< ADC group inj. sequencer \
                                                                      rank 1 */
#define LL_ADC_INJ_RANK_2                                                                        \
        ( ADC_JDR2_REGOFFSET | ADC_INJ_RANK_2_JSQR_BITOFFSET_POS ) /*!< ADC group inj. sequencer \
                                                                      rank 2 */
#define LL_ADC_INJ_RANK_3                                                                        \
        ( ADC_JDR3_REGOFFSET | ADC_INJ_RANK_3_JSQR_BITOFFSET_POS ) /*!< ADC group inj. sequencer \
                                                                      rank 3 */
#define LL_ADC_INJ_RANK_4                                                                        \
        ( ADC_JDR4_REGOFFSET | ADC_INJ_RANK_4_JSQR_BITOFFSET_POS ) /*!< ADC group inj. sequencer \
                                                                      rank 4 */
/**
 * @}
 */
...
#define LL_ADC_SAMPLINGTIME_640CYCLES_5                                                            \
        ( ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 | ADC_SMPR2_SMP10_0 ) /*!< Sampling time 640.5 ADC \
                                                                         clock cycles */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_REG_INJ                                                         \
        ( ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN ) /*!< ADC analog      \
                                 watchdog monitoring of all channels, converted by either group \
                                 regular or injected */
#define LL_ADC_AWD_CHANNEL_0_REG                                                                 \
        ( ( LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK ) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL ) /*!< \
                                                  ADC analog watchdog monitoring of ADC channel  \
...
#define LL_ADC_AWD_CHANNEL_14_INJ                                                                  \
        ( ( LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK ) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL ) /*!< \
                                                    ADC analog watchdog monitoring of ADC channel  \
                                                    ADCx_IN14, converted by group only */
...
#define LL_ADC_AWD_CHANNEL_19_REG                                                                 \
        ( ( LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK ) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL ) /*!< \
                                                   ADC analog watchdog monitoring of ADC channel  \
                                                   ADCx_IN19, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_19_INJ                                                                  \
        ( ( LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK ) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL ) /*!< \
                                                    ADC analog watchdog monitoring of ADC channel  \
                                                    ADCx_IN19, converted by group injected only */
...
#define LL_ADC_AWD_FILTERING_8SAMPLES                                                            \
        ( ADC_TR1_AWDFILT_2 | ADC_TR1_AWDFILT_1 | ADC_TR1_AWDFILT_0 ) /*!< ADC analog watchdog 8 \
                             consecutives out-of-window samples are needed to raise flag or      \
                             interrupt */
/**
 * @}
 */
...
#define LL_ADC_OVS_RATIO_256                                                                      \
        ( ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_1 | ADC_CFGR2_OVSR_0 ) /*!< ADC oversampling ratio of \
                            256 (sum of conversions data computed to result as oversampling       \
...
#define LL_ADC_OVS_SHIFT_RIGHT_7                                                               \
        ( ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_1 | ADC_CFGR2_OVSS_0 ) /*!< ADC oversampling right \
                            shift of 7 (sum of the ADC conversions data (after OVS ratio) is   \
                            divided by 128 to result as oversampling conversion data) */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES                                                        \
        ( ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0 ) /*!< ADC multimode delay between \
                           two sampling phases: 8 ADC clock cycles */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_12CYCLES                                                       \
        ( ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0 ) /*!< ADC multimode delay between \
                           two sampling phases: 12 ADC clock cycles */
/**
 * @}
 */
 ...
 *         (3) On STM32H5, fast channel allows: 2.5 (sampling) + 12.5 (conversion 12b) = 15 ADC
 * clock cycles (fADC) Other channels are slow channels: 6.5 (sampling) + 12.5 (conversion 12b) = 19
 * ADC clock cycles (fADC)
 ...
 *         (3) On STM32H5, fast channel allows: 2.5 (sampling) + 12.5 (conversion 12b) = 15 ADC
 * clock cycles (fADC) Other channels are slow channels: 6.5 (sampling) + 12.5 (conversion 12b) = 19
 * ADC clock cycles (fADC) (4) For ADC channel read back from ADC register, comparison with internal
 * channel parameter to be done using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
 */
...
/**
  ...
  *         (3) On STM32H5, fast channel allows: 2.5 (sampling) + 12.5 (conversion 12b) = 15 ADC
  clock cycles (fADC)
  *             Other channels are slow channels: 6.5 (sampling) + 12.5 (conversion 12b) = 19 ADC
  clock cycles (fADC)
  ...
  *         Value "1" if the channel corresponds to a parameter definition of a ADC internal
  channel.
  */
...
#define __LL_ADC_ANALOGWD_GET_THRESHOLD_RESOLUTION( \
    __ADC_RESOLUTION__, __AWD_THRESHOLD_12_BITS__ ) \
...
#define __LL_ADC_MULTI_CONV_DATA_MASTER_SLAVE(                                  \
    __ADC_MULTI_MASTER_SLAVE__, __ADC_MULTI_CONV_DATA__ )                       \
...
#define __LL_ADC_CALC_DIFF_DATA_TO_VOLTAGE(                                             \
    __VREFANALOG_VOLTAGE__, __ADC_DATA__, __ADC_RESOLUTION__ )                          \
 ...
 *         In case or error, value LL_ADC_TEMPERATURE_CALC_ERROR is returned (inconsistent
 * temperature value)
 */
 ...
 * value (unit: uV/DegCelsius). On STM32H5, refer to device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature sensor voltage typical
 * value (at temperature and Vref+ defined in parameters below) (unit: mV). On this STM32 series,
 * refer to datasheet parameter "V30" (corresponding to TS_CAL1).
 ...
 */
#if defined( ADC_MULTIMODE_SUPPORT )
__STATIC_INLINE uint32_t LL_ADC_DMA_GetRegAddr( ADC_TypeDef const* ADCx, uint32_t Register )
{
 ...
 *         @arg @ref LL_ADC_CLOCK_ASYNC_DIV256
 */
__STATIC_INLINE uint32_t LL_ADC_GetCommonClock( ADC_Common_TypeDef const* ADCxy_COMMON )
{
...
{
        MODIFY_REG(
            ADCxy_COMMON->CCR, ADC_CCR_VREFEN | ADC_CCR_TSEN | ADC_CCR_VBATEN, PathInternal );
}
 ...
 *         @arg @ref LL_ADC_PATH_INTERNAL_VBAT
 */
__STATIC_INLINE uint32_t LL_ADC_GetCommonPathInternalCh( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (uint32_t) ( READ_BIT(
            ADCxy_COMMON->CCR, ADC_CCR_VREFEN | ADC_CCR_TSEN | ADC_CCR_VBATEN ) );
}
 ...
 * @note   On this STM32 series, Channel 0 channel connection to GPIO is controlled via specific
 * register.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_EnableChannel0_GPIO( ADC_TypeDef const* ADCx )
{
        /* Prevent unused argument(s) compilation warning */
        (void) ( ADCx );
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_DisableChannel0_GPIO( ADC_TypeDef const* ADCx )
{
        /* Prevent unused argument(s) compilation warning */
        (void) ( ADCx );
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_GetCalibrationFactor( ADC_TypeDef const* ADCx, uint32_t SingleDiff )
{
 ...
 *         @arg @ref LL_ADC_RESOLUTION_6B
 */
__STATIC_INLINE uint32_t LL_ADC_GetResolution( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_DATA_ALIGN_LEFT
 */
__STATIC_INLINE uint32_t LL_ADC_GetDataAlignment( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_LP_AUTOWAIT
 */
__STATIC_INLINE uint32_t LL_ADC_GetLowPowerMode( ADC_TypeDef const* ADCx )
{
 ...
 * channel parameter to be done using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
 */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetChannel( ADC_TypeDef const* ADCx, uint32_t Offsety )
{
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
 */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetLevel( ADC_TypeDef const* ADCx, uint32_t Offsety )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET( ADCx->OFR1, Offsety );
 ...
 *         @arg @ref LL_ADC_OFFSET_ENABLE
 */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetState( ADC_TypeDef const* ADCx, uint32_t Offsety )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET( ADCx->OFR1, Offsety );
 ...
 *         @arg @ref LL_ADC_OFFSET_SIGN_POSITIVE
 */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetSign( ADC_TypeDef const* ADCx, uint32_t Offsety )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET( ADCx->OFR1, Offsety );
 ...
 *         @arg @ref LL_ADC_OFFSET_SATURATION_DISABLE
 */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetSaturation( ADC_TypeDef const* ADCx, uint32_t Offsety )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET( ADCx->OFR1, Offsety );
 ...
 *         @arg @ref LL_ADC_SAMPLINGTIME_COMMON_3C5_REPL_2C5
 */
__STATIC_INLINE uint32_t LL_ADC_GetSamplingTimeCommonConfig( ADC_TypeDef const* ADCx )
{
 ...
 *         (2) On STM32H5 series, parameter specific to devices: STM32H503xx.
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_REG_IsTriggerSourceSWStart( ADC_TypeDef const* ADCx )
{
        return (
            ( READ_BIT( ADCx->CFGR, ADC_CFGR_EXTEN ) ==
 ...
 *         @arg @ref LL_ADC_REG_TRIG_EXT_RISINGFALLING
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerEdge( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_REG_SAMPLING_MODE_TRIGGER_CONTROLED
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSamplingMode( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerLength( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_REG_SEQ_DISCONT_8RANKS
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerDiscont( ADC_TypeDef const* ADCx )
{
 ...
 * channel parameter to be done using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerRanks( ADC_TypeDef const* ADCx, uint32_t Rank )
{
 ...
 *         @arg @ref LL_ADC_REG_CONV_CONTINUOUS
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetContinuousMode( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_REG_DMA_TRANSFER_UNLIMITED
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetDMATransfer( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_REG_OVR_DATA_OVERWRITTEN
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetOverrun( ADC_TypeDef const* ADCx )
{
 ...
 *         (2) On STM32H5 series, parameter specific to devices: STM32H503xx.
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource( ADC_TypeDef const* ADCx )
{
...
/**
  ...
  *         Value "1" if trigger source SW start.
  */
__STATIC_INLINE uint32_t LL_ADC_INJ_IsTriggerSourceSWStart( ADC_TypeDef const* ADCx )
{
        return (
            ( READ_BIT( ADCx->JSQR, ADC_JSQR_JEXTEN ) ==
 ...
 *         @arg @ref LL_ADC_INJ_TRIG_EXT_RISINGFALLING
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerEdge( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_INJ_SEQ_SCAN_ENABLE_4RANKS
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetSequencerLength( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_INJ_SEQ_DISCONT_1RANK
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetSequencerDiscont( ADC_TypeDef const* ADCx )
{
 ...
 * channel parameter to be done using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetSequencerRanks( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        return (
            uint32_t) ( ( READ_BIT(
                              ADCx->JSQR,
 ...
 *         @arg @ref LL_ADC_INJ_TRIG_FROM_GRP_REGULAR
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTrigAuto( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_INJ_QUEUE_2CONTEXTS_END_EMPTY
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_GetQueueMode( ADC_TypeDef const* ADCx )
{
 ...
 *             Refer to function @ref LL_ADC_SetSamplingTimeCommonConfig().
 */
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime( ADC_TypeDef const* ADCx, uint32_t Channel )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->SMPR1,
            ( ( Channel & ADC_CHANNEL_SMPRX_REGOFFSET_MASK ) >> ADC_SMPRX_REGOFFSET_POS ) );
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_GetChannelSingleDiff( ADC_TypeDef const* ADCx, uint32_t Channel )
{
 ...
 *         (0) On STM32H5, parameter available only on analog watchdog number: AWD1.
 */
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDMonitChannels( ADC_TypeDef const* ADCx, uint32_t AWDy )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->CFGR,
            ( ( AWDy & ADC_AWD_CRX_REGOFFSET_MASK ) >> ADC_AWD_CRX_REGOFFSET_POS ) +
...
LL_ADC_GetAWDFilteringConfiguration( ADC_TypeDef const* ADCx, uint32_t AWDy )
{
        /* Prevent unused argument(s) compilation warning */
        (void) ( AWDy );
 ...
 *         @arg @ref LL_ADC_OVS_GRP_INJ_REG_RESUMED
 */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingScope( ADC_TypeDef const* ADCx )
{
        return (uint32_t) ( READ_BIT(
 ...
 *         @arg @ref LL_ADC_OVS_REG_DISCONT
 */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingDiscont( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_OVS_RATIO_256
 */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingRatio( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_OVS_SHIFT_RIGHT_8
 */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingShift( ADC_TypeDef const* ADCx )
{
 ...
 *         @arg @ref LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM
 */
__STATIC_INLINE uint32_t LL_ADC_GetMultimode( ADC_Common_TypeDef const* ADCxy_COMMON )
{
 ...
 *         @arg @ref LL_ADC_MULTI_REG_DMA_UNLMT_RES8_6B
 */
__STATIC_INLINE uint32_t LL_ADC_GetMultiDMATransfer( ADC_Common_TypeDef const* ADCxy_COMMON )
{
 ...
 *         (3) Parameter available only if ADC resolution is 12 bits.
 */
__STATIC_INLINE uint32_t LL_ADC_GetMultiTwoSamplingDelay( ADC_Common_TypeDef const* ADCxy_COMMON )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsDeepPowerDownEnabled( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsInternalRegulatorEnabled( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabled( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsDisableOngoing( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsCalibrationOnGoing( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_REG_IsConversionOngoing( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_REG_IsStopConversionOngoing( ADC_TypeDef const* ADCx )
{
 ...
 * @retval Value between Min_Data=0x00000000 and Max_Data=0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_ADC_REG_ReadConversionData32( ADC_TypeDef const* ADCx )
{
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
 */
__STATIC_INLINE uint16_t LL_ADC_REG_ReadConversionData12( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint16_t LL_ADC_REG_ReadConversionData10( ADC_TypeDef const* ADCx )
{
        return (uint16_t) ( READ_BIT( ADCx->DR, ADC_DR_RDATA ) );
}
 ...
 */
__STATIC_INLINE uint8_t LL_ADC_REG_ReadConversionData8( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint8_t LL_ADC_REG_ReadConversionData6( ADC_TypeDef const* ADCx )
{
        return (uint8_t) ( READ_BIT( ADCx->DR, ADC_DR_RDATA ) );
}
...
__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(
    ADC_Common_TypeDef const* ADCxy_COMMON,
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_IsConversionOngoing( ADC_TypeDef const* ADCx )
{
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_IsStopConversionOngoing( ADC_TypeDef const* ADCx )
{
 ...
 * @retval Value between Min_Data=0x00000000 and Max_Data=0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_ADC_INJ_ReadConversionData32( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
 */
__STATIC_INLINE uint16_t LL_ADC_INJ_ReadConversionData12( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->JDR1, ( ( Rank & ADC_INJ_JDRX_REGOFFSET_MASK ) >> ADC_JDRX_REGOFFSET_POS ) );
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0x3FF
 */
__STATIC_INLINE uint16_t LL_ADC_INJ_ReadConversionData10( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->JDR1, ( ( Rank & ADC_INJ_JDRX_REGOFFSET_MASK ) >> ADC_JDRX_REGOFFSET_POS ) );
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0xFF
 */
__STATIC_INLINE uint8_t LL_ADC_INJ_ReadConversionData8( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->JDR1, ( ( Rank & ADC_INJ_JDRX_REGOFFSET_MASK ) >> ADC_JDRX_REGOFFSET_POS ) );
 ...
 * @retval Value between Min_Data=0x00 and Max_Data=0x3F
 */
__STATIC_INLINE uint8_t LL_ADC_INJ_ReadConversionData6( ADC_TypeDef const* ADCx, uint32_t Rank )
{
        const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
            ADCx->JDR1, ( ( Rank & ADC_INJ_JDRX_REGOFFSET_MASK ) >> ADC_JDRX_REGOFFSET_POS ) );
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_ADRDY( ADC_TypeDef const* ADCx )
{
        return (
            ( READ_BIT( ADCx->ISR, LL_ADC_FLAG_ADRDY ) == ( LL_ADC_FLAG_ADRDY ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_EOC( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_EOS( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_OVR( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_EOSMP( ADC_TypeDef const* ADCx )
{
        return (
            ( READ_BIT( ADCx->ISR, LL_ADC_FLAG_EOSMP ) == ( LL_ADC_FLAG_EOSMP ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_JEOC( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_JEOS( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_JQOVF( ADC_TypeDef const* ADCx )
{
        return (
            ( READ_BIT( ADCx->ISR, LL_ADC_FLAG_JQOVF ) == ( LL_ADC_FLAG_JQOVF ) ) ? 1UL : 0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_AWD1( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_AWD2( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_AWD3( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_ADRDY( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_ADRDY_MST ) == ( LL_ADC_FLAG_ADRDY_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_ADRDY( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_ADRDY_SLV ) == ( LL_ADC_FLAG_ADRDY_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOC( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOC_SLV ) == ( LL_ADC_FLAG_EOC_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOC( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOC_SLV ) == ( LL_ADC_FLAG_EOC_SLV ) ) ?
                1UL :
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOS( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOS_MST ) == ( LL_ADC_FLAG_EOS_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOS( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOS_SLV ) == ( LL_ADC_FLAG_EOS_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_OVR( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_OVR_MST ) == ( LL_ADC_FLAG_OVR_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_OVR( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_OVR_SLV ) == ( LL_ADC_FLAG_OVR_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOSMP( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOSMP_MST ) == ( LL_ADC_FLAG_EOSMP_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOSMP( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_EOSMP_SLV ) == ( LL_ADC_FLAG_EOSMP_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JEOC( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JEOC_MST ) == ( LL_ADC_FLAG_JEOC_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JEOC( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JEOC_SLV ) == ( LL_ADC_FLAG_JEOC_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JEOS( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JEOS_MST ) == ( LL_ADC_FLAG_JEOS_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JEOS( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JEOS_SLV ) == ( LL_ADC_FLAG_JEOS_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JQOVF( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JQOVF_MST ) == ( LL_ADC_FLAG_JQOVF_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JQOVF( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_JQOVF_SLV ) == ( LL_ADC_FLAG_JQOVF_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD1( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD1_MST ) == ( LL_ADC_FLAG_AWD1_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD1( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD1_SLV ) == ( LL_ADC_FLAG_AWD1_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD2( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD2_MST ) == ( LL_ADC_FLAG_AWD2_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD2( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD2_SLV ) == ( LL_ADC_FLAG_AWD2_SLV ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD3( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD3_MST ) == ( LL_ADC_FLAG_AWD3_MST ) ) ?
                1UL :
                0UL );
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD3( ADC_Common_TypeDef const* ADCxy_COMMON )
{
        return (
            ( READ_BIT( ADCxy_COMMON->CSR, LL_ADC_FLAG_AWD3_SLV ) == ( LL_ADC_FLAG_AWD3_SLV ) ) ?
                1UL :
                0UL );
}
#endif /* ADC_MULTIMODE_SUPPORT */
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_ADRDY( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_EOC( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_EOS( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_OVR( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_EOSMP( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_JEOC( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_JEOS( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_JQOVF( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_AWD1( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_AWD2( ADC_TypeDef const* ADCx )
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_AWD3( ADC_TypeDef const* ADCx )
{
...
ErrorStatus LL_ADC_CommonInit(
    ...
    LL_ADC_CommonInitTypeDef const* pADC_CommonInitStruct );
...
ErrorStatus LL_ADC_Init( ADC_TypeDef* ADCx, LL_ADC_InitTypeDef const* pADC_InitStruct );
void        LL_ADC_StructInit( LL_ADC_InitTypeDef* pADC_InitStruct );

/* Initialization of some features of ADC instance and ADC group regular */
ErrorStatus LL_ADC_REG_Init( ADC_TypeDef* ADCx, LL_ADC_REG_InitTypeDef const* pADC_RegInitStruct );
void        LL_ADC_REG_StructInit( LL_ADC_REG_InitTypeDef* pADC_RegInitStruct );

/* Initialization of some features of ADC instance and ADC group injected */
ErrorStatus LL_ADC_INJ_Init( ADC_TypeDef* ADCx, LL_ADC_INJ_InitTypeDef const* pADC_InjInitStruct );
