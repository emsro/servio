...
typedef struct
{
        ...
        uint32_t HSICalibrationValue; /*!< The calibration trimming value (default is
                                         ...
                                         number between Min_Data = 0x00 and Max_Data = 0x7F on the
                                         other devices */
        ...
        uint32_t CSICalibrationValue; /*!< The calibration trimming value (default is
                                         RCC_CSICALIBRATION_DEFAULT). This parameter must be a
                                         number between Min_Data = 0x00 and Max_Data = 0x3F */
...
typedef struct
{
        ...
        uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived from the
                                    ...
                                    RCC_APB1_APB2_APB3_Clock_Source */

        uint32_t APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is derived from the
                                    AHB clock (HCLK). This parameter can be a value of @ref
                                    RCC_APB1_APB2_APB3_Clock_Source */

        uint32_t APB3CLKDivider; /*!< The APB3 clock (PCLK3) divider. This clock is derived from the
                                    AHB clock (HCLK). This parameter can be a value of @ref
                                    RCC_APB1_APB2_APB3_Clock_Source      */
} RCC_ClkInitTypeDef;
...
#define RCC_HSE_BYPASS                                                                            \
        ( (uint32_t) ( RCC_CR_HSEBYP | RCC_CR_HSEON ) ) /*!< External Analog clock source for HSE \
                                                           clock */
...
#define RCC_LSE_BYPASS                                                                            \
        ( (uint32_t) ( RCC_BDCR_LSEBYP | RCC_BDCR_LSEON ) ) /*!< External Analog clock source for \
                                                               LSE clock Bypassed*/
#define RCC_LSE_BYPASS_DIGITAL                                                             \
        ( (uint32_t) ( RCC_BDCR_LSEEXT | RCC_BDCR_LSEBYP |                                 \
                       RCC_BDCR_LSEON ) ) /*!< External Digital clock source for LSE clock \
                                             Bypassed */
/**
 * @}
 */
...
#define RCC_PLL1_VCIRANGE_3                                                                      \
        ( RCC_PLL1CFGR_PLL1RGE_0 | RCC_PLL1CFGR_PLL1RGE_1 ) /*!< Clock range frequency between 8 \
                                                               and 16 MHz */
/**
 * @}
 */
...
#define RCC_RTCCLKSOURCE_HSE_DIVx \
        ( 0x00000300U ) /*!< HSE oscillator clock divided by X used as RTC clock source */
...
#define RCC_FLAG_CSIRDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_CSIRDY_Pos ) ) /*!< CSI Ready flag */
#define RCC_FLAG_HSIRDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_HSIRDY_Pos ) ) /*!< HSI Ready flag */
#define RCC_FLAG_HSIDIVF                                                                         \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_HSIDIVF_Pos ) ) /*!< HSI divider flag \
                                                                            */
#define RCC_FLAG_HSERDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_HSERDY_Pos ) ) /*!< HSE Ready flag */
#define RCC_FLAG_PLL1RDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_PLL1RDY_Pos ) ) /*!< PLL1 Ready flag */
#define RCC_FLAG_PLL2RDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_PLL2RDY_Pos ) ) /*!< PLL2 Ready flag */
#if defined( RCC_CR_PLL3ON )
#define RCC_FLAG_PLL3RDY \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_PLL3RDY_Pos ) ) /*!< PLL3 Ready flag */
#endif                                                                     /* RCC_CR_PLL3ON */
#define RCC_FLAG_HSI48RDY                                                                         \
        ( (uint32_t) ( ( RCC_CR_REG_INDEX << 5U ) | RCC_CR_HSI48RDY_Pos ) ) /*!< HSI48 Ready flag \
                                                                             */

/* Flags in the BDCR register */
#define RCC_FLAG_LSERDY                                                                           \
        ( (uint32_t) ( ( RCC_BDCR_REG_INDEX << 5U ) | RCC_BDCR_LSERDY_Pos ) ) /*!< LSE Ready flag \
                                                                               */
...
#define RCC_FLAG_LSIRDY                                                                           \
        ( (uint32_t) ( ( RCC_BDCR_REG_INDEX << 5U ) | RCC_BDCR_LSIRDY_Pos ) ) /*!< LSI Ready flag \
                                                                               */

/* Flags in the RSR register */
#define RCC_FLAG_RMVF                                                                            \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_RMVF_Pos ) ) /*!< Remove reset flag \
                                                                           */
#define RCC_FLAG_PINRST                                                                          \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_PINRSTF_Pos ) ) /*!< PIN reset flag \
                                                                              */
#define RCC_FLAG_BORRST                                                                          \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_BORRSTF_Pos ) ) /*!< BOR reset flag \
                                                                              */
#define RCC_FLAG_SFTRST                                                                          \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_SFTRSTF_Pos ) ) /*!< Software Reset \
                                                                                flag */
...
#define RCC_FLAG_WWDGRST                                                                           \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_WWDGRSTF_Pos ) ) /*!< Window watchdog \
                                                                                 reset flag */
#define RCC_FLAG_LPWRRST                                                                           \
        ( (uint32_t) ( ( RCC_RSR_REG_INDEX << 5U ) | RCC_RSR_LPWRRSTF_Pos ) ) /*!< Low-Power reset \
                                                                                 flag */
...
#define RCC_RESET_FLAG_ALL                                                                    \
        ( RCC_RESET_FLAG_PIN | RCC_RESET_FLAG_PWR | RCC_RESET_FLAG_SW | RCC_RESET_FLAG_IWDG | \
...
#define RCC_STOP_KERWAKEUPCLOCK_CSI \
        RCC_CFGR1_STOPKERWUCK /*!< CSI kernel clock selection after wake-up from STOP */
...
#define RCC_ALL                                                                                  \
        ( RCC_HSI | RCC_HSE | RCC_CSI | RCC_LSI | RCC_LSE | RCC_HSI48 | RCC_SYSCLK | RCC_PRESC | \
          RCC_PLL1 | RCC_PLL2 | RCC_PLL3 | RCC_CKPERSEL | RCC_RMVF )
/**
 * @}
 */
...
/** @defgroup RCC_AHB2_Peripheral_Clock_Enable_Disable_Status AHB2 Peripheral Clock Enabled or
 * Disabled Status
...
/** @defgroup RCC_AHB4_Peripheral_Clock_Enable_Disable_Status AHB4 Peripheral Clock Enabled or
 * Disabled Status
...
/** @defgroup RCC_APB1_Peripheral_Clock_Enable_Disable_Status APB1 Peripheral Clock Enabled or
 * Disabled Status
...
/** @defgroup RCC_APB2_Peripheral_Clock_Enable_Disable_Status APB2 Peripheral Clock Enabled or
 * Disabled Status
...
/** @defgroup RCC_APB3_Peripheral_Clock_Enable_Disable_Status APB3 Peripheral Clock Enabled or
 * Disabled Status
 ...
 * @brief  Check whether the AHBx/APBx branch clock for all AHBx/APBx peripherals is disabled or
 * not.
 * @note   It is recommended to disable the clock of all peripherals (by writing 0 in
 *         the AHBxENR/APBxENR register) before Disabling the corresponding Bus Branch clock.
 *         Some peripheral bus clocks are not affected by branch clock disabling as IWDG (APB1),
...
/** @defgroup RCC_AHB1_Peripheral_Clock_Sleep_Enable_Disable AHB1 Peripheral Clock Sleep Enable
 * Disable
...
/** @defgroup RCC_AHB2_Peripheral_Clock_Sleep_Enable_Disable AHB2 Peripheral Clock Sleep Enable
 * Disable
...
#define __HAL_RCC_RTC_CLKPRESCALER( __RTCCLKSource__ )                                           \
        ( ( ( __RTCCLKSource__ ) & RCC_BDCR_RTCSEL ) == RCC_BDCR_RTCSEL ) ?                      \
            MODIFY_REG(                                                                          \
                RCC->CFGR1, RCC_CFGR1_RTCPRE, ( ( ( __RTCCLKSource__ ) & 0xFFFFCFFU ) >> 4 ) ) : \
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL1_DIVP: This Clock is used to generate the high speed system clock (up to
 * 250MHz)
 *            @arg RCC_PLL1_DIVQ: This Clock is used to generate the clock for USB (48 MHz), RNG
 * (<=48 MHz), OCTOSPI, SPI, SAI and Ethernet
...
/**
  * @brief  Macro to configures the main PLL (PLL1) clock source, multiplication and division
  factors.
  ...
  * @note   This clock source (__PLL1SOURCE__) is the clock source for PLL1 (main PLL) and is
  different from PLL2 & PLL3 clock sources.
  *
  ...
  * @retval None
  */
#define __HAL_RCC_PLL1_CONFIG(                                                 \
    __PLL1SOURCE__, __PLL1M__, __PLL1N__, __PLL1P__, __PLL1Q__, __PLL1R__ )    \
        do {                                                                   \
                MODIFY_REG(                                                    \
                    RCC->PLL1CFGR,                                             \
...
#define __HAL_RCC_PLL1_FRACN_CONFIG( __PLL1FRACN__ ) \
        WRITE_REG( RCC->PLL1FRACR, (uint32_t) ( __PLL1FRACN__ ) << RCC_PLL1FRACR_PLL1FRACN_Pos )
 ...
 * @note   The configured clock is also used as emergency clock for the Clock Security System on HSE
 * (HSECSS).
...
#define IS_RCC_MCO2SOURCE( SOURCE )                                                            \
        ( ( ( SOURCE ) == RCC_MCO2SOURCE_SYSCLK ) || ( ( SOURCE ) == RCC_MCO2SOURCE_PLL2P ) || \
...
#define IS_RCC_LSE_DRIVE( __DRIVE__ )                                                             \
        ( ( ( __DRIVE__ ) == RCC_LSEDRIVE_MEDIUMLOW ) || ( ( __DRIVE__ ) == RCC_LSEDRIVE_LOW ) || \
...
HAL_StatusTypeDef
HAL_RCC_ClockConfig( RCC_ClkInitTypeDef const* pClkInitStruct, uint32_t FLatency );
