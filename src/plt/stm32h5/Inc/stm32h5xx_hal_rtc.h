...
typedef struct
{
        ...
        uint32_t BinMixBcdU; /*!< Specifies the BCD calendar update if and only if BinMode =
                                RTC_BINARY_MIX. This parameter can be a value of @ref
                                RTCEx_Binary_mix_BCDU */
} RTC_InitTypeDef;
...
typedef struct
{
        ...
        uint32_t SubSeconds; /*!< Specifies the RTC_SSR RTC Sub Second register content.
                                  ...
                                  If the free running 32 bit counter is not activated (mode binary
                                none)
                                     - This parameter corresponds to a time unit range
                                  between [0-1] Second with [1 Sec / SecondFraction +1] granularity
                                  else
                                     - This parameter corresponds to the free running 32 bit
                                counter. */
...
typedef struct
{
        ...
        uint32_t BinaryAutoClr; /*!< Clear synchronously counter (RTC_SSR) on binary alarm.
                                     RTC_ALARMSUBSECONDBIN_AUTOCLR_YES must only be used if Binary
                                   mode is RTC_BINARY_ONLY This parameter can be a value of
        ...
        uint32_t FlagAutoClr; /*!< Specifies the alarm trigger generation. This feature is
                                 meaningful to avoid any RTC software execution after configuration.
                                   This parameter can be a value of @ref
...
#endif /* (USE_HAL_RTC_REGISTER_CALLBACKS) */
{
...
#if ( USE_HAL_RTC_REGISTER_CALLBACKS == 1 )
        void ( *AlarmAEventCallback )( struct __RTC_HandleTypeDef* hrtc );    /*!< RTC Alarm A Event
                                                                                 callback            */
        void ( *AlarmBEventCallback )( struct __RTC_HandleTypeDef* hrtc );    /*!< RTC Alarm B Event
                                                                                 callback            */
        void ( *TimeStampEventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC TimeStamp
                                                                                 Event callback */
        void ( *WakeUpTimerEventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC WakeUpTimer
                                                                                   Event callback */
        void ( *SSRUEventCallback )( struct __RTC_HandleTypeDef* hrtc );        /*!< RTC SSRU Event
                                                                                   callback        */
        void ( *Tamper1EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 1 Event
                                                                               callback           */
        void ( *Tamper2EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 2 Event
                                                                               callback           */
        void ( *Tamper3EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 3 Event
                                                                               callback           */
        void ( *Tamper4EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 4 Event
                                                                               callback           */
        void ( *Tamper5EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 5 Event
                                                                               callback           */
        void ( *Tamper6EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 6 Event
                                                                               callback           */
        void ( *Tamper7EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 7 Event
                                                                               callback           */
        void ( *Tamper8EventCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Tamper 8 Event
                                                                               callback           */
        ...
        void ( *InternalTamper6EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 6 Event callback  */
        void ( *InternalTamper7EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 7 Event callback  */
        ...
        void ( *InternalTamper9EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 9 Event callback  */
        void ( *InternalTamper11EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 11 Event callback */
        void ( *InternalTamper12EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 12 Event callback */
        void ( *InternalTamper13EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 13 Event callback */
        void ( *InternalTamper15EventCallback )(
            struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Internal Tamper 15 Event callback */
        void ( *MspInitCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Msp Init callback */
        void ( *MspDeInitCallback )( struct __RTC_HandleTypeDef* hrtc ); /*!< RTC Msp DeInit
                                                                            callback */
 ...
 */
typedef void ( *pRTC_CallbackTypeDef )( RTC_HandleTypeDef* hrtc ); /*!< pointer to an RTC callback
                                                                      function */
#endif /* USE_HAL_RTC_REGISTER_CALLBACKS */
...
/** @defgroup RTC_Alarm_Sub_Seconds_BCD_Masks_Definitions RTC Alarm Sub Seconds BCD Masks
 * Definitions In BCD mode (BIN=00) the overflow bits of the synchronous counter (bits 31:15) are
 * never compared.
 * @{
 */
...
#define RTC_ALARMSUBSECONDMASK_SS14_1 \
        RTC_ALRMASSR_MASKSS_0 /*!< SS[14:1] not used in Alarmcomparison. Only SS[0] is compared */
#define RTC_ALARMSUBSECONDMASK_SS14_2                                                      \
        RTC_ALRMASSR_MASKSS_1 /*!< SS[14:2] not used in Alarm comparison. Only SS[1:0] are \
                                 compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_3                                                              \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 ) /*!< SS[14:3] not used in Alarm          \
                                                             comparison. Only SS[2:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_4                                                      \
        RTC_ALRMASSR_MASKSS_2 /*!< SS[14:4] not used in Alarm comparison. Only SS[3:0] are \
                                 compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_5                                                              \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 ) /*!< SS[14:5] not used in Alarm          \
                                                             comparison. Only SS[4:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_6                                                              \
        ( RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 ) /*!< SS[14:6] not used in Alarm          \
                                                             comparison. Only SS[5:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_7                                                          \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |                                      \
          RTC_ALRMASSR_MASKSS_2 ) /*!< SS[14:7] not used in Alarm comparison. Only SS[6:0] are \
                                     compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_8                                                      \
        RTC_ALRMASSR_MASKSS_3 /*!< SS[14:8] not used in Alarm comparison. Only SS[7:0] are \
                                 compared                */
#define RTC_ALARMSUBSECONDMASK_SS14_9                                                              \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14:9] not used in Alarm          \
                                                             comparison. Only SS[8:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_10                                                             \
        ( RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14:10] not used in Alarm         \
                                                             comparison. Only SS[9:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_11                                                           \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |                                        \
          RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14:11] not used in Alarm comparison. Only SS[10:0] are \
                                     compared              */
#define RTC_ALARMSUBSECONDMASK_SS14_12                                                             \
        ( RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14:12] not used in Alarm         \
                                                             comparison.Only SS[11:0] are compared \
                                                           */
#define RTC_ALARMSUBSECONDMASK_SS14_13                                                           \
        ( RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 |                                        \
          RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14:13] not used in Alarm comparison. Only SS[12:0] are \
                                     compared              */
#define RTC_ALARMSUBSECONDMASK_SS14                                                           \
        ( RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 |                                     \
          RTC_ALRMASSR_MASKSS_3 ) /*!< SS[14] not used in Alarm comparison. Only SS[13:0] are \
                                     compared                 */
#define RTC_ALARMSUBSECONDMASK_NONE \
        RTC_ALRMASSR_MASKSS /*!< SS[14:0] are compared and must match to activate alarm */
/**
 * @}
 */
...
#if ( USE_HAL_RTC_REGISTER_CALLBACKS == 1 )
HAL_StatusTypeDef HAL_RTC_RegisterCallback(
...
HAL_StatusTypeDef
HAL_RTC_GetTime( RTC_HandleTypeDef const* hrtc, RTC_TimeTypeDef* sTime, uint32_t Format );
HAL_StatusTypeDef
HAL_RTC_SetDate( RTC_HandleTypeDef* hrtc, RTC_DateTypeDef* sDate, uint32_t Format );
HAL_StatusTypeDef
         HAL_RTC_GetDate( RTC_HandleTypeDef const* hrtc, RTC_DateTypeDef* sDate, uint32_t Format );
...
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent( RTC_HandleTypeDef const* hrtc, uint32_t Timeout );
