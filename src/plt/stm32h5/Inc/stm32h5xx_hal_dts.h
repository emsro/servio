...
#endif /* USE_HAL_DTS_REGISTER_CALLBACKS */
{
...
#if ( USE_HAL_DTS_REGISTER_CALLBACKS == 1U )
        void ( *MspInitCallback )( struct __DTS_HandleTypeDef* hdts );   /*!< DTS Base Msp Init
                                                                            Callback   */
        void ( *MspDeInitCallback )( struct __DTS_HandleTypeDef* hdts ); /*!< DTS Base Msp DeInit
                                                                            Callback */
        ...
        void ( *AsyncEndCallback )( struct __DTS_HandleTypeDef* hdts );  /*!< Asynchronous end of
                                                                            measure Callback       */
        void ( *AsyncLowCallback )( struct __DTS_HandleTypeDef* hdts );  /*!< Asynchronous low
                                                                            threshold Callback  */
        void ( *AsyncHighCallback )( struct __DTS_HandleTypeDef* hdts ); /*!< Asynchronous high
                                                                            threshold Callback */
#endif /* USE_HAL_DTS_REGISTER_CALLBACKS */
} DTS_HandleTypeDef;
...
#define DTS_QUICKMEAS_ENABLE \
        DTS_CFGR1_Q_MEAS_OPT /*!< Enable the Quick Measure (Measure without calibration) */
...
#define DTS_SMP_TIME_3_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_1 ) /*!< 3 clock cycle for the \
                                                                   sampling time  */
#define DTS_SMP_TIME_4_CYCLE \
        ( DTS_CFGR1_TS1_SMP_TIME_2 ) /*!< 4 clock cycle for the sampling time  */
#define DTS_SMP_TIME_5_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_2 ) /*!< 5 clock cycle for the \
                                                                   sampling time  */
#define DTS_SMP_TIME_6_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_1 | DTS_CFGR1_TS1_SMP_TIME_2 ) /*!< 6 clock cycle for the \
                                                                   sampling time  */
...
#define DTS_SMP_TIME_9_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_3 ) /*!< 9 clock cycle for the \
                                                                   sampling time  */
#define DTS_SMP_TIME_10_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_1 | DTS_CFGR1_TS1_SMP_TIME_3 ) /*!< 10 clock cycle for the \
                                                                   sampling time */
#define DTS_SMP_TIME_11_CYCLE                                   \
        ( DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_1 | \
          DTS_CFGR1_TS1_SMP_TIME_3 ) /*!< 11 clock cycle for the sampling time */
#define DTS_SMP_TIME_12_CYCLE                                                               \
        ( DTS_CFGR1_TS1_SMP_TIME_2 | DTS_CFGR1_TS1_SMP_TIME_3 ) /*!< 12 clock cycle for the \
                                                                   sampling time */
...
#define DTS_SMP_TIME_15_CYCLE                                                              \
        ( DTS_CFGR1_TS1_SMP_TIME_0 | DTS_CFGR1_TS1_SMP_TIME_1 | DTS_CFGR1_TS1_SMP_TIME_2 | \
...
#define DTS_FLAG_TS1_AITE \
        DTS_SR_TS1_AITEF /*!< Asynchronous Interrupt flag for end of measure for DTS1 */
#define DTS_FLAG_TS1_AITL \
        DTS_SR_TS1_AITLF /*!< Asynchronous Interrupt flag for low threshold for DTS1  */
#define DTS_FLAG_TS1_AITH \
        DTS_SR_TS1_AITHF /*!< Asynchronous Interrupt flag for high threshold for DTS1 */
#define DTS_FLAG_TS1_RDY \
        DTS_SR_TS1_RDY /*!< Ready flag for DTS1                                     */
/**
 * @}
 */
...
#define DTS_IT_TS1_AITE                                                                          \
        DTS_ITENR_TS1_AITEEN /*!< Enable asynchronous interrupt flag for end of measure for DTS1 \
                              */
#define DTS_IT_TS1_AITL \
        DTS_ITENR_TS1_AITLEN /*!< Enable asynchronous interrupt flag for low threshold for DTS1 */
#define DTS_IT_TS1_AITH                                                                          \
        DTS_ITENR_TS1_AITHEN /*!< Enable asynchronous interrupt flag for high threshold for DTS1 \
                              */
/**
 * @}
 */
...
#define IS_DTS_TRIGGERINPUT( __INPUT__ )                                                           \
        ( ( ( __INPUT__ ) == DTS_TRIGGER_HW_NONE ) || ( ( __INPUT__ ) == DTS_TRIGGER_LPTIMER1 ) || \
          ( ( __INPUT__ ) == DTS_TRIGGER_LPTIMER2 ) ||                                             \
          ( ( __INPUT__ ) == DTS_TRIGGER_LPTIMER3 ) || ( ( __INPUT__ ) == DTS_TRIGGER_EXTI13 ) )
#else
#define IS_DTS_TRIGGERINPUT( __INPUT__ )                                                           \
        ( ( ( __INPUT__ ) == DTS_TRIGGER_HW_NONE ) || ( ( __INPUT__ ) == DTS_TRIGGER_LPTIMER1 ) || \
          ( ( __INPUT__ ) == DTS_TRIGGER_LPTIMER2 ) || ( ( __INPUT__ ) == DTS_TRIGGER_EXTI13 ) )
#endif /* defined(LPTIM3) */
