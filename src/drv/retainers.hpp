...
inline auto retain_callback( period_interface& period )
{
...
inline auto retain_callback( current_interface& curr_drv )
{
...
inline auto retain_callback( position_interface& pos_drv )
{
