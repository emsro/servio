...
consteval map get_default_config()
{
        return map{
            ...
            reg< POSITION_CONV_LOWER_SETPOINT_VALUE, uint32_t >{ 0 },
            reg< POSITION_CONV_LOWER_SETPOINT_ANGLE, float >{ 0.F },
            reg< POSITION_CONV_HIGHER_SETPOINT_VALUE, uint32_t >{ 4096 },
            reg< POSITION_CONV_HIGHER_SETPOINT_ANGLE, float >{ 2 * pi },
